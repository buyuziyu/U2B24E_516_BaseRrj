...
******************************************************************************/
/* Functions */
extern void RDC3AS0_Init(void);
extern uint16 RDC3AS0_GetCurrentPosition(void);
extern float32 RDC3AS0_SamplePosition(void);

extern void Dsadc_Init(void);
extern void Dsadc_Cos_Init(void);
extern void Dsadc_Sin_Init(void);
#ifdef USE_REF_ADC
extern void Dsadc_Ref_Init(void);
#endif

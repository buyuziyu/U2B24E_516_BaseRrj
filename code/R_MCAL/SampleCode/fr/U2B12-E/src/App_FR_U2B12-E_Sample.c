...
/* Module       = App_FR_U2B12-E_Sample.c                                     */
/*============================================================================*/
/*                                  COPYRIGHT                                 */
/*============================================================================*/
 ...
 *                          - Update BoundIntToPEMax, Guard_Init, Port_Init, Guard_Enable_PE
 ...
 *           16/05/2024   : Delete Fr_input_data1, Fr_59_Gstinput_data1,
 *                           Fr_59_Gstinput_table1 and unify with common
 *                           variable to optimize memmory
...
_INTERRUPT_ void INTFLX0TIM0(void)
{
  ...
  else if (FR_59_RENESAS_ELEVEN == Fr_GucInvoked[0])
  {
    ...
    /* Invoke the API Fr_59_Renesas_HaltCommunication()  */
    LucReturnValue = Fr_59_Renesas_HaltCommunication(LucControllerIdx);
      if (E_OK == LucReturnValue)
    {
        Fr_GblInvoked = FR_59_RENESAS_TRUE;
    }

 ...
 * 2.1.1:   22/07/2024   : Change Fr_GucInvoked_core0 to Fr_GucInvoked
 *                         to unify when running multiple PE
 *          16/05/2024   : Initial Version
 */
/******************************************************************************/

#ifndef APP_FR_COMMON_SAMPLE_0_H
#define APP_FR_COMMON_SAMPLE_0_H
...
#endif
extern VAR(Fr_59_Renesas_OutputPointerTableType, FR_DATA) Fr_59_Gstoutput_table_core0[4];
extern VAR(Fr_59_Renesas_OutputDataStrType, FR_DATA) Fr_59_Gstoutput_data_core0[4];
extern VAR(Fr_59_Renesas_OutputConstdataType, FR_DATA) Fr_output_data_core0[6];

extern VAR(Fr_59_Renesas_InputConstdataType, FR_DATA) Fr_input_data_core0[6];
extern VAR(Fr_59_Renesas_InputDataStrType, FR_DATA) Fr_59_Gstinput_data_core0[4];
extern VAR(Fr_59_Renesas_InputPointerTableType, FR_DATA) Fr_59_Gstinput_table_core0[4];

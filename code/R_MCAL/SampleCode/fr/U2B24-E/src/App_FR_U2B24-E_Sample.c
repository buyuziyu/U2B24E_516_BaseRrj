 ...
 *                          + Update Guard_Enable_PE, Guard_Init to access PE6
 *                          + Update Appl_Init(): add macro RUN_PE6
 ...
 *                          - Update BoundIntToPEMax, Guard_Init, IH_Init, Port_Init, Guard_Enable_PE
 *  2.2.0:   31/12/2024   : Update SW-VERSION for Ver22.02.00/Ver22.02.00.D Final Release
 *                          Update IH_Init, Port_Init
 *  2.1.3:   31/10/2024   : Update SW-VERSION to 2.1.3
 *                         Add Guard_Enable_PE, Guard_Init, BoundIntToPEMax
 *                         Update preprocessor for PEID_MAX_VALUE
...
/* ===== */
VAR(Fr_59_Renesas_InputConstdataType, FR_DATA) Fr_input_data1[6] =
{
/*Fr data 0*/
{
0xEEEEEEEE,
...
/*Structure of register values for input data structure */
VAR(Fr_59_Renesas_InputDataStrType, FR_DATA) Fr_59_Gstinput_data1[4] =
{
/*message buffer 0*/
{
/*ulFLX0FRWRHS1*/
...
/*Structure of register values for input transfer table */
VAR(Fr_59_Renesas_InputPointerTableType, FR_DATA) Fr_59_Gstinput_table1[4] =
{
{
/*ulFLX0FRWRHS4*/
0x80704,
/*pointer to input data structure */
&Fr_59_Gstinput_data1[0]
},
{
/*ulFLX0FRWRHS4*/
0x80703,
/*pointer to input data structure */
&Fr_59_Gstinput_data1[1]
},
{
/*ulFLX0FRWRHS4*/
0x8020B40B,
/*pointer to input data structure */
&Fr_59_Gstinput_data1[2]
},
{
/*ulFLX0FRWRHS4*/
0x8020B400,
/*pointer to input data structure */
&Fr_59_Gstinput_data1[3]
}
};

VAR(Fr_59_Renesas_OutputConstdataType, FR_DATA) Fr_output_data1[6] =
{
/*Fr data 0*/
{
...
/*Structure of register values for output data structure */
VAR(Fr_59_Renesas_OutputDataStrType, FR_DATA) Fr_59_Gstoutput_data1[4] =
{
/*message buffer 0*/
{
/*ulFLX0FRRDHS1*/
...
/*Structure of register values for output transfer table */
VAR(Fr_59_Renesas_OutputPointerTableType, FR_DATA) Fr_59_Gstoutput_table1[4] =
{
{
/*pointer to output data structure */
&Fr_59_Gstoutput_data1[0],
/*Message buffer to be transferred*/
4
},
{
/*pointer to output data structure */
&Fr_59_Gstoutput_data1[1],
/*Message buffer to be transferred*/
127
},
{
/*pointer to output data structure */
&Fr_59_Gstoutput_data1[2],
/*Message buffer to be transferred*/
127
},
{
/*pointer to output data structure */
&Fr_59_Gstoutput_data1[3],
/*Message buffer to be transferred*/
127
}
};
...
void BoundIntToPEMax(void)
{
  ...
  {
    EIBD_BASE_ADDR[724] = PEID_MAX_VALUE;
    EIBD_BASE_ADDR[726] = PEID_MAX_VALUE;
  }
  else
  {
...
void Guard_Enable_PE(void)
{
  ...
  PBGCKPROT1(20,0) |= (uint32)((0x01<<1)|(0x01<<2)|(0x01<<3)|(0x01<<4)|(0x01<<6));
  PBGKCPROT(20)     = KCPROT_CLR;

  PBGKCPROT(0)     = KCPROT_SET;
  PBGCKPROT1(0,0) |= (uint32)((0x01<<1)|(0x01<<2)|(0x01<<3)|(0x01<<4)|(0x01<<6));
  PBGKCPROT(0)     = KCPROT_CLR;
    
  PBGKCPROT(20)     = KCPROT_SET;
  PBGCKPROT1(21,5) |= (uint32)((0x01<<1)|(0x01<<2)|(0x01<<3)|(0x01<<4)|(0x01<<6));
  PBGKCPROT(20)     = KCPROT_CLR;
    
  PBGKCPROT(20)     = KCPROT_SET;
  PBGCKPROT1(21,6) |= (uint32)((0x01<<1)|(0x01<<2)|(0x01<<3)|(0x01<<4)|(0x01<<6));
  PBGKCPROT(20)     = KCPROT_CLR;
    
  PBGKCPROT(20)      = KCPROT_SET;
  PBGCKPROT1(21,11) |= (uint32)((0x01<<1)|(0x01<<2)|(0x01<<3)|(0x01<<4)|(0x01<<6));
  PBGKCPROT(20)      = KCPROT_CLR;
 
  INTC2GKCPROT    = KCPROT_SET;
  INTC2GMPID(724) = (uint32)((0x01<<1)|(0x01<<2)|(0x01<<3)|(0x01<<4));
  INTC2GPROT(724) |= (uint32)((0x01<<16)|(0x01<<18)|(0x01<<22));
  INTC2GPROT_GR   |= (uint32)((0x01<<16)|(0x01<<18)|(0x01<<22));
  INTC2GPROT_IMR  |= (uint32)((0x01<<16)|(0x01<<18)|(0x01<<22));
  BoundIntToPEMax();
  INTC2GKCPROT = KCPROT_CLR;
  
  INTC2GKCPROT = KCPROT_SET;
  INTC2GMPID(726) = (uint32)((0x01<<1)|(0x01<<2)|(0x01<<3)|(0x01<<4));
  INTC2GPROT(726) |= (uint32)((0x01<<16)|(0x01<<18)|(0x01<<22));
  INTC2GPROT_GR   |= (uint32)((0x01<<16)|(0x01<<18)|(0x01<<22));
  INTC2GPROT_IMR  |= (uint32)((0x01<<16)|(0x01<<18)|(0x01<<22));
  BoundIntToPEMax();
  INTC2GKCPROT = KCPROT_CLR;
  ...
  PBGCKPROT1(62,0) |= (uint32)((0x01<<1)|(0x01<<2)|(0x01<<3)|(0x01<<4)|(0x01<<6));
  PBGKCPROT(62) = KCPROT_CLR;
    
  HBGKCPROT(92)  = KCPROT_SET;
  HBGPROT1(92)  |= (uint32)((0x01<<1)|(0x01<<2)|(0x01<<3)|(0x01<<4)|(0x01<<6));
  HBGKCPROT(92)  = KCPROT_CLR;

  HBGKCPROT(93)  = KCPROT_SET;
  HBGPROT1(93)  |= (uint32)((0x01<<1)|(0x01<<2)|(0x01<<3)|(0x01<<4)|(0x01<<6));
...
{
  PBGKCPROT(20) = KCPROT_SET;
  PBGCKPROT1(20,2) |= (uint32)((0x01<<1)|(0x01<<2)|(0x01<<3)|(0x01<<4)|(0x01<<6));
  PBGKCPROT(20) = KCPROT_CLR;
  ...
  PBGKCPROT(62) = KCPROT_SET;
  PBGCKPROT1(62,1) |= (uint32)((0x01<<1)|(0x01<<2)|(0x01<<3)|(0x01<<4)|(0x01<<6));
  PBGKCPROT(62) = KCPROT_CLR;
...
void Port_Init(void)
{
  ...
  FR_PORT0[2].usPMC     = (uint16)0x0117;
  ...
  FR_PORT0[2].usPFCAE   = (uint16)0x0102;
...
_INTERRUPT_ void INTFLX0TIM0(void)
{
  ...
  else if (FR_59_RENESAS_ELEVEN == Fr_GucInvoked[0])
  {
    ...
    LucReturnValue = Fr_59_Renesas_ReceiveQueueTable(LucControllerIdx, &Fr_59_Gstoutput_table[0]);
      if (E_OK == LucReturnValue)
    {
        Fr_GblInvoked = FR_59_RENESAS_TRUE;
          Fr_GucInvoked[0]++;
    ...
    LucReturnValue = Fr_59_Renesas_UserOutputTransferRequest(LucControllerIdx, &Fr_59_Gstoutput_table[1]);
      if (E_OK == LucReturnValue)
    {
        Fr_GblInvoked = FR_59_RENESAS_TRUE;
            Fr_GucInvoked[0]++;
    ...
    LucReturnValue = Fr_59_Renesas_UserInputTransferRequest(LucControllerIdx, &Fr_59_Gstinput_table[0]);
      if (E_OK == LucReturnValue)
    {
        Fr_GblInvoked = FR_59_RENESAS_TRUE;
            Fr_GucInvoked[0]++;
    ...
    LucReturnValue = Fr_59_Renesas_HaltInputQueue(LucControllerIdx, &Fr_59_Gstinput_table[1]);
      if (E_OK == LucReturnValue)
    {
        Fr_GblInvoked = FR_59_RENESAS_TRUE;
    }
...
_INTERRUPT_ void INTFLX1TIM0(void)
{
 uint8 LucControllerIdx;
  ...
  LucCount1 = FR_59_RENESAS_ZERO;
    ...
    if (FR_59_RENESAS_ZERO == Fr_GucInvoked[1])
  {
    LusLPduIdx = FR_59_RENESAS_EIGHT;
    /*
     * Invoke Fr_PrepareLPdu to reconfigure buffer to transmit the frame of
  ...
  else if (FR_59_RENESAS_ONE == Fr_GucInvoked[1])
  {
    LusLPduIdx = FR_59_RENESAS_SEVEN;
    /* Invoke Fr_ReceiveRxLPdu to receive the frame transmitted from Node 2 */
    LucReturnValue = Fr_59_Renesas_ReceiveRxLPdu(LucControllerIdx, LusLPduIdx,
                              ...
                              (FR_59_RENESAS_LSDULENGHT == LucRxLSduLengthPtr1))
    {
      ...
      if (FR_59_RENESAS_NINE == Fr_GucInvoked[1])
      {
        Fr_GblInvoked = FR_59_RENESAS_TRUE;
		    Fr_GucInvoked[1]++;
      }
    ...
    if(FR_59_RENESAS_TEN == Fr_GucInvoked[1])
    {
      /* Invoke the API Fr_59_Renesas_CancelAbsoluteTimer()  */
      LucReturnValue = Fr_59_Renesas_CancelAbsoluteTimer(LucControllerIdx, LucAbsTimerIdx);
	    if (E_OK == LucReturnValue)
  ...
  else if (FR_59_RENESAS_TEN == Fr_GucInvoked[1])
  {
    /* Invoke the API Fr_59_Renesas_GetNmVector()  */
    do
    {
  ...
  else if (FR_59_RENESAS_ELEVEN == Fr_GucInvoked[1])
  {
    /* Invoke the API Fr_59_Renesas_ReceiveQueueTable()  */
    LucReturnValue = Fr_59_Renesas_ReceiveQueueTable(LucControllerIdx, &Fr_59_Gstoutput_table1[0]);
	  if (E_OK == LucReturnValue)
    {
        Fr_GblInvoked = FR_59_RENESAS_TRUE;
		  Fr_GucInvoked[1]++;
    ...
    /* Invoke the API Fr_59_Renesas_UserOutputTransferRequest()  */
    LucReturnValue = Fr_59_Renesas_UserOutputTransferRequest(LucControllerIdx, &Fr_59_Gstoutput_table1[1]);
	  if (E_OK == LucReturnValue)
    {
        Fr_GblInvoked = FR_59_RENESAS_TRUE;
		    Fr_GucInvoked[1]++;
    ...
    /* Invoke the API Fr_59_Renesas_UserInputTransferRequest()  */
    LucReturnValue = Fr_59_Renesas_UserInputTransferRequest(LucControllerIdx, &Fr_59_Gstinput_table1[0]);
	  if (E_OK == LucReturnValue)
    {
        Fr_GblInvoked = FR_59_RENESAS_TRUE;
		    Fr_GucInvoked[1]++;
    ...
    /* Invoke the API Fr_59_Renesas_HaltInputQueue()  */
    LucReturnValue = Fr_59_Renesas_HaltInputQueue(LucControllerIdx, &Fr_59_Gstinput_table1[1]);
    if (E_OK == LucReturnValue)
    {
        Fr_GblInvoked = FR_59_RENESAS_TRUE;
    }

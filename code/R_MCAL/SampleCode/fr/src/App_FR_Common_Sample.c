 ...
 * 2.1.2:   13/08/2024     : Change Fr_59_Renesas_SetWakeupChannel to call
 ...
 * 2.0.1:   11/10/2023     : Move Fr_output_data, Fr_59_Gstoutput_data
 *                           Fr_59_Gstoutput_table to a global variable
 * 1.4.5:   10/02/2023     : Change SW-VERSION to 1.4.5
 * 1.4.4:   21/06/2022     : Change SW-VERSION to 1.4.4
 *                           Add the missing API to invoke full API.
 ...
 * 1.0.2:   06/03/2020     : Change from FrConf_FrMultipleConfiguration_FrMultipleConfiguration
 *                           to Fr_Config
 *          14/01/2020     : Change Fr_FrMultipleConfiguration_FrMultipleConfiguration to
 *                           FrConf_FrMultipleConfiguration_FrMultipleConfiguration
 * 1.0.1:   04/06/2019     : Change argument name for Fr_59_Renesas_Init() API
 *                           due to changes for handler macro name.

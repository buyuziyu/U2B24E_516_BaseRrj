 ...
 *                         1. Add GblVerCheckStatus with volatile
 ...
 *          22/07/2024   : Change Fr_GucInvoked_core0 to Fr_GucInvoked
 *                         to unify when running multiple PE
 *          15/06/2024   : Initial Version
 */
/******************************************************************************/
...
VAR(Fr_59_Renesas_OutputConstdataType, FR_DATA) Fr_output_data_core0[6] =
  {
  /*Fr data 0*/
...
VAR(Fr_59_Renesas_OutputDataStrType, FR_DATA) Fr_59_Gstoutput_data_core0[4] =
  {
  /*message buffer 0*/
  {
  /*ulFLX0FRRDHS1*/
  ...
  0x0C800000,
  /*Pointer to output data section */
  &Fr_output_data_core0[3] }
  };
VAR(Fr_59_Renesas_OutputPointerTableType, FR_DATA) Fr_59_Gstoutput_table_core0[4] =
  {
  {
  /*pointer to output data structure */
  &Fr_59_Gstoutput_data_core0[0],
  /*Message buffer to be transferred*/
  2 }, {
  /*pointer to output data structure */
  &Fr_59_Gstoutput_data_core0[1],
  /*Message buffer to be transferred*/
  127 }, {
  /*pointer to output data structure */
  &Fr_59_Gstoutput_data_core0[2],
  /*Message buffer to be transferred*/
  127 }, {
  /*pointer to output data structure */
  &Fr_59_Gstoutput_data_core0[3],
  /*Message buffer to be transferred*/
  127 }
  };
/* ========= */
VAR(Fr_59_Renesas_InputConstdataType, FR_DATA) Fr_input_data_core0[6] =
  {
  /*Fr data 0*/
  {
  0xEEEEEEEE,
...
VAR(Fr_59_Renesas_InputDataStrType, FR_DATA) Fr_59_Gstinput_data_core0[4] =
  {
  /*message buffer 0*/
  {
  /*ulFLX0FRWRHS1*/
  ...
  0xAC400000,
  /*Pointer to input data section */
  &Fr_input_data_core0[3]
  }
  };
VAR(Fr_59_Renesas_InputPointerTableType, FR_DATA) Fr_59_Gstinput_table_core0[4] =
  {
  {
  /*ulFLX0FRWRHS4*/
  0x80704,
  /*pointer to input data structure */
  &Fr_59_Gstinput_data_core0[0]
  },
  {
  /*ulFLX0FRWRHS4*/
  0x80703,
  /*pointer to input data structure */
  &Fr_59_Gstinput_data_core0[1]
  },
  {
  /*ulFLX0FRWRHS4*/
  0x8020B40B,
  /*pointer to input data structure */
  &Fr_59_Gstinput_data_core0[2]
  },
  {
  /*ulFLX0FRWRHS4*/
  0x8020B400,
  /*pointer to input data structure */
  &Fr_59_Gstinput_data_core0[3]
  }
};
  ...
  if (E_OK == LucReturnValue)
  {
    ...
    if (FR_59_RENESAS_ELEVEN == Fr_GucInvoked[0])
    {
      do
      {
        ...
        LucReturnValue = Fr_59_Renesas_TransferHandlerInit(LucControllerIdx, &Fr_59_Gstoutput_table_core0[0],
                                                                                              &Fr_59_Gstoutput_table_core0[0]);
      }while(E_OK != LucReturnValue);
        /* Invoke the API Fr_59_Renesas_TransferQueueTable() */
      do
      {
        LucReturnValue = Fr_59_Renesas_TransferQueueTable( LucControllerIdx, &Fr_59_Gstinput_table_core0[0]);
      }while(E_OK != LucReturnValue);
    }
  }

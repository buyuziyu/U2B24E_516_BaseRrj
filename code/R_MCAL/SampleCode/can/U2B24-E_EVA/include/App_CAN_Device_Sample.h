...
#define TOTAL_CHECKPOINT_MULTICORE_SINGLEVARIANT_CORE0   35
#define TOTAL_CHECKPOINT_MUTILCORE_SINGLEVARIANT_CORE1   27
#define TOTAL_CHECKPOINT_MULTICORE_POSTBUILD_CORE0   35
#define TOTAL_CHECKPOINT_MULTICORE_POSTBUILD_CORE1   29

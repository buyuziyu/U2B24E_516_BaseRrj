 ...
 * 2.3.1: 31/03/2025  : Update value of macro total checkpoint
 *                    : Update SW-VERSION for RH850/Ver22.00.02 U2Bx-E
 * 2.2.0: 31/12/2024  : Add new macro related check point.
 * 2.1.2: 31/10/2024  : Add new macro TOTAL_CHECKPOINT_MUTILCORE_SINGLEVARIANT_CORE1
...
#define TOTAL_CHECKPOINT_MULTICORE_SINGLEVARIANT_CORE0   37
#define TOTAL_CHECKPOINT_MUTILCORE_SINGLEVARIANT_CORE1   28
#define TOTAL_CHECKPOINT_MULTICORE_POSTBUILD_CORE0   35
#define TOTAL_CHECKPOINT_MULTICORE_POSTBUILD_CORE1   30

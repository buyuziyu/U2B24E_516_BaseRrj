...
/* Module       = App_CAN_Multi_PostBuildVariant_Sample_0.c                   */
/*============================================================================*/
/*                                  COPYRIGHT                                 */
/*============================================================================*/
...
int main(void)
{
  ...
  /* Waiting for reception variant 1 core 1  */
  while (LulCount--);
...
#endif
  /* Wait for Core 1 done sequence*/
  while (GblDone_Core1 == 0);
  GblDone_Core1 = 0;
  GblCheck_DeInit_Core0 = 0;
  Can_DeInit();
  /* Remark Core 1 done deinit */
  GblCheck_DeInit_Core0 = 1;
...
*******************************************************************************/
  ...
  while (GblCheckInit_1 == 1);
  /* Set Controller Mode to START Mode for Controller 1*/
  GenCanReturn_0 = Can_SetControllerMode(
                      CanConf_CanController_CanController0, CAN_CS_STARTED);
  if (E_OK == GenCanReturn_0)
  {
  ...
  /* Waiting for reception variant 2 core 1  */
  LulCount = 1000000;
  while (LulCount--);
  if (((GucReceiveCount_0 - LucReceiveCountOld_0) == 1) && 
      ((GucTransmitCount_0 - LucTransmitCountOld_0) == 1)) 
  ...
  /* Waiting for reception with BUFFER MODE variant 2 core 2  */
  LulCount = 1000000;
  while (LulCount--);
  if (((GucReceiveCount_0 - LucReceiveCountOld_0) == 1) && 
      ((GucTransmitCount_0 - LucTransmitCountOld_0) == 1))
  ...
  if (GucReturnCount_0 == TOTAL_CHECKPOINT_MULTICORE_POSTBUILD_CORE0)
  {
    GbOverallStatus_0 = CAN_COMMON_OK;
  }
  /* Remark Core 0 Done sequence */
  GblDone_Core0 = 1;
  Can_SetControllerMode(CanConf_CanController_CanController0, CAN_CS_STOPPED);
  /* End trap */
  Can_SampleApp_End();

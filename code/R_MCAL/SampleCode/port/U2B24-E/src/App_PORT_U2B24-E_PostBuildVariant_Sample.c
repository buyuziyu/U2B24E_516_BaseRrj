...
/* Module       = App_PORT_U2B24-E_PostBuildVariant_Sample.c                  */
/*============================================================================*/
/*                                  COPYRIGHT                                 */
/*============================================================================*/
...
*******************************************************************************/
/* 2.3.1:  31/03/2025   : Add PE Guard function for runing PE max             */
/*                      : Update checkpoint for Port_Init()                   */
...
*******************************************************************************/
uint8 GaaTestResult_Variant1[8];
uint8 GaaTestResult_Variant2[7];
...
{ 
  ...
  {
    GaaTestResult_Variant1[0] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResult_Variant1[0] = (uint8)PORT_FAIL;
  }
  /* Enable PE guard when running on other PE */
  #if defined(RUN_OTHER_PE)
  ...
  /* Variant Config 1 */
  Port_Init(Port_Config_Variant_1);
  ...
  if (((PMC10 & 0x0080) == 0x0080) && ((PIPC10 & 0x0080) == 0x0000) 
      ...
      && ((PM10 & 0x0080) == 0x0000) && ((PU10 & 0x0080) == 0x0080) 
      && ((PD10 & 0x0080) == 0x0000) && ((PIBC10 & 0x0080) == 0x0000) 
      && ((PFC10 & 0x0080) == 0x0000))
  {
    GaaTestResult_Variant1[1] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResult_Variant1[1] = (uint8)PORT_FAIL;
  }
  ...
  /* "Alternative Input mode (ALT3 IN)"                                  */
  /* PMC:1(ALT) PIPC:0(S/W IO) <PFCEAE:0> PFCAE:0 PFCE:1 PFC:0 PM:1(IN)   */
  /* PINV:0 PODC:1 PODCE:1(P-ch open drain) PDSC:1 PUCC:0(Mid) P:1(High)  */

  Port_SetPinMode(PortConf_PortGroup10_PortPin6, PORT_APP_ALT3_IN);
  if ((0x0040 == (PMC10 & 0x0040)) && (0x0000 == (PIPC10 & 0x0040)) 
  && (0x0040 == (PM10 & 0x0040)) && (0x0000 == (PFCAE10 & 0x0040)) 
  && (0x0040 == (PFCE10 & 0x0040)) && (0x0000 == (PFC10 & 0x0040)))
  {
    GaaTestResult_Variant1[2] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResult_Variant1[2] = (uint8)PORT_FAIL;
  }
  ...
  /*
     ...
     * applicable.
     *
     * Default Pin direction of PortGroup0
  ...
  {
    GaaTestResult_Variant1[3] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResult_Variant1[3] = (uint8)PORT_FAIL;
  }
  /*
  ...
  */
  ...
  {
    GaaTestResult_Variant1[4] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResult_Variant1[4] = (uint8)PORT_FAIL;
  ...
  {
    GaaTestResult_Variant1[5] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResult_Variant1[5] = (uint8)PORT_FAIL;
  }
  /* This API will switch a pin of port from ALT to DIO. */
  Port_SetToDioMode(PortConf_PortGroup10_PortPin3);
  if ((PMC10 & 0x0004) == 0x0000)
  {
    GaaTestResult_Variant1[6] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResult_Variant1[6] = (uint8)PORT_FAIL;
  }
  ...
  {
    GaaTestResult_Variant1[7] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResult_Variant1[7] = (uint8)PORT_FAIL;
  }
  /*
  ...
  /* This API will initilize all the registers to the initial values */
  /* Variant Config 2*/
  Port_Init(Port_Config_Variant_2);

  /* Verifying the configuration values for Port Group 10 registers       */
  /* Check PortMode of Pin7 as Alternative Output (ALT11 IN)              */
  /* PMC:1(ALT) PIPC:0(S/W IO) <PFCEAE:1> PFCAE:0 PFCE:1 PFC:0 PM:1(IN)  */
  /* PU: 1, PD:0                                                          */
  if (((PMC10 & 0x0080) == 0x0080) && ((PIPC10 & 0x0080) == 0x0000)
      && ((PFCEAE10 & 0x0080) == 0x0080)
      && ((PFCAE10 & 0x0080) == 0x0000) && ((PFCE10 & 0x0080) == 0x0080) 
      && ((PM10 & 0x0080) == 0x0080) && ((PU10 & 0x0080) == 0x0080) 
      && ((PD10 & 0x0080) == 0x0000) && ((PIBC10 & 0x0080) == 0x0000) 
      && ((PFC10 & 0x0080) == 0x0000))
  {
    GaaTestResult_Variant2[0] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResult_Variant2[0] = (uint8)PORT_FAIL;
  }
  ...
  /* PortMode Setting of PortGroup10 PortPin6 is                          */
  /* "Alternative Output mode (ALT6 OUT)"                                 */
  /* PMC:1(ALT) PIPC:0(S/W IO) <PFCEAE:0> PFCAE:1 PFCE:0 PFC:1 PM:0(OUT)  */
  /* PINV:0 PODC:1 PODCE:1(P-ch open drain) PDSC:1 PUCC:0(Mid) P:1(High)  */

  Port_SetPinMode(PortConf_PortGroup10_PortPin6, PORT_APP_ALT6_OUT);
  if ((0x0040 == (PMC10 & 0x0040)) && (0x0000 == (PIPC10 & 0x0040)) 
  && (0x0000 == (PM10 & 0x0040)) && (0x0040 == (PFCAE10 & 0x0040)) 
  && (0x0000 == (PFCE10 & 0x0040)) && (0x0040 == (PFC10 & 0x0040)))
  {
    GaaTestResult_Variant2[1] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResult_Variant2[1] = (uint8)PORT_FAIL;
  }
  ...
  if (((PM10 & 0x0020) == 0x0020) && ((PMC10 & 0x0020) == 0x0000))
  {
    GaaTestResult_Variant2[2] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResult_Variant2[2] = (uint8)PORT_FAIL;
  }
  /*
     * Change the direction of PortGroup10 PortPin4
     * If the direction of pin is not changeable, refresh direction.
  ...
  */
  ...
  if (((PM10 & 0x0030) == 0x0020))
  {
    GaaTestResult_Variant2[3] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResult_Variant2[3] = (uint8)PORT_FAIL;
  } /* End of Port_RefreshPortDirection API */
  ...
  if ((PMC10 & 0x0008) == 0x0008)
  {
    GaaTestResult_Variant2[4] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResult_Variant2[4] = (uint8)PORT_FAIL;
  }
  /* This API will switch a pin of port from ALT to DIO. */
  Port_SetToDioMode(PortConf_PortGroup10_PortPin3);
  if ((PMC10 & 0x0004) == 0x0000)
  {
    GaaTestResult_Variant2[5] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResult_Variant2[5] = (uint8)PORT_FAIL;
  }
  ...
  if ((PM10 & 0x0004) == 0x0000)
  {
    GaaTestResult_Variant2[6] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResult_Variant2[6] = (uint8)PORT_FAIL;
  }

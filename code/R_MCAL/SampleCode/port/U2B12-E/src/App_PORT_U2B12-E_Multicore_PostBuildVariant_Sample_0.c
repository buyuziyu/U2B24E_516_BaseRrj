...
/* Module       = App_PORT_U2B12-E_Multicore_PostBuildVariant_Sample_0.c      */
/*============================================================================*/
/*                                  COPYRIGHT                                 */
/*============================================================================*/
...
int main(void)
{
  ...
  /* "Alternative Output mode (ALT3 IN)"                                 */
  ...
  && (0x0040 == (PM10 & 0x0040)) && (0 == (PFCAE10 & 0x0040)) 
  && (0x0040 == (PFCE10 & 0x0040)) && (0 == (PFC10 & 0x0040)))
  {
  ...
  */
  ...
  PKCPROT_REG = PORT_PWE_DISABLE_WRITE;
     ...
     */
  while (GucRefreshPinFlag_Variant1 == 1);
  Port_RefreshPortDirection();
  GucRefreshPinFlag_Variant1 = 1;
    /* Default Pin direction of PortGroup10
  ...
  */
  ...
  if (((PMC10 & 0x0080) == 0x0080) && ((PIPC10 & 0x0080) == 0x0000)
      ...
      && ((PFC10 & 0x0080) == 0x0000))
  {
    GaaTestResultPE0[8] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResultPE0[8] = (uint8)PORT_FAIL;
  }
  ...
  {
    GaaTestResultPE0[9] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResultPE0[9] = (uint8)PORT_FAIL;
  }
  /*
     * This API will change the direction of the pin to the requested
     * direction if the PortPinDirectionChangeable runtime parameter for
  ...
  if (((PM10 & 0x0020) == 0x0020) && ((PMC10 & 0x0020) == 0x0000))
  {
    GaaTestResultPE0[10] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResultPE0[10] = (uint8)PORT_FAIL;
  }
  ...
  */
  ...
  PKCPROT_REG = PORT_PWE_DISABLE_WRITE;
     ...
     * This API will refresh all the port pins to the configured value.
     */
  while (GucRefreshPinFlag_Variant2 == 1);
  Port_RefreshPortDirection();
  GucRefreshPinFlag_Variant2 = 1;
    /* Default Pin direction of PortGroup10
     * Pin5: direction changeable -> Not being affected after
     * refreshing.
     * Pin4: direction unchangeable -> change from IN to OUT after
  ...
  if (((PM10 & 0x0030) == 0x0020))
  {
    GaaTestResultPE0[11] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResultPE0[11] = (uint8)PORT_FAIL;
  } /* End of Port_RefreshPortDirection API */
  ...
  if ((PMC10 & 0x0008) == 0x0008)
  {
    GaaTestResultPE0[12] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResultPE0[12] = (uint8)PORT_FAIL;
  }
  ...
  if ((PMC10 & 0x0004) == 0x0000)
  {
    GaaTestResultPE0[13] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResultPE0[13] = (uint8)PORT_FAIL;
  }
  ...
  if ((PM10 & 0x0004) == 0x0000)
  {
    GaaTestResultPE0[14] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResultPE0[14] = (uint8)PORT_FAIL;
  }

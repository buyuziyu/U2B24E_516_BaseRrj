...
/* Module       = App_PORT_U2B12-E_Multicore_PostBuildVariant_Sample_1.c      */
/*============================================================================*/
/*                                  COPYRIGHT                                 */
/*============================================================================*/
...
int main_PE1(void)
{
  ...
  while (GucStubInitFlag_Variant1 == 0);

  /* Verifying the configuration values for Port Group 2 registers    */
  /* Check PortMode of Pin7 as Alternative Output (ALT10 OUT)              */
  /* PMC:1(ALT) PIPC:1(S/W IO) <PFCEAE:1> PFCAE:0 PFCE:0 PFC:1 PM:0(OUT)  */
  /* PU: 0, PD:0                                                          */

  if (((PMC2 & 0x0080) == 0x0080) && ((PIPC2 & 0x0080) == 0x0080) 
      && ((PFCAE2 & 0x0080) == 0x0000) && ((PFCE2 & 0x0080) == 0x0000) 
      && ((PM2 & 0x0080) == 0x0000) && ((PU2 & 0x0080) == 0x0000) 
      && ((PD2 & 0x0080) == 0x0000) && ((PIBC2 & 0x0080) == 0x0000) 
      && ((PFC2 & 0x0080) == 0x0080) && ((PFCEAE2 & 0x0080) == 0x0080))
  {
  ...
  /* "Alternative Output mode (ALT5 IN)"                                  */
  ...
  */
  ...
  GucRefreshPinFlag_Variant1 = 0;
  while (GucRefreshPinFlag_Variant1 == 0);
    /* Default Pin direction of PortGroup2
  ...
  /* Variant Config 2 */
  /* Waiting for Port_Init() initialize on core 0 */
  while (GucStubInitFlag_Variant2 == 0);

  /* Verifying the configuration values for Port Group 2 registers    */
  /* Check PortMode of Pin7 as Alternative Input (ALT5 IN)              */
  /* PMC:1(ALT) PIPC:1(S/W IO) <PFCEAE:0> PFCAE:1 PFCE:0 PFC:0 PM:1(IN)  */
  /* PU: 1, PD:0                                                          */

  if (((PMC2 & 0x0080) == 0x0080) && ((PIPC2 & 0x0080) == 0x0000) 
      && ((PFCAE2 & 0x0080) == 0x0080) && ((PFCE2 & 0x0080) == 0x0000) 
      && ((PM2 & 0x0080) == 0x0080) && ((PU2 & 0x0080) == 0x0080) 
      && ((PD2 & 0x0080) == 0x0000) && ((PIBC2 & 0x0080) == 0x0000) 
      && ((PFC2 & 0x0080) == 0x0000) && ((PFCEAE2 & 0x0080) == 0x0000))
  {
    GaaTestResultPE1[7] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResultPE1[7] = (uint8)PORT_FAIL;
  }
  ...
  /* PortMode Setting of PortGroup2 PortPin6 is                       */
  /* "Alternative Output mode (ALT4 OUT)"                                  */
  /* PMC:1(ALT) PIPC:0(S/W IO) <PFCEAE:0> PFCAE:0 PFCE:1 PFC:1 PM:0(OUT)  */

  Port_SetPinMode(PortConf_PortGroup2_PortPin6, PORT_APP_ALT4_OUT);
  if ((0x0040 == (PMC2 & 0x0040)) && (0x0000 == (PIPC2 & 0x0040)) 
  && (0x0000 == (PM2 & 0x0040)) && (0x0000 == (PFCAE2 & 0x0040)) 
  && (0x0040 == (PFCE2 & 0x0040)) && (0x0040 == (PFC2 & 0x0040)))
  {
    GaaTestResultPE1[8] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResultPE1[8] = (uint8)PORT_FAIL;
  }
  /*
     * This API will change the direction of the pin to the requested
     * direction if the PortPinDirectionChangeable runtime parameter for
  ...
  if (((PM2 & 0x0020) == 0x0020) && ((PMC2 & 0x0020) == 0x0000))
  {
    GaaTestResultPE1[9] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResultPE1[9] = (uint8)PORT_FAIL;
  }
  ...
  */
  ...
  GucRefreshPinFlag_Variant2 = 0;
  while (GucRefreshPinFlag_Variant2 == 0);
    /* Default Pin direction of PortGroup2
     * Pin5: direction changeable -> Not being affected after
     * refreshing.
     * Pin4: direction unchangeable -> change from IN to OUT after
  ...
  if (((PM2 & 0x0030) == 0x0020))
  {
    GaaTestResultPE1[10] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResultPE1[10] = (uint8)PORT_FAIL;
  } /* End of Port_RefreshPortDirection API */
  ...
  if ((PMC2 & 0x0008) == 0x0008)
  {
    GaaTestResultPE1[11] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResultPE1[11] = (uint8)PORT_FAIL;
  }
  ...
  if ((PMC2 & 0x0004) == 0x0000)
  {
    GaaTestResultPE1[12] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResultPE1[12] = (uint8)PORT_FAIL;
  }
  ...
  if ((PM2 & 0x0004) == 0x0000)
  {
    GaaTestResultPE1[13] = (uint8)PORT_PASS;
  }
  else
  {
    GaaTestResultPE1[13] = (uint8)PORT_FAIL;
  }

...
/* Module       = App_PWM_U2B6-E_Sample.c                                     */
/*                                                                            */
/*============================================================================*/
/*                                  COPYRIGHT                                 */
/*============================================================================*/
...
*******************************************************************************/
/*                                                                            **
 * 2.5.1:  30/06/2025 : Update Port_Init for TAUJ                             **
 ...
 * 2.3.0:  31/12/2024 : For GTM support, add the following                    **
 *                      1. Add TOM/ATOM EIC                                   **
...
void Port_Init(void)
{
  ...
  /* P57-CN17 P22_09_ALT_OUT15 (TAUJ2O3) |    1     1    1    0  | 0  |  1  |  */
  ...
  /* Port set alt out mode for pin P22 for TAUJ2O1 and TAUJ2O3 channel */
  PWM_PFCEAE(22) |= (uint16)((1u<<9)|(1u<<11));
  PWM_PFCAE(22)  |= (uint16)((1u<<9)|(1u<<11));
  PWM_PFCE(22)   |= (uint16)((1u<<9)|(1u<<11));
  PWM_PFC(22)    &= (uint16)(~((1u<<9)|(1u<<11)));
  PWM_PM(22)     &= (uint16)(~((1u<<9)|(1u<<11)));
  PWM_PMC(22)    |= (uint16)((1u<<9)|(1u<<11));
}

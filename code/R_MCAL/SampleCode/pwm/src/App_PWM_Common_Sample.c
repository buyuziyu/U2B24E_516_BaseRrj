...
/* Module       = App_PWM_Common_Sample.c                                     */
/*                                                                            */
/*============================================================================*/
/*                                  COPYRIGHT                                 */
/*============================================================================*/
 ...
 *                     2. Add U2BxE to section Global variables               **
 *                     3. Update input(notification type) for API             **
 *                        Pwm_EnableNotification and Pwm_DisableNotification  **
 *                     4. Update channel intput                               **
 * 2.0.1: 25/10/2023 : Update version in header comment                       **
 * 1.4.3: 30/05/2022 : Add new process to get notification from TAUD3 channel **
...
#endif
{
  ...
  */
  ...
  #if(PWM_SET_DUTY_CYCLE_API == STD_ON)
    /* Set the Duty cycle for channel 1 Pwm-Diag */
  ...
  */
  ...
  #if (PWM_DIAG_UNIT_USED == STD_ON)
  #if (PWM_SET_OUTPUT_TO_IDLE_API == STD_ON)
  /* Set PWM channel 2 Pwm-Diag to its idle state */
  ...
  #if (PWM_DIAG_UNIT_USED == STD_ON)
  #if (PWM_SET_DUTY_CYCLE_API == STD_ON)
  /* Set the Duty cycle for channel 2 Pwm-Diag */
  ...
  */
  ...
  GulEdgeIntCount[1] = 0;
  /* Disable the notifications for PWM master channel 5 */
  Pwm_DisableNotification(Pwm_PwmChannel5);
  /* Reset GulEdgeIntCount to 0 */
  GulEdgeIntCount[5] = 0;
  #if (STD_ON == PWM_TAUD_UNIT_USED && STD_ON == PWM_TAUD3_UNIT_USED)
  /* Disable the notifications for PWM channel 7 */
...
void Pwm_Notification_PwmChannel_002(void)
{
#ifdef USE_FREERUN_TIMER
...
void Pwm_Notification_PwmChannel_003(void)
{
#ifdef USE_FREERUN_TIMER
...
void Pwm_Notification_PwmChannel_006(void)
{
#ifdef USE_FREERUN_TIMER
...
void Pwm_Notification_PwmChannel_007(void)
{
#ifdef USE_FREERUN_TIMER
...
#if (DEVICE != U2Cx) && (DEVICE != U2Ax)
#if(PWM_DIAG_UNIT_USED == STD_ON)
void Pwm_DiagNotification_00 (uint32 LulIntFactor)
{
  GulEdgeIntCount[8]++;
}
...
void Pwm_Notification_PwmChannel_008(void)
{
#ifdef USE_FREERUN_TIMER
...
void Pwm_Notification_PwmChannel_009(void)
{
#ifdef USE_FREERUN_TIMER

...
/* Module       = App_PWM_Common_Sample_0.c                                   */
/*                                                                            */
/*============================================================================*/
/*                                  COPYRIGHT                                 */
/*============================================================================*/
 ...
 * 1.4.3: 22/04/2022 : Add sequence testing Pwm_SetChannelOutput for          **
 *                     Pwm_PwmChannel2                                        **
...
{
#ifdef USE_FREERUN_TIMER
  GulTimerChannel8CountA = GulTimerChannel6CountB;
...
{
#ifdef USE_FREERUN_TIMER
  GulTimerChannel9CountA = GulTimerChannel6CountB;

...
/* Module       = App_PWM_Common_Multicore_PostBuildVariant_Sample_1.c        */
/*                                                                            */
/*============================================================================*/
/*                                  COPYRIGHT                                 */
/*============================================================================*/
 ...
 * 2.3.2: 15/04/2025 : Update to not call Pwm_SetChannelOutput for U2Ax GTM   **
 * 2.3.1: 31/03/2025 : As part of GTM support, following changes are made     **
...
#endif
void main_sequence_PE1(const Pwm_ConfigType * Pwm_Config);
/*******************************************************************************
...
void main_PE1(void)
{
  ...
  main_sequence_PE1(Pwm_Config_Variant_1);
  /* Call sequence on core 1 variant 2 */
  main_sequence_PE1(Pwm_Config_Variant_2);
...
void main_sequence_PE1(const Pwm_ConfigType * Pwm_Config)
{
  ...
  {
    GulEdgeIntCount_PE1[LucCountTmp] = 0;
    GucOutputState_PE1 = 0;
  }

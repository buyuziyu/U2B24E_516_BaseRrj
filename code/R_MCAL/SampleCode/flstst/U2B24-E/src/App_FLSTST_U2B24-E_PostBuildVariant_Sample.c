...
/* Module       = App_FLSTST_U2B24-E_Sample.c                                 */
/*============================================================================*/
/*                                  COPYRIGHT                                 */
/*============================================================================*/
...
const uint8 GulFgndCrcSignature_Variant1[] = {0x0a, 0x9e};
const uint8 GulBgndCrcSignature_Variant1[] = {0x32, 0x05};
#pragma ghs section rodata = default
#pragma ghs section rodata = ".FLSTST_CRCSIG_STORE_1"
const uint8 GulFgndCrcSignature_Variant2[] = {0x34, 0xe4, 0x8c, 0xc1};
const uint8 GulBgndCrcSignature_Variant2[] = {0x9c, 0x55, 0xc4, 0xad};
#pragma ghs section rodata = default

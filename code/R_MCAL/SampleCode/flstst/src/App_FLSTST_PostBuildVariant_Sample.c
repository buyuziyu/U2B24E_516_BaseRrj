 ...
 * 1.1.1:  07/08/2024  : Move CRC value to specific device
 * 1.0.0:  01/06/2024  : Initial Version
 */
/******************************************************************************/
...
**                     Include Section                                        **
*******************************************************************************/
#include "App_FLSTST_PostBuildVariant_Sample.h"
...
FlsTst_TestSignatureFgndType GulSignatureFgnd_Variant1;
FlsTst_TestSignatureFgndType GulSignatureFgnd_Variant2;
FlsTst_TestResultFgndType GucTestResultFgnd_Variant1;
FlsTst_TestResultFgndType GucTestResultFgnd_Variant2;

/* Background test callback status */
uint8 GblTestCompleteStatus_Variant1;
uint8 GblTestCompleteStatus_Variant2;
uint8 LucLoopCount;
FlsTst_TestResultBgndType GucTestResultBgnd_Variant1;
FlsTst_TestResultBgndType GucTestResultBgnd_Variant2;

/*******************************************************************************
**                        User function prototypes                            **
*******************************************************************************/
/* Function check pass fail checkpoint */
void TestPass(void);
void TestFail(void);

/* Function prototype variant support */
void Flstst_VariantSupport_1(void);
void Flstst_VariantSupport_2(void);
...
#endif
{
  ...
  /* ======= VARIANT_1 ========= */
  /* Initialize FLSTST at Variant 1 */
  FlsTst_Init(FlsTst_Config_Variant_1);

  /* Invoke function variant 1 */
  Flstst_VariantSupport_1();

  /* ======= VARIANT_2 ========= */
  /* Initialize FLSTST at Variant 2 */
  FlsTst_Init(FlsTst_Config_Variant_2);
  
  /* Invoke function variant 2 */
  Flstst_VariantSupport_2();
#if defined(RUN_OTHER_PE)
return 0;
#endif
}
...
/* Function Flstst Variant 1 */
void Flstst_VariantSupport_1()
{
  ...
  {
    GulSignatureFgnd_Variant1 = FlsTst_GetTestSignatureFgnd();
    GucTestResultFgnd_Variant1 = FlsTst_GetTestResultFgnd();

    if ((FlsTst_TestResultType)GucTestResultFgnd_Variant1 == FLSTST_RESULT_OK)
    {
      GblTestResult = FLSTST_TRUE;
    }
    else
  ...
  GblTestCompleteStatus_Variant1 = FLSTST_FALSE;

  /* Invoke  FlsTst main function */
  while (GblTestCompleteStatus_Variant1 != FLSTST_TRUE)
  {  
  FlsTst_MainFunction();
  }

  /* Get the test Bgnd test status */
  GucTestResultBgnd_Variant1 = FlsTst_GetTestResultBgnd();

  if ((FlsTst_TestResultType)GucTestResultBgnd_Variant1.enTestResultBgnd == FLSTST_RESULT_OK)
  {
	GblTestResult = FLSTST_TRUE;
  } 
  else
  ...
  /* De-Initialize FLSTST at Variant 1 */
  FlsTst_DeInit();
...
/* Function Flstst Variant 2 */
void Flstst_VariantSupport_2()
{
  /* Get the current FlsTst Execution state */
  GddExecutionState = FlsTst_GetCurrentState();
  ...
  if (GddReturnValue == E_OK)
  {
    GulSignatureFgnd_Variant2 = FlsTst_GetTestSignatureFgnd();
    GucTestResultFgnd_Variant2 = FlsTst_GetTestResultFgnd();

    if ((FlsTst_TestResultType)GucTestResultFgnd_Variant2 == FLSTST_RESULT_OK)
    {
      GblTestResult = FLSTST_TRUE;
    }
    else
  ...
  /* Background  flash test*/
  GblTestCompleteStatus_Variant2 = FLSTST_FALSE;

  /* Invoke  FlsTst main function */
  while (GblTestCompleteStatus_Variant2 != FLSTST_TRUE)
  {  
  FlsTst_MainFunction();
  }

  /* Get the test Bgnd test status */
  GucTestResultBgnd_Variant2 = FlsTst_GetTestResultBgnd();

  if ((FlsTst_TestResultType)GucTestResultBgnd_Variant2.enTestResultBgnd == FLSTST_RESULT_OK)
  {
	GblTestResult = FLSTST_TRUE;
  } 
  else
  ...
  /* De-Initialize FLSTST at Variant 2 */
  FlsTst_DeInit();
...
FUNC(void, FLSTST_APPL_CODE) TestCompleteNotification_001(void)
{
  GblTestCompleteStatus_Variant1 = FLSTST_TRUE;
}

FUNC(void, FLSTST_APPL_CODE) TestCompleteNotification_002(void)
{
  GblTestCompleteStatus_Variant2 = FLSTST_TRUE;
}

...
/* Module       = App_RAMTST_Multi_Sample.c                                   */
/*============================================================================*/
/*                                  COPYRIGHT                                 */
/*============================================================================*/
...
**                         Global Data                                        **
*******************************************************************************/
uint8 GucTestCompleteStatus_Core0;
uint8 GucErrorStatus_Core0;
uint8 GucTestCompleteStatus_Core1;
uint8 GucErrorStatus_Core1;

/*******************************************************************************
                        RAMTST Module Initialization
*******************************************************************************/
void Init_MCAL(void)
{
 /* Initialize Watchdog */
...
void Complete_Notify(void)
{
  ...
  if (LucCoreId == 0)
  {
    GucTestCompleteStatus_Core0 = RAMTST_TRUE;
  } 
  if (LucCoreId == 1)
  {
    GucTestCompleteStatus_Core1 = RAMTST_TRUE;
  }
}
...
void Error_Notify(void)
{
  ...
  if (LucCoreId == 0)
  {
    GucErrorStatus_Core0 = RAMTST_TRUE;
  } 
  if (LucCoreId == 1)
  {
    GucErrorStatus_Core1 = RAMTST_TRUE;
  }
}

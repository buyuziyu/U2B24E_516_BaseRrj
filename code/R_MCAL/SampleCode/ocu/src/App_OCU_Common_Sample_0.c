...
/* Module       = App_OCU_Common_Sample_0.c                                                                           */
/*====================================================================================================================*/
/*                                                     COPYRIGHT                                                      */
/*====================================================================================================================*/
...
int main(void)
{
  ...
  PE0_SYNC();
  /* Task 2 with channel Ocu_OcuChannelConfiguration0 */
  task2(Ocu_OcuChannelConfiguration0);
  /* Waiting Initialization by PE1 */
  PE0_SYNC();
  ...
  /* Waiting Initialization by PE1 */
  PE0_SYNC();
  /* Task 2 with channel Ocu_OcuChannelConfiguration2 */
  task2(Ocu_OcuChannelConfiguration2);
  /* Waiting Initialization by PE1 */
  PE0_SYNC();
  #endif
  ...
  /* Waiting Initialization by PE1 */
  PE0_SYNC();
  /* Task 2 with channel Ocu_OcuChannelConfiguration4 */
  task2(Ocu_OcuChannelConfiguration4);
  /* Waiting Initialization by PE1 */
  PE0_SYNC();
  #endif
...
/* Task2, service API on core 0 for TAU channel*/
int task2(uint8 channel_index)
{

...
/* Module       = App_OCU_Common_Sample_1.c                                                                           */
/*====================================================================================================================*/
/*                                                     COPYRIGHT                                                      */
/*====================================================================================================================*/
...
int main_PE1(void)
{
  ...
  PE1_SYNC();
  /* Task 3 with channel Ocu_OcuChannelConfiguration1 */
  task3(Ocu_OcuChannelConfiguration1);
  /* Waiting Initialization by PE0 */
  PE1_SYNC();
  ...
  /* Waiting Initialization by PE0 */
  PE1_SYNC();
  /* Task 3 with channel Ocu_OcuChannelConfiguration3 */
  task3(Ocu_OcuChannelConfiguration3);
  /* Waiting Initialization by PE0 */
  PE1_SYNC();
  #endif
  ...
  /* Waiting Initialization by PE0 */
  PE1_SYNC();
  /* Task 3 with channel Ocu_OcuChannelConfiguration5 */
  task3(Ocu_OcuChannelConfiguration5);
  /* Waiting Initialization by PE0 */
  PE1_SYNC();
  #endif
...
int task3(uint8 channel_index)
{
  ...
  {
  /* Wait for the counter count to countVal */

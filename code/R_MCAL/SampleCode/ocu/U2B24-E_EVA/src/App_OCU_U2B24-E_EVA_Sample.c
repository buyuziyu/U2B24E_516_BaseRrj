...
/* Module       = App_OCU_U2B24-E_EVA_Sample.c                                                                        */
/*====================================================================================================================*/
/*                                                     COPYRIGHT                                                      */
/*====================================================================================================================*/
 ...
 *                         1. Update Port_Init for TAUD1O1, TAUJ2O1
...
uint8 GaaListChannel[5] = {0,2,3,4,5};
/***********************************************************************************************************************
...
void Clock_Init(void)
{
  ...
  /* For TAUDn the default clock source is CLKC_HSB */
  CLKKCPROT1  = ENABLE_WRITE_KEY_CODE;
  CKS_ATAUJC |= 0x4UL;
  CLKKCPROT1  = DISABLE_WRITE_KEY_CODE;
}
...
void Port_Init(void)
{
  ...
  /* P23_00_ALT_OUT16 (TAUD1O1)  |    1     1    1    1  | 0  |  1  |  */
  ...
  /* Port set alt out mode for pin P00_01 mode ATL_OUT6 channel TAUD1O1 ouput symbol 'TAUD1O1' */
  OCU_PFCEAE(23) |= (uint16)(1u<<0);
  OCU_PFCAE(23)  |= (uint16)(1u<<0);
  OCU_PFCE(23)   |= (uint16)(1u<<0);
  OCU_PFC(23)    |= (uint16)(1u<<0);
  OCU_PM(23)     &= (uint16)(~(1u<<0));
  OCU_PMC(23)    |= (uint16)(1u<<0);

...
/* Module       = App_ETH_PostBuildVariant_Sample.c                           */
/*============================================================================*/
/*                                  COPYRIGHT                                 */
/*============================================================================*/
 ...
 * 2.0.2: 28/03/2024    : Initial Version.
 */
/******************************************************************************/
...
volatile uint8 EthPassedCount[140];
...
/* Board MAC address */
static uint8 mac_board_addr[2][SRC_MACADDR_LEN] =
{
...
#endif
{
  ...
  for (LucCtrlCnt = 0; LucCtrlCnt < ETH_TOTAL_CTRL_CONFIG; LucCtrlCnt++)
  {
    switch (Eth_Config_Variant_2->pCtrlConfig->pEthConfig[LucCtrlCnt].enEthPHYInterface)
    {
    case ETH_MII:

...
/* Module       = App_SPI_U2B6-E_Sample.c                                                                             */
/*====================================================================================================================*/
/*                                                COPYRIGHT                                                           */
/*====================================================================================================================*/
...
{
  /* HW Unit: DMA */
  70UL,  /* EIC70 (INTSDMA0CH0)  */       /*   Index 0   */
  71UL,  /* EIC71 (INTSDMA0CH1)  */       /*   Index 1   */
  72UL,  /* EIC72 (INTSDMA0CH2)  */       /*   Index 2   */
  73UL,  /* EIC73 (INTSDMA0CH3)  */       /*   Index 3   */
  74UL,  /* EIC74 (INTSDMA0CH4)  */       /*   Index 4   */
  75UL,  /* EIC75 (INTSDMA0CH5)  */       /*   Index 5   */
  76UL,  /* EIC76 (INTSDMA0CH6)  */       /*   Index 6   */
  77UL,  /* EIC77 (INTSDMA0CH7)  */       /*   Index 7   */
  78UL,  /* EIC78 (INTSDMA0CH8)  */       /*   Index 8   */
  79UL,  /* EIC79 (INTSDMA0CH9)  */       /*   Index 9   */
  80UL,  /* EIC80 (INTSDMA0CH10) */       /*   Index 10   */
  81UL,  /* EIC81 (INTSDMA0CH11) */       /*   Index 11   */
  82UL,  /* EIC82 (INTSDMA0CH12) */       /*   Index 12   */
  83UL,  /* EIC83 (INTSDMA0CH13) */       /*   Index 13   */
  84UL,  /* EIC84 (INTSDMA0CH14) */       /*   Index 14   */
  85UL,  /* EIC85 (INTSDMA0CH15) */       /*   Index 15   */
  825UL,  /* EIC825 (INTSDMA1CH0)  */       /*   Index 16   */
  826UL,  /* EIC826 (INTSDMA1CH1)  */       /*   Index 17   */
  827UL,  /* EIC827 (INTSDMA1CH2)  */       /*   Index 18   */
  828UL,  /* EIC828 (INTSDMA1CH3)  */       /*   Index 19   */
  829UL,  /* EIC829 (INTSDMA1CH4)  */       /*   Index 20   */
  830UL,  /* EIC830 (INTSDMA1CH5)  */       /*   Index 21   */
  831UL,  /* EIC831 (INTSDMA1CH6)  */       /*   Index 22   */
  832UL,  /* EIC832 (INTSDMA1CH7)  */       /*   Index 23   */
  833UL,  /* EIC833 (INTSDMA1CH8)  */       /*   Index 24   */
  834UL,  /* EIC834 (INTSDMA1CH9)  */       /*   Index 25   */
  835UL,  /* EIC835 (INTSDMA1CH10) */       /*   Index 26   */
  836UL,  /* EIC836 (INTSDMA1CH11) */       /*   Index 27   */
  837UL,  /* EIC837 (INTSDMA1CH12) */       /*   Index 28   */
  838UL,  /* EIC838 (INTSDMA1CH13) */       /*   Index 29   */
  839UL,  /* EIC839 (INTSDMA1CH14) */       /*   Index 30   */
  840UL,  /* EIC840 (INTSDMA1CH15) */       /*   Index 31   */
  /* HW Unit: MSPI */
...
void Port_Init(void)
{
  ...
  REG_PWE = 0x007F7FFFUL;
  REG_PKCPROT = SPI_KCPROT_CLR;

  while(REG_PWE != 0x007F7FFFUL)
  {
    ASM_NOP();
  };
  ...
  /* MSPI0 */
  /*                                   | PMC PM PIPC | PFCAE PFCE PFCn | */
  /* P11_5   : AF1(IN/OUT) : MSPI0SC   | 1   *  1    | 0     0    0    | */
  /* P11_4   : AF2(IN)     : MSPI0SI   | 1   1  0    | 0     0    1    | */
  /* P11_9   : AF1(OUT)    : MSPI0SO   | 1   *  1    | 0     0    0    | */
  /* P11_9   : AF1(IN)     : MSPI0DCS  | 1   *  1    | 0     0    0    | */
  /* P20_3   : AF2(OUT)    : MSPI0CSS0 | 1   0  0    | 0     0    1    | */

  Spi_PortSetting(11, 5, 1, ALT_INOUT1);
  Spi_PortSetting(11, 4, 0, ALT_IN2);
  Spi_PortSetting(11, 9, 1, ALT_OUT1);
  Spi_PortSetting(20, 3, 0, ALT_OUT2);

  /* <PORT_base>=0xFFD90000UL */
  /* MSPI1 */
  /*                                   | PMC PM PIPC | PFCAE PFCE PFCn | */
  /* P11_2   : AF1(IN/OUT) : MSPI1SC   | 1   *  1    | 0     0    0    | */
  /* P11_6   : AF1(IN)     : MSPI1SI   | 1   1  0    | 0     0    0    | */
  /* P11_7   : AF2(OUT)    : MSPI1SO   | 1   *  1    | 0     0    1    | */
  /* P11_7   : AF2(IN)     : MSPI1DCS  | 1   *  1    | 0     0    1    | */
  /* P11_1   : AF1(IN)     : MSPI1SSIZ | 1   1  0    | 0     0    0    | */

  Spi_PortSetting(11, 2, 1, ALT_INOUT1);
  Spi_PortSetting(11, 6, 0, ALT_IN1);
  Spi_PortSetting(11, 7, 1, ALT_OUT2);
  Spi_PortSetting(11, 1, 0, ALT_IN1);

  /* Variant 2 */
  /* <PORT_base>=0xFFD90000UL */
  /* MSPI2 */
  /*                                      | PMC PIPC  | PFCAE PFCE  PFCn  PM  | */
  /* P14_0    : AF4 (IN/OUT) : MSPI2SC    |  1    1   |   0     1     1    *  | */
  /* P14_2    : AF4 (IN)     : MSPI2SI    |  1    0   |   0     1     1    1  | */
  /* P14_3    : AF1 (OUT)    : MSPI2SO    |  1    1   |   0     0     0    *  | */
  /* P20_4    : AF3 (OUT)    : MSPI2CSS0  |  1    0   |   0     1     0    0  | */

  Spi_PortSetting(14, 0, 1, ALT_INOUT4);
  Spi_PortSetting(14, 2, 0, ALT_IN4);
  Spi_PortSetting(14, 3, 1, ALT_OUT1);
  Spi_PortSetting(20, 4, 0, ALT_OUT3);

  /* MSPI3 */
  /*                                      | PMC PIPC  | PFCAE PFCE  PFCn  PM  | */
  /* P02_9    : AF1 (IN/OUT) : MSPI3SC    |  1    1   |   0     0     0    *  | */
  /* P02_6    : AF4 (IN)     : MSPI3SI    |  1    0   |   0     1     1    1  | */
  /* P02_5    : AF1 (OUT)    : MSPI3SO    |  1    1   |   0     0     0    *  | */
  /* P02_3    : AF1 (IN)     : MSPI3SSI   |  1    0   |   0     0     0    1  | */

  Spi_PortSetting(2, 9, 1, ALT_INOUT1);
  Spi_PortSetting(2, 6, 0, ALT_IN4);
  Spi_PortSetting(2, 5, 1, ALT_OUT1);
  Spi_PortSetting(2, 3, 0, ALT_IN1);

...
/* Module       = App_SPI_Common_Multicore_PostBuildVariant_Sample_0.c                                                */
/*====================================================================================================================*/
/*                                                COPYRIGHT                                                           */
/*====================================================================================================================*/
 ...
 *                     : Update macro device for not using Guard_Enable_PE in U2Ax
...
volatile Spi_StatusType App_GenStatus_0;
#else
Spi_StatusType App_GenStatus_0;
#endif

/* Variable used to store the Module Version Info */
Std_VersionInfoType App_GstVersionInfo_0;

/* Variable to check the result of API */
#if defined (CCRH)
volatile boolean App_GaaTestResult_0[SPI_CHECK_POINTS];
#else
...
#if defined (CCRH)
uint32 App_GaaWriteBuffer0_Variant1[] = {11, 12, 13, 14};
uint32 App_GaaReadBuffer0_Variant1[4] = { 0 };
uint32 App_GaaWriteBuffer1_Variant1[] = {15, 16, 17, 18};
uint32 App_GaaReadBuffer1_Variant1[4] = { 0 };
#else
uint8 App_GaaWriteBuffer0_Variant1[] = {11, 12, 13, 14};
uint8 App_GaaReadBuffer0_Variant1[4];
uint8 App_GaaWriteBuffer1_Variant1[] = {15, 16, 17, 18};
uint8 App_GaaReadBuffer1_Variant1[4];
#endif

#if defined (CCRH)
uint32 App_GaaWriteBuffer0_Variant2[] = {21, 22, 23, 24};
uint32 App_GaaReadBuffer0_Variant2[4] = { 0 };
uint32 App_GaaWriteBuffer1_Variant2[] = {25, 26, 27, 28};
uint32 App_GaaReadBuffer1_Variant2[4] = { 0 };
#else
uint8 App_GaaWriteBuffer0_Variant2[] = {21, 22, 23, 24};
uint8 App_GaaReadBuffer0_Variant2[4];
uint8 App_GaaWriteBuffer1_Variant2[] = {25, 26, 27, 28};
uint8 App_GaaReadBuffer1_Variant2[4];
#endif

volatile uint8 App_Finish_Variant;
...
int main(void)
{
  ...
  /* Enable Guard PE for Multicore with Multiple Post-build variant */
  #if ((DEVICE == U2Bx)||(DEVICE == U2Cx)||(DEVICE == U2BxE))
  Guard_Enable_PE();
  #endif
  /* PROGRAM START */
  ...
  if (E_OK == LddInitCheckValue)
  {
    ...
    App_GenStatus_0 = Spi_GetStatus();

    /* Read and check the SPI Driver version information. */
    #if (SPI_VERSION_INFO_API == STD_ON)
    Spi_GetVersionInfo(&App_GstVersionInfo_0);
    SPI_RESULT_ASSERT(
                        (SPI_VENDOR_ID == App_GstVersionInfo_0.vendorID) &&
                        (SPI_MODULE_ID == App_GstVersionInfo_0.moduleID) &&
                        (SPI_SW_MAJOR_VERSION == App_GstVersionInfo_0.sw_major_version) &&
                        (SPI_SW_MINOR_VERSION == App_GstVersionInfo_0.sw_minor_version) &&
                        (SPI_SW_PATCH_VERSION == App_GstVersionInfo_0.sw_patch_version)
                     );
    #endif
    ...
    SPI_RESULT_ASSERT(E_OK == Spi_WriteIB(SpiConf_SpiChannel_SpiChannel_001, (Spi_DataBufferType *)App_GaaWriteBuffer1_Variant1));
    #endif
    ...
    #if ((SPI_CHANNEL_BUFFERS_ALLOWED == SPI_IB) || (SPI_CHANNEL_BUFFERS_ALLOWED == SPI_IBEB))
    SPI_RESULT_ASSERT(E_OK == Spi_ReadIB(SpiConf_SpiChannel_SpiChannel_001, (Spi_DataBufferType *)App_GaaReadBuffer1_Variant1));
    #endif
    ...
    SPI_RESULT_ASSERT(E_OK == Spi_AppVerifyData((Spi_DataBufferType *)App_GaaWriteBuffer0_Variant1, (Spi_DataBufferType *)App_GaaReadBuffer1_Variant1, 2));

    /* Clear buffer */
    Spi_ClearBuffer((Spi_DataBufferType *)App_GaaReadBuffer1_Variant1, sizeof(App_GaaReadBuffer1_Variant1));
...
/**********************************************************************************************************************/
    ...
    SPI_RESULT_ASSERT(E_OK == Spi_SetupEB(SpiConf_SpiChannel_SpiChannel, (Spi_DataBufferType *)App_GaaWriteBuffer0_Variant2, (Spi_DataBufferType *)App_GaaReadBuffer0_Variant2, 2));
    #endif
    ...
    /* Verify master/slave data */
    SPI_RESULT_ASSERT(E_OK == Spi_AppVerifyData((Spi_DataBufferType *)App_GaaWriteBuffer1_Variant2, (Spi_DataBufferType *)App_GaaReadBuffer0_Variant2, 2));

    /* Clear buffer */
    Spi_ClearBuffer((Spi_DataBufferType *)App_GaaReadBuffer0_Variant2, sizeof(App_GaaReadBuffer0_Variant2));

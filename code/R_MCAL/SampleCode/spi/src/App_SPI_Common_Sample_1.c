...
/* Module       = App_SPI_Common_Sample_1.c                                                                           */
/*====================================================================================================================*/
/*                                                COPYRIGHT                                                           */
/*====================================================================================================================*/
 ...
 * 1.0.1:  07/02/2020  : Update the numbe of buffers to trasmit to support
 *                       Fixed FIFO mode in MSPI.
 * 1.0.0:  23/08/2019  : Change value of App_GaaWriteBuffer_1 in PE1
 *                       to distinguish with App_GaaWriteBuffer_0_0 in PE0
 *         13/03/2019  : Initial Version
 */
/**********************************************************************************************************************/
...
int main_PE1(void)
{
  ...
  SPI_RESULT_ASSERT(E_OK == Spi_SetupEB(SpiConf_SpiChannel_SpiChannel, (Spi_DataBufferType *)App_GaaWriteBuffer0, (Spi_DataBufferType *)App_GaaReadBuffer0, 2));
  #endif
  ...
  SPI_RESULT_ASSERT(E_OK == Spi_AppVerifyData((Spi_DataBufferType *)App_GaaWriteBuffer1, (Spi_DataBufferType *)App_GaaReadBuffer0, 2));

  /* Clear buffer */
  Spi_ClearBuffer((Spi_DataBufferType *)App_GaaReadBuffer0, sizeof(App_GaaReadBuffer0));

 ...
 *                         Change from #include "Wdg_59.h" to #include "Wdg_59_Inst1.h"
 *                         Update macros name: 
 ...
 *                         Update APIs name:  
 *                         Wdg_59_GetVersionInfo        -> Wdg_59_Inst1_GetVersionInfo
 *                         Wdg_59_SetMode               -> Wdg_59_Inst1_SetMode
 *                         Wdg_59_SetTriggerCondition   -> Wdg_59_Inst1_SetTriggerCondition
 *                         Wdg_59_Init(Wdg_59_Config_1) -> Wdg_59_Inst1_Init(Wdg_59_Inst1_Config)
 * 1.2.1:  06/05/2021    : Improve source code to fix
 *                         Style_Format_008, Style_Format_015

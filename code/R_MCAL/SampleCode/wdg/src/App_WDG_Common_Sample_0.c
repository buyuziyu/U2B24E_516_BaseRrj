 ...
 * 2.1.1:  31/08/2024    : Update macro EIBD705 to EIBD
 ...
 *                         Change from #include "Wdg_59.h" to #include "Wdg_59_Inst0.h"
 *                         Update macros name: 
 ...
 *                         Update APIs name:  
 *                         Wdg_59_GetVersionInfo        -> Wdg_59_Inst0_GetVersionInfo
 *                         Wdg_59_SetMode               -> Wdg_59_Inst0_SetMode
 *                         Wdg_59_SetTriggerCondition   -> Wdg_59_Inst0_SetTriggerCondition
 *                         Wdg_59_Init(Wdg_59_Config_0) -> Wdg_59_Inst0_Init(Wdg_59_Inst0_Config)
 * 1.2.1:  06/05/2021    : Improve source code to fix Style_Format_015
 * 1.2.0:  26/08/2020    : Release
 * 1.1.0:  19/06/2020    : Release
 * 1.0.1:  14/05/2020    : Support barrier-synchronization for E2x
...
*******************************************************************************/
#include "Wdg.h"
#include "App_WDG_Multi_Sample.h"
...
int main(void)
{
  ...
  #endif
  {
    while (1)
    {
      /* The sample application is success */
    }
  }
  else
  {

...
/* Module       = App_MCU_U2B12-E_PostBuildVariant_Sample.c                   */
/*============================================================================*/
/*                                  COPYRIGHT                                 */
/*============================================================================*/
...
#endif
{
  ...
  GenInitRamSectionResult[4] = Mcu_InitRamSection(MCU_LRAM_SELF_SETTING);
  #endif

  /* Initialize Cluster RAM */
  #if defined MCU_CRAM_SETTING
  GenInitRamSectionResult[5] = Mcu_InitRamSection(MCU_CRAM_SETTING);
  #endif

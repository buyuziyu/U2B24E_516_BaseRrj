...
/* Module       = App_MCU_U2B6-E_PostBuildVariant_Sample.c                    */
/*============================================================================*/
/*                                  COPYRIGHT                                 */
/*============================================================================*/
 ...
 *                       Add canceling module standby mode of GTM
...
volatile Std_ReturnType              GenInitRamSectionResult[4];
...
#endif
{
  ...
  GenInitRamSectionResult[2] = Mcu_InitRamSection(MCU_LRAM_SELF_SETTING);
  #endif

  /* Initialize Cluster RAM */
  #if defined MCU_CRAM_SETTING
  GenInitRamSectionResult[3] = Mcu_InitRamSection(MCU_CRAM_SETTING);
  #endif

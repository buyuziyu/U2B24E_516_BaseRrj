...
#define MCU_LRAM_SETTING_4 \
                    McuRamSectorSettingConf_McuRamSectorSettingConf_004
                    
#define MCU_LRAM_SETTING_5 \
                    McuRamSectorSettingConf_McuRamSectorSettingConf_005
                    
#define MCU_LRAM_SETTING_6 \
                    McuRamSectorSettingConf_McuRamSectorSettingConf_006
                    
#define MCU_LRAM_SELF_SETTING \
                    McuRamSectorSettingConf_McuRamSectorSettingConf_007
  
#define MCU_CRAM_SETTING \
                    McuRamSectorSettingConf_McuRamSectorSettingConf_008

...
int main(void)
{
  ...
  Dio_WritePort(DioConf_DioPort_UserPort_PG20, (Dio_PortLevelType)0x003F);
  /* To Read the Port value */
  LddPortLevel_PE0 = Dio_ReadPort(DioConf_DioPort_UserPort_PG20);
  
  if ((Dio_PortLevelType)0x003F ==
      (Dio_PortLevelType)(LddPortLevel_PE0 & (Dio_PortLevelType)0x003F))
  {
  ...
  Dio_WriteChannelGroup(DioConf_DioChannelGroup_UserChannelGroup_PG20,
                        (Dio_PortLevelType)0x0038);
  /* To Read the ChannelGroup Output value  */
  LddPortLevel_PE0 = Dio_ReadChannelGroupOutputValue(DioConf_DioChannelGroup_UserChannelGroup_PG20);
  if ((Dio_PortLevelType)0x0038 == LddPortLevel_PE0)
  {
    GaaTestResult_PE0[6] = (uint8)TRUE;

    /* To Read the ChannelGroup Level value  */
    LddPortLevel_PE0 = Dio_ReadChannelGroup(DioConf_DioChannelGroup_UserChannelGroup_PG20);
    if ((Dio_PortLevelType)0x0038 == LddPortLevel_PE0)
    {

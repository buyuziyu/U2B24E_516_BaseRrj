...
/* Module       = App_ICU_PostBuildVariant_Sample.c                           */
/*============================================================================*/
/*                                  COPYRIGHT                                 */
/*============================================================================*/
 ...
 * 2.0.2:  23/03/2024  : Update Big_Delay() to avoid code optimize
           25/02/2024  : Initial Version
 */
/******************************************************************************/
...
void Big_Delay(void);
void Reg_Init(void);
void main_sequence(const Icu_ConfigType * Icu_Config);
...
#endif
{
  ...
  ENABLE_INTERRUPT();
  /* Call sample app sequence with Icu_Config_Variant_1 */ 
  main_sequence(Icu_Config_Variant_1);
  /* Call sample app sequence with Icu_Config_Variant_2 */
  main_sequence(Icu_Config_Variant_2);
...
void main_sequence(const Icu_ConfigType * Icu_Config)
{
  ...
  boolean GblBreakLoop = ICU_FALSE;
...
*******************************************************************************/
void Icu_EdgeDetect_Notification_Variant_1(void)
{
  /* Increment the counter to indicate that notification is invoked */
  GusEdgeNumbers++;
}

void Icu_TimeStamps_Notification_Variant_1(void)
{
  /* Set flag to true to inform that the 5 timestamps have been captured */
  GblTimestampsCaptured = TRUE;
}

void Icu_EdgeCount_Overflow_Notification_Variant_1(void)
{
  //Do nothing
}

/* Notification function for signal measurement channel */
void Icu_Signal_Overflow_Notification_Variant_1(void)
{
  /* Signal measurement counter overflow */
}

void Icu_EdgeDetect_Notification_Variant_2(void)
{
  /* Increment the counter to indicate that notification is invoked */
  GusEdgeNumbers++;
}

void Icu_TimeStamps_Notification_Variant_2(void)
{
  /* Set flag to true to inform that the 5 timestamps have been captured */
  GblTimestampsCaptured = TRUE;
}

void Icu_EdgeCount_Overflow_Notification_Variant_2(void)
{
  //Do nothing
}

/* Notification function for signal measurement channel */
void Icu_Signal_Overflow_Notification_Variant_2(void)
{
  /* Signal measurement counter overflow */
}

...
/* Module       = App_ICU_Common_Multicore_PostBuildVariant_Sample_0.c        */
/*============================================================================*/
/*                                  COPYRIGHT                                 */
/*============================================================================*/
...
*******************************************************************************/
void task1(void);
void task2(const Icu_ConfigType * Icu_Config);
...
int main(void)
{
  ...
  task2(Icu_Config_Variant_1);
  /* Call sequence on core 0 variant 2 */
  task2(Icu_Config_Variant_2);
...
void task2(const Icu_ConfigType * Icu_Config)
{
  ...
  /* Initialization of the ICU Driver on variant 1*/
  Icu_Init(Icu_Config);
...
*******************************************************************************/
  ...
  for(uint8 channel = 0; channel < ICU_MAX_CHANNEL; channel++)
  {
       ...
       (Icu_GpChannelConfig[channel].ucIcuMeasurementMode == ICU_MODE_SIGNAL_EDGE_DETECT))
    {
      ...
      /* Disable wakeup for IcuConf_IcuChannel_IcuChannel_006 */

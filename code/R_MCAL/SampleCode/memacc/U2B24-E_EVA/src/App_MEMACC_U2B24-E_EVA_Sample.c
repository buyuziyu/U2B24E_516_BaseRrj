...
/* Module       = App_MEMACC_U2B24-E_EVA_Sample.c                             */
/*============================================================================*/
/*                                  COPYRIGHT                                 */
/*============================================================================*/
 ...
 * 1.0.2:  31/03/2025: As part of support U2Bx-E SampleApp on G4KH,
...
void Mcu_Init(void)
{
  ...
  CLKKCPROT1  = MEMACC_KCPROT_SET;
  HSOSCSTPM   = 0x00000000UL;
  CLKKCPROT1  = MEMACC_KCPROT_CLR;

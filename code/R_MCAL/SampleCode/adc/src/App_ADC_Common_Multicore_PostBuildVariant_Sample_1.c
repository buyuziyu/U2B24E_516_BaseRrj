...
/* Module       = App_ADC_Common_Multicore_PostBuildVariant_Sample_1.c                                                */
/*====================================================================================================================*/
/*                                  COPYRIGHT                                                                         */
/*====================================================================================================================*/
...
int main_PE1(void)
{
  /* Task 3 with execute with hardware unit 1 - Variant 1 */
  task3();
  /* Task 3 with execute with hardware unit 0 - Variant 2 */
  task3();
...
{  
  ...
  for (int i = 0; i < TEST_ADC_NUMB_CHNL_G0_1* TEST_ADC_NUMB_SAMPLE_G0_1; ++i) {
    GddSetBuffGroup0_1[i] = ADC_WORD_ZERO;
  }
  for (int i = 0; i < TEST_ADC_NUMB_CHNL_G1_1* TEST_ADC_NUMB_SAMPLE_G1_1; ++i) {
    GddSetBuffGroup1_1[i] = ADC_WORD_ZERO;
  }
  for (int i = 0; i < TEST_ADC_NUMB_CHNL_G2_1* TEST_ADC_NUMB_SAMPLE_G2_1; ++i) {
    GddSetBuffGroup2_1[i] = ADC_WORD_ZERO;
  }
  for (int i = 0; i < TEST_ADC_NUMB_CHNL_G3_1* TEST_ADC_NUMB_SAMPLE_G3_1; ++i) {
    GddSetBuffGroup3_1[i] = ADC_WORD_ZERO;
  }
  
  /* Reset variable used to store the return value for Read group API */
  for (int i = 0; i < TEST_ADC_NUMB_CHNL_G0_1; ++i) {
    GddReadResultGroup0_1[i] = ADC_WORD_ZERO;
  }
  for (int i = 0; i < TEST_ADC_NUMB_CHNL_G2_1; ++i) {
    GddReadResultGroup2_1[i] = ADC_WORD_ZERO;
  }
  
  /* Reset variable used to store the conversion status of Groups */
  for (int i = 0; i < 4; ++i) {
    for (int j = 0; j < 4; ++j) {
        GaaGroupStatus1[i][j] = ADC_IDLE;
    }
  }
...
/* ===== VARIANT 2 ====== */
void IoHwAb_Adc_Notification_Group100_Variant2(void)
{
  /* Call the notification function */
...
void IoHwAb_Adc_Notification_Group101_Variant2(void)
{
  /* Call the notification function */
...
void IoHwAb_Adc_Notification_Group102_Variant2(void)
{
  /* Call the notification function */
...
void IoHwAb_Adc_Notification_Group103_Variant2(void)
{
  /* Call the notification function */

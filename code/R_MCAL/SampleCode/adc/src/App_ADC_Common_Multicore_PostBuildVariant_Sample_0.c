...
/* Module       = App_ADC_Common_Multicore_PostBuildVariant_Sample_0.c                                                */
/*====================================================================================================================*/
/*                                  COPYRIGHT                                                                         */
/*====================================================================================================================*/
 ...
 *                       1. Update to reset buffers and conversion statuses after completing each task
 *                       2. Update the pointer name passed to Adc_GetStreamLastPointer()
 ...
 * 1.0.0:  06/03/2024  : Initial version.
 */
/**********************************************************************************************************************/
...
***********************************************************************************************************************/
void task1(void);
void task2(const Adc_ConfigType * Adc_Config);
/***********************************************************************************************************************
...
int main()
{
  ...
  /* Initialize Adc_Init Variant 1*/
  Adc_Init(Adc_Config_Variant_1);

  /* Call sequence on core 0 - variant 1 */
  task2(Adc_Config_Variant_1);
  ...
  /* Initialize Adc_Init Variant 2*/
  
  Adc_Init(Adc_Config_Variant_2);

  /* Call sequence on core 0 - variant 2 */
  task2(Adc_Config_Variant_2);
...
void task2(const Adc_ConfigType * Adc_Config)
{
  ...
  for (int i = 0; i < TEST_ADC_NUMB_CHNL_G0_0* TEST_ADC_NUMB_SAMPLE_G0_0; ++i) {
    GddSetBuffGroup0[i] = ADC_WORD_ZERO;
  }
  for (int i = 0; i < TEST_ADC_NUMB_CHNL_G1_0* TEST_ADC_NUMB_SAMPLE_G1_0; ++i) {
    GddSetBuffGroup1[i] = ADC_WORD_ZERO;
  }
  for (int i = 0; i < TEST_ADC_NUMB_CHNL_G2_0* TEST_ADC_NUMB_SAMPLE_G2_0; ++i) {
    GddSetBuffGroup2[i] = ADC_WORD_ZERO;
  }
  for (int i = 0; i < TEST_ADC_NUMB_CHNL_G3_0* TEST_ADC_NUMB_SAMPLE_G3_0; ++i) {
    GddSetBuffGroup3[i] = ADC_WORD_ZERO;
  }
  
  /* Reset variable used to store the return value for Read group API Core0 */
  for (int i = 0; i < TEST_ADC_NUMB_CHNL_G0_0; ++i) {
    GddReadResultGroup0[i] = ADC_WORD_ZERO;
  }
  for (int i = 0; i < TEST_ADC_NUMB_CHNL_G1_0; ++i) {
    GddReadResultGroup1[i] = ADC_WORD_ZERO;
  }
  for (int i = 0; i < TEST_ADC_NUMB_CHNL_G2_0; ++i) {
    GddReadResultGroup2[i] = ADC_WORD_ZERO;
  }
  for (int i = 0; i < TEST_ADC_NUMB_CHNL_G3_0; ++i) {
    GddReadResultGroup3[i] = ADC_WORD_ZERO;
  }
  
  /* Reset variable used to store the conversion status of Groups */
  for (int i = 0; i < 4; ++i) {
    for (int j = 0; j < 4; ++j) {
        GaaGroupStatus0[i][j] = ADC_IDLE;
    }
  }
  ...
  /* Reset variable used to store the return value for Read group API Core1*/
  for (int i = 0; i < TEST_ADC_NUMB_CHNL_G1_1; ++i) {
    GddReadResultGroup1_1[i] = ADC_WORD_ZERO;
  }
  for (int i = 0; i < TEST_ADC_NUMB_CHNL_G3_1; ++i) {
    GddReadResultGroup3_1[i] = ADC_WORD_ZERO;
  }
}
...
/* ===== VARIANT 2 ====== */
void IoHwAb_Adc_Notification_Group000_Variant2(void)
{
  /* Call the notification function */
...
void IoHwAb_Adc_Notification_Group001_Variant2(void)
{
  /* Call the notification function */
...
void IoHwAb_Adc_Notification_Group002_Variant2(void)
{
  /* Call the notification function */
...
void IoHwAb_Adc_Notification_Group003_Variant2(void)
{
  /* Call the notification function */

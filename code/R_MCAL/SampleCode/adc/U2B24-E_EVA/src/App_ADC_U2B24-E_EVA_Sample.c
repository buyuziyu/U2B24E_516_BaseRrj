...
/* Module       = App_Adc_U2B24-E_EVA_Sample.c                                                                        */
/*====================================================================================================================*/
/*                                  COPYRIGHT                                                                         */
/*====================================================================================================================*/
 ...
 *                       1. Add the flow ADC Conversion interrupt register initialization for EIC ADCK3
 * 2.2.0:  31/12/2024  : Update SW-VERSION for Ver22.02.00/Ver22.02.00.D Final Release
 * 2.1.3:  31/10/2024  : Update SW-VERSION 2.1.3
 * 2.1.2:  30/09/2024  : Update SW-VERSION 2.1.2
 * 2.1.1:  12/08/2024  : As part of U2Bx-E support, following changes are made:
 *                       1.Update Clock_Init()
...
void Start_Timer0()
{
  /* Write protected */
  ADC_MSRKCPROT = ADC_KCPROT_SET;
  MSR_TAUD &= ADC_MSR_ACTIVE;
  /*Start and generate HW trigger from TAUD0INT8*/
  if ((TAUD0TE&(0x0001<<8))==1) TAUD0TT=(0x0001<<8);
  TAUD0TPS = 0x000F;
  TAUD0CDR8   =          0x0FFF;
  TAUD0CMUR8  =          0X0000;
  TAUD0TOE    |=    (0X0001<<8);

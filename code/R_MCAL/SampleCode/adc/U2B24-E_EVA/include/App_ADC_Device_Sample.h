/*====================================================================================================================*/
/* Project      = AUTOSAR Renesas U2B24E MCAL Components                                                              */
 ...
 *                       1. Define EI Level Interrupt Bind Register
 * 2.3.0:  31/01/2025  : As part of ARDAACL-52581, following changes are made:
 *                       1. Add the definition of EIC ISR register for ADCK3
 * 2.2.0:  31/12/2024  : Update SW-VERSION for Ver22.02.00/Ver22.02.00.D Final Release
 * 2.1.3:  31/10/2024  : Update SW-VERSION 2.1.3
 * 2.1.2:  30/09/2024  : Update SW-VERSION 2.1.2
 * 2.0.2:  27/02/2024  : Initial Version
 */
/**********************************************************************************************************************/
...
#define ADC_INTCREG_BASEADD_ADCK3    (volatile uint16 *)0xFFF80390 /* EIC 456 to 460 */
...
#define TAUD0TPS          *((volatile uint16*)0xFFBF4240UL)
#define TAUD0CDR8         *((volatile uint16*)0xFFBF4020UL)
#define TAUD0CNT8         *((volatile uint16*)0xFFBF40A0U)
#define TAUD0CMOR8        *((volatile uint16*)0xFFBF4220UL)
#define TAUD0CMUR8        *((volatile uint8*)0xFFBF40E0UL)
#define TAUD0TS           *((volatile uint16*)0xFFBF41C4UL)
#define TAUD0TE           *((volatile uint16*)0xFFBF41C0UL)
#define TAUD0TT           *((volatile uint16*)0xFFBF41C8UL)
#define TAUD0TOE          *((volatile uint16*)0xFFBF405CUL)
#define TAUD0TOM          *((volatile uint16*)0xFFBF4248UL)
#define TAUD0TOC          *((volatile uint16*)0xFFBF424CUL)
#define TAUD0TDE          *((volatile uint16*)0xFFBF4250UL)
#define TAUD0TDL          *((volatile uint16*)0xFFBF4054UL)
#define TAUD0RDE          *((volatile uint16*)0xFFBF4260UL)
#define TAUD0RDC          *((volatile uint16*)0xFFBF426CUL)
#define TAUD0RDS          *((volatile uint16*)0xFFBF4268UL)
#define TAUD0RDM          *((volatile uint16*)0xFFBF4264UL)
#define ADC_INTCREG_BASEADD_INTTAUD0I8 *((volatile uint16*)0xFFFC402EUL)

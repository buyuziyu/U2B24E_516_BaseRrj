...
/* Module       = App_LIN_U2B12-E_Sample.c                                    */
/*============================================================================*/
...
void Mcu_Init(void)
{
  ...
  EIC621 |= (uint16)(1 << 6);
  /* Set Reference Table Method for RLIN33 */
  EIC622 |= (uint16)(1 << 6);
  /* Set Reference Table Method for RLIN33 */
  EIC623 |= (uint16)(1 << 6);

  /* Set Reference Table Method for RLIN34 */
  EIC626 |= (uint16)(1 << 6);
  /* Set Reference Table Method for RLIN34 */
  EIC627 |= (uint16)(1 << 6);
  /* Set Reference Table Method for RLIN34 */
  ...
  /* Set Reference Table Method for RLIN35 */
  EIC631 |= (uint16)(1 << 6);
  /* Set Reference Table Method for RLIN35 */
  EIC632 |= (uint16)(1 << 6);
  /* Set Reference Table Method for RLIN35 */
  ...
  /* Set Reference Table Method for RLIN36 */
  EIC636 |= (uint16)(1 << 6);
  /* Set Reference Table Method for RLIN36 */
  EIC637 |= (uint16)(1 << 6);
  /* Set Reference Table Method for RLIN36 */
  ...
  /* Set Reference Table Method for RLIN37 */
  EIC641 |= (uint16)(1 << 6);
  /* Set Reference Table Method for RLIN37 */
  EIC642 |= (uint16)(1 << 6);
  /* Set Reference Table Method for RLIN37 */
  ...
  /* Set Reference Table Method for RLIN38 */
  EIC645 |= (uint16)(1 << 6);
  /* Set Reference Table Method for RLIN38 */
  EIC646 |= (uint16)(1 << 6);
  /* Set Reference Table Method for RLIN38 */
  ...
  /* Set Reference Table Method for RLIN39 */
  EIC993 |= (uint16)(1 << 6);
  /* Set Reference Table Method for RLIN39 */
  EIC994 |= (uint16)(1 << 6);
  /* Set Reference Table Method for RLIN39 */

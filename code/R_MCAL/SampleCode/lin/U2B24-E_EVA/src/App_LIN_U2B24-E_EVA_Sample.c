...
/* Module       = App_LIN_U2B24-E_EVA_Sample.c                                */
/*                                  COPYRIGHT                                 */
/*============================================================================*/
...
void Mcu_Init(void)
{
  ...
  EIC621 |= (uint16)(1 << 6);
  /* Set Reference Table Method for RLIN310 */
  EIC622 |= (uint16)(1 << 6);
  /* Set Reference Table Method for RLIN310 */
  EIC623 |= (uint16)(1 << 6);
...
void Port_Init(void)
{
  ...
  /* P34_0  : RLIN30TX - Alternative Function 8(Output)        | 1   0  0    0    | 0      1     1    1    | */
  /* P20_7  : RLIN31TX - Alternative Function 8(Output)        | 1   0  0    0    | 0      1     1    1    | */

  /* RLIN3 rxd_lin3(Reception data signal)                     | PMC PM PBDC PIPC | PFCEAE PFCAE PFCE PFCn | */
  /* P34_2  : RLIN30RX - Alternative Function 8(Input)         | 1   1  0    0    | 0      1     1    1    | */
  /* P20_6  : RLIN31RX - Alternative Function 8(Input)         | 1   1  0    0    | 0      1     1    1    | */
  ...
  ** P06_4  : RLIN31TX - Alternative Function 5(Output)        | 1   0  0    0    | 0      1     0    0    | **
  ** P06_5  : RLIN31RX - Alternative Function 2(Input)         | 1   1  0    0    | 0      0     0    1    | **
  *********************/
  /* Seting Value */
 ...
 /* Set Port Bi-Direction Control Register to Output for TX */
  ...
  /*********************
  ** RLIN3 Channel #5                                         | PMC PM PBDC PIPC | PFCEAE PFCAE PFCE PFCn | ** 
  ** P33_1  : RLIN35TX - Alternative Function 8(Output)        | 1   0  0    0    | 0      1     1    1    | **
  ** P33_0  : RLIN35RX - Alternative Function 8(Input)         | 1   1  0    0    | 0      1     1    1    | ** 
  *********************/
  /* Seting Value */

...
#define EIC396              (*((volatile uint16 *)0xFFF80318UL)) /* INTOSTM6TINT */
...
#define INTC2_EIBD396       *(uint32*)(0xfff82630UL)
#define INTC2_EIBD963       *(uint32*)(0xfff82f0cUL)
#define INTC2_EIBD960       *(uint32*)(0xFFF82F00UL)
#define INTC2_EIBD961       *(uint32*)(0xfff82f04UL)

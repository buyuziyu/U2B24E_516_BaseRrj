...
/*====================================================================================================================*/
/* Purpose:                                                                                                           */
/* This file contains code for version checking for modules included by Flash Test Driver.                            */
/*                                                                                                                    */
/*====================================================================================================================*/
/*                                                                                                                    */
...
***********************************************************************************************************************/
/*
 * Included for Flash Test module version information and other modules version
 * information
 */
...
#define FLSTST_VERSION_C_AR_RELEASE_MAJOR_VERSION    FLSTST_AR_RELEASE_MAJOR_VERSION_VALUE
#define FLSTST_VERSION_C_AR_RELEASE_MINOR_VERSION    FLSTST_AR_RELEASE_MINOR_VERSION_VALUE
#define FLSTST_VERSION_C_AR_RELEASE_REVISION_VERSION FLSTST_AR_RELEASE_REVISION_VERSION_VALUE
...
**                                                   Version Check                                                    **
***********************************************************************************************************************/
#if (FLSTST_VERSION_AR_RELEASE_MAJOR_VERSION != FLSTST_VERSION_C_AR_RELEASE_MAJOR_VERSION)
  #error "FlsTst_Version.c : Mismatch in Release Major Version"
#endif

#if (FLSTST_VERSION_AR_RELEASE_MINOR_VERSION != FLSTST_VERSION_C_AR_RELEASE_MINOR_VERSION)
  #error "FlsTst_Version.c : Mismatch in Release Minor Version"
#endif

#if (FLSTST_VERSION_AR_RELEASE_REVISION_VERSION != FLSTST_VERSION_C_AR_RELEASE_REVISION_VERSION)
  ...
  #error "FlsTst_Version.c : Mismatch in Major Version"
#endif

#if (FLSTST_VERSION_SW_MINOR_VERSION != FLSTST_VERSION_C_SW_MINOR_VERSION)
  #error "FlsTst_Version.c : Mismatch in Minor Version"
#endif
...
#endif /* End of DET */
#endif /* End of FLSTST_DEV_ERROR_DETECT */
...
#endif /* End of FLSTST_VERSION_CHECK_EXT_MODULES */

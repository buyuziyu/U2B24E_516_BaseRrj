...
/*====================================================================================================================*/
/* Purpose:                                                                                                           */
/* This file contains macros required for checking versions of modules included by Flash Test Driver.                 */
/*                                                                                                                    */
/*====================================================================================================================*/
/*                                                                                                                    */
...
**                                                  Include Section                                                   **
***********************************************************************************************************************/
/* Flash test module version information is required for inter module version check */
#include "FlsTst.h"

/* Following is required only when external modules version check is enabled */
#if (FLSTST_VERSION_CHECK_EXT_MODULES == STD_ON)

/* Included for declaration of Dem version information */
#include "Dem.h"
...
#define FLSTST_VERSION_AR_RELEASE_REVISION_VERSION FLSTST_AR_RELEASE_REVISION_VERSION

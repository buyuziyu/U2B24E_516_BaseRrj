 ...
 *  2.0.0  26/07/2023  : Remove qac message 0841 header, GPT_INSTANCE_INDEX, Gpt_MultiInstance.h, Gpt_GpOSTMUnitConfig
 ...
 *         06/05/2021  : Updated the Memory section for Gpt_OstmFunc
 *                       using GPT_START_SEC_VAR_INIT_UNSPECIFIED.
 *  1.2.0  17/07/2020  : Release.
 *  1.1.0  19/06/2020  : Release.
 *         22/03/2020  : add #include "Gpt.h".
...
#ifndef GPT_OSTM_RAM_HEADER
#define GPT_OSTM_RAM_HEADER
...
#include "Gpt_Cfg.h"
/* Included for type of Gpt_OSTMUnitConfigType */
...
#define GPT_OSTM_RAM_AR_RELEASE_MAJOR_VERSION    GPT_AR_RELEASE_MAJOR_VERSION_VALUE
#define GPT_OSTM_RAM_AR_RELEASE_MINOR_VERSION    GPT_AR_RELEASE_MINOR_VERSION_VALUE
#define GPT_OSTM_RAM_AR_RELEASE_REVISION_VERSION GPT_AR_RELEASE_REVISION_VERSION_VALUE
/* File version information */
#define GPT_OSTM_RAM_SW_MAJOR_VERSION            GPT_SW_MAJOR_VERSION
#define GPT_OSTM_RAM_SW_MINOR_VERSION            GPT_SW_MINOR_VERSION
#define GPT_OSTM_RAM_SW_PATCH_VERSION            GPT_SW_PATCH_VERSION
/***********************************************************************************************************************
**                                                   Global Symbols                                                   **
***********************************************************************************************************************/
...
extern VAR(Gpt_HwFuncTableType, GPT_VAR_INIT) Gpt_OstmFunc;

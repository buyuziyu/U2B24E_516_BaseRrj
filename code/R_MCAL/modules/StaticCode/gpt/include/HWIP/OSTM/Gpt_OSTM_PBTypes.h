 ...
 *  2.0.0  25/08/2023  : Add qac message 3630
 *         26/07/2023  : Remove qac message 0841 header, GPT_INSTANCE_INDEX, Gpt_MultiInstance.h, Gpt_GpOSTMUnitConfig,
 *                       STag_Gpt_OSTMUnitConfigType, Gpt_GaaOSTMUnitConfig
...
***********************************************************************************************************************/
typedef volatile struct STag_Gpt_OSTMnUnitRegs                                                                          /* PRQA S 3630 # JV-01 */
{
  uint32 ulOSTMnCMP;
  uint32 ulOSTMnCNT;
  uint8 aaReserved1[4];

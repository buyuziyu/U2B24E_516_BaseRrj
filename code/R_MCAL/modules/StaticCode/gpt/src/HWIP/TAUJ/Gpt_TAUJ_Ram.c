 ...
 *  2.3.0  28/02/2025  : Remove redundant define for Gpt_GaaChannelRamData
 ...
 *  2.1.1  30/08/2024  : As part of Post Build multiple varriant support, following changes are made
 *                       1.Add array Gpt_GaaChannelRamData
...
VAR(Gpt_HwFuncTableType, GPT_VAR_INIT) Gpt_TaujFunc =
{

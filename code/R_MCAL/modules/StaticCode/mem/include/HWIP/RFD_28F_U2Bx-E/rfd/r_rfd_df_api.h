/**********************************************************************************************************************
    ...
    File Name       : r_rfd_df_api.h
    Program Version : V1.00
    File Revision   : $Rev: 4343 $
    File Date       : $Date:: 2023-05-17 16:23:15 +0700#$
    Device(s)       : RV28 Flash based RH850 microcontroller
    Description     : Include file for prototype definition of API for Data Flash Control Component
**********************************************************************************************************************/
...
#ifndef R_RFD_DF_API_H
#define R_RFD_DF_API_H
...
extern T_u4_RFDReturn  R_RFD_DFIDAuth(T_u1* i_pu1_AuthIDData);
extern void            R_RFD_EraseDFRequest(T_u4_RfdAddress i_u4_Start, T_u4_RfdAddress i_u4_End);
extern void            R_RFD_WriteDFRequest(T_u4_RfdAddress i_u4_Start, T_u2 i_u2_Length, T_pu4_RfdBuffer i_pu4_Data);
extern void            R_RFD_BlankCheckDFRequest(T_u4_RfdAddress i_u4_Start, T_u4_RfdAddress i_u4_End);
extern T_u4_RFDReturn  R_RFD_GetBlankCheckResult(T_u2_FACI i_u2_TargetFaci, T_u4_RfdAddress* o_pu4_NotBlankAddress);
extern T_u2_FACI       R_RFD_DFAddressToFaciNumber(T_u4_RfdAddress i_u4_Address);


#endif  /* R_RFD_DF_API_H */

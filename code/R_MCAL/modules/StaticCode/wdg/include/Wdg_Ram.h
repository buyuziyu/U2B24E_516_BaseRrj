 ...
 *                         Change #include "Wdg_Mapping.h" with #include "Wdg_MemMap.h", add Wdg_GaaGlobalAccPoint,
 *                         Wdg_GaaGetCoreId2Index, delete Wdg_GddDriverState, Wdg_GddCurrentMode, Wdg_GulTriggerCounter
...
extern const uint8 Wdg_GaaGetCoreId2Index[WDG_SUPPORTED_CORE_MAX_NUM];
...
#include "Wdg_MemMap.h"
/* Global pointer access to module status */
extern CONST(Wdg_GlobalAccessPointType, WDG_CONFIG_DATA) Wdg_GaaGlobalAccPoint[WDG_SUPPORTED_CORE_CONFIGURED_NUM];
#define WDG_STOP_SEC_CONST_32
#include "Wdg_MemMap.h"

#define WDG_START_SEC_VAR_NO_INIT_PTR
#include "Wdg_MemMap.h" 
/* Global pointer access to module configuration */

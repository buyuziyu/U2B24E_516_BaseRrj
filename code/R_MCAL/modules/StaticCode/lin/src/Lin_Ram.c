 ...
 *         08/01/2024  : Remove redundant QAC message
 * 2.0.0:  26/07/2023  : Add information about CWE violation ID
 *         18/07/2023  : Update to support for Multicore:
 *                       Remove parameter "Lin_GblDriverState" , Lin_GpChannelConfig, Lin_GpRLIN3Properties, 
 *                       Lin_GpChannelRamData in Global data section
 *         22/05/2023  : Remove redundant QAC message and QAC messages (1:1533)

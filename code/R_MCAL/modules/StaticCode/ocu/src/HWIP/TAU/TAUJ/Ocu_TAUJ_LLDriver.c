 ...
 *                          Ocu_GblCountingDirection in internal function: Ocu_HW_Tauj_ChannelInit, 
 *                          Ocu_HW_Tauj_GetCounter, Ocu_HW_Tauj_StartRestartChannel, Ocu_HW_Tauj_SetThreshold.
 *  1.0.1  25/10/2023  : Add comment in Register Used: TAUJnTO, TAUJnTOE in Ocu_HW_Tauj_ChannelInit and 
                         Ocu_HW_Tauj_ChannelDeInit, TAUJnTS in Ocu_HW_Tauj_CbkNotification
                         Add comment in Functions invoked: OCU_ENTER_CRITICAL_SECTION, OCU_EXIT_CRITICAL_SECTION,
                         Ocu_Notification_<Channel> in Ocu_HW_Tauj_CbkNotification
                         Remove Functions invoked RH850_SV_CLEAR_ICR_SYNCP, Registers used EICn in 
                         Ocu_HW_Tauj_StartRestartChannel
                         Remove Registers used TAUJnTS, TAUJnCDRm, TAUJnCNTm, add comment in Functions invoked:
                         OCU_ENTER_CRITICAL_SECTION, OCU_EXIT_CRITICAL_SECTION in Ocu_HW_Tauj_StopChannel
                         Remove Functions invoked RH850_SV_CLEAR_ICR_SYNCP in Ocu_HW_Tauj_EnableInterrupt 
           ...
           09/10/2023  : Update QAC messages for Ocu_HW_Tauj_StartRestartChannel, and Ocu_HW_Tauj_CbkNotification
           25/09/2023  : In Ocu_HW_Tauj_ChannelInit change the OCU driver mode for the slave channel to interval timer
                         mode, from now on the 2 channels no longer run in Synchronous Channel Operation
                         In Ocu_HW_Tauj_SetPinAction move the updated ram status of ddPinActionState to the bottom
                         In Ocu_HW_Tauj_StartRestartChannel and Ocu_HW_Tauj_CbkNotification update the code sequence
                         since the slave channel now running independently (interval timer mode)
                         In Ocu_HW_Tauj_SetThreshold update the brand condition due to coding rule
...
#define OCU_TAUJ_LLDRIVER_C_AR_RELEASE_MAJOR_VERSION    OCU_AR_RELEASE_MAJOR_VERSION_VALUE
#define OCU_TAUJ_LLDRIVER_C_AR_RELEASE_MINOR_VERSION    OCU_AR_RELEASE_MINOR_VERSION_VALUE
#define OCU_TAUJ_LLDRIVER_C_AR_RELEASE_REVISION_VERSION OCU_AR_RELEASE_REVISION_VERSION_VALUE
/* File version information */
#define OCU_TAUJ_LLDRIVER_C_SW_MAJOR_VERSION            OCU_SW_MAJOR_VERSION_VALUE
#define OCU_TAUJ_LLDRIVER_C_SW_MINOR_VERSION            OCU_SW_MINOR_VERSION_VALUE
/***********************************************************************************************************************
**                                                   Version Check                                                    **
***********************************************************************************************************************/
#if (OCU_TAUJ_LLDRIVER_AR_RELEASE_MAJOR_VERSION != OCU_TAUJ_LLDRIVER_C_AR_RELEASE_MAJOR_VERSION)
  #error "Ocu_TAUJ_LLDriver.c : Mismatch in Release Major Version"
#endif
#if (OCU_TAUJ_LLDRIVER_AR_RELEASE_MINOR_VERSION != OCU_TAUJ_LLDRIVER_C_AR_RELEASE_MINOR_VERSION)
  #error "Ocu_TAUJ_LLDriver.c : Mismatch in Release Minor Version"
#endif
#if (OCU_TAUJ_LLDRIVER_AR_RELEASE_REVISION_VERSION != OCU_TAUJ_LLDRIVER_C_AR_RELEASE_REVISION_VERSION)
  #error "Ocu_TAUJ_LLDriver.c : Mismatch in Release Revision Version"
#endif
#if (OCU_TAUJ_LLDRIVER_SW_MAJOR_VERSION != OCU_TAUJ_LLDRIVER_C_SW_MAJOR_VERSION)
  #error "Ocu_TAUJ_LLDriver.c : Mismatch in Software Major Version"
#endif
#if (OCU_TAUJ_LLDRIVER_SW_MINOR_VERSION != OCU_TAUJ_LLDRIVER_C_SW_MINOR_VERSION)
  #error "Ocu_TAUJ_LLDriver.c : Mismatch in Software Minor Version"
#endif
...
/***********************************************************************************************************************
** Function Name         : Ocu_HW_Tauj_UnitInit
**
** Service ID            : NA
**
...
**
** Registers Used        : TAUJnTPS, TAUJnBRS
**
** Reference ID          : OCU_DUD_ACT_029, OCU_DUD_ACT_029_GBL001, OCU_DUD_ACT_029_GBL002
***********************************************************************************************************************/
#define OCU_START_SEC_PRIVATE_CODE
#include "Ocu_MemMap.h"

FUNC(void, OCU_PRIVATE_CODE) Ocu_HW_Tauj_UnitInit(P2CONST(Ocu_ConfigType, AUTOMATIC, OCU_APPL_CONST) LpConfigPtr)
{
  #if (OCU_TAUJ_CONFIG_PRESCALER_SUPPORTED == STD_ON)
  ...
  P2VAR(Ocu_TAUJUnitOsRegs, AUTOMATIC, REGSPACE) LpTAUJUnitOsReg;                                                       /* PRQA S 3432 # JV-01 */
  ...
  for (LucCount = (uint8)OCU_ZERO; LucCount < (uint8)OCU_TOTAL_TAU_UNITS_CONFIGURED; LucCount++)
  {
    ...
    /* If HWIP is TAUJ */
    if (OCU_HW_TAUJ == LucTimerType)
    {
      /* Initialize the pointer to OS register base address */
      LpTAUJUnitOsReg = (P2VAR(Ocu_TAUJUnitOsRegs, AUTOMATIC, REGSPACE))(LpTAUUnitConfig[LucCount].pTAUUnitOsCntlRegs); /* PRQA S 0316, 3432 # JV-01, JV-01 */
      /* Load the configured pre-scaler value */
      LpTAUJUnitOsReg->usTAUJnTPS = LpTAUUnitConfig[LucCount].usPrescaler;
  ...
  #endif /* End of (OCU_TAUJ_CONFIG_PRESCALER_SUPPORTED == STD_ON) */
} /* End of API Ocu_HW_Tauj_UnitInit */

#define OCU_STOP_SEC_PRIVATE_CODE
#include "Ocu_MemMap.h"                                                                                                 /* PRQA S 5087 # JV-01 */
/***********************************************************************************************************************
** Function Name         : Ocu_HW_Tauj_ChannelInit
**
** Service ID            : NA
**
...
**
** Functions invoked     : Ocu_HW_Tauj_DisableInterrupt
**
** Registers Used        : TAUJnCDRm, TAUJnCMORm, TAUJnTS, TAUJnTO, TAUJnTOE 
**
** Reference ID          : OCU_DUD_ACT_030, OCU_DUD_ACT_030_GBL001, OCU_DUD_ACT_030_GBL002
** Reference ID          : OCU_DUD_ACT_030_GBL003, OCU_DUD_ACT_030_GBL004, OCU_DUD_ACT_030_GBL005
** Reference ID          : OCU_DUD_ACT_030_GBL006, OCU_DUD_ACT_030_GBL007, OCU_DUD_ACT_030_GBL008
** Reference ID          : OCU_DUD_ACT_030_GBL009, OCU_DUD_ACT_030_GBL010, OCU_DUD_ACT_030_GBL011
***********************************************************************************************************************/
#define OCU_START_SEC_PRIVATE_CODE
#include "Ocu_MemMap.h"                                                                                                 /* PRQA S 5087 # JV-01 */

FUNC(void, OCU_PRIVATE_CODE) Ocu_HW_Tauj_ChannelInit(Ocu_ChannelType LddChannel)
{
  ...
  P2VAR(Ocu_TAUJChannelUserRegs, AUTOMATIC, REGSPACE) LpTAUJMasterChannelRegs;                                          /* PRQA S 3432 # JV-01 */
  /* Pointer pointing to the TAUJ Unit control registers */
  P2VAR(Ocu_TAUJUnitUserRegs, AUTOMATIC, REGSPACE) LpTAUJUnitUserRegs;                                                  /* PRQA S 3432 # JV-01 */
  ...
  /* Set the mode of Master TAUJ (slave channel - 1) timer mode to interval mode */
  *((volatile uint16 *)(LpTAUChannelConfigData->pMasterCMORReg)) = LpTAUChannelConfigData->usClockSelection;            /* PRQA S 0316 # JV-01 */
  /* Set the mode of Slave TAUJ timer mode to interval mode */
  *((volatile uint16 *)(LpTAUChannelConfigData->pCMORReg)) = LpTAUChannelConfigData->usClockSelection;                  /* PRQA S 0316 # JV-01 */
  ...
  Ocu_HW_Tauj_DisableInterrupt(LddChannel);
  ...
  LpTAUJMasterChannelRegs = (P2VAR(Ocu_TAUJChannelUserRegs, AUTOMATIC, REGSPACE))LpTAUChannelConfigData->pMasterCDRReg; /* PRQA S 0316, 3432 # JV-01, JV-01 */

  /* Set default max HW counter tick value Master channel */
  LpTAUJMasterChannelRegs->ulTAUJnCDRm = ((LpChannelConfig->ulMaxCounterValue *                                         /* PRQA S 3384 # JV-01 */
  ...
  LpTAUJUnitUserRegs = (P2VAR(Ocu_TAUJUnitUserRegs, AUTOMATIC, REGSPACE))                                               /* PRQA S 0316, 3432 # JV-01, JV-01 */
  ...
  if (OCU_TRUE == LpChannelConfig->blOutputPinUsed)
  {
    ...
    LpTAUJUnitUserRegs->ucTAUJnTOE &= (uint8)~(LpTAUChannelConfigData->usChannelBitValue);
    ...
    {
      /* Set the pin level for the associated TAUJnOm pin for the slave channel */
      LpTAUJUnitUserRegs->ucTAUJnTO |= (uint8)LpTAUChannelConfigData->usChannelBitValue;
    }
    else
    {
      /* Set the pin level for the associated TAUJnOm pin for the slave channel */
  ...
  LpTAUJUnitUserRegs->ucTAUJnTS = (uint8)(LpTAUChannelConfigData->usChannelBitValue >> OCU_ONE);
} /* End of API Ocu_HW_Tauj_ChannelInit */

#define OCU_STOP_SEC_PRIVATE_CODE
#include "Ocu_MemMap.h"                                                                                                 /* PRQA S 5087 # JV-01 */
/***********************************************************************************************************************
** Function Name         : Ocu_HW_Tauj_ChannelDeInit
**
** Service ID            : NA
**
...
** Functions invoked     : Ocu_HW_Tauj_DisableInterrupt
**
** Registers used        : TAUJnCDRm, TAUJnCMORm, TAUJnTT, TAUJnTO, TAUJnTOE
**
** Reference ID          : OCU_DUD_ACT_031, OCU_DUD_ACT_031_GBL001, OCU_DUD_ACT_031_GBL002
** Reference ID          : OCU_DUD_ACT_031_GBL003, OCU_DUD_ACT_031_GBL004, OCU_DUD_ACT_031_GBL005
** Reference ID          : OCU_DUD_ACT_031_GBL006, OCU_DUD_ACT_031_GBL007, OCU_DUD_ACT_031_GBL008
** Reference ID          : OCU_DUD_ACT_031_GBL009, OCU_DUD_ACT_031_GBL010, OCU_DUD_ACT_031_GBL011
** Reference ID          : OCU_DUD_ACT_031_GBL012
***********************************************************************************************************************/
#if (OCU_DE_INIT_API == STD_ON)
#define OCU_START_SEC_PRIVATE_CODE
#include "Ocu_MemMap.h"                                                                                                 /* PRQA S 5087 # JV-01 */

FUNC(void, OCU_PRIVATE_CODE) Ocu_HW_Tauj_ChannelDeInit(Ocu_ChannelType LddChannel)
{
  /* TAU unit config data */
  P2CONST(Ocu_TAUChannelConfigType, AUTOMATIC, OCU_CONFIG_DATA) LpTAUChannelConfigData;
  /* Pointer to the channel configuration */
  P2CONST(Ocu_ChannelConfigType, AUTOMATIC, OCU_CONFIG_DATA) LpChannelConfig;
  /* Pointer used for TAUJ Slave channel control registers */
  P2VAR(Ocu_TAUJChannelUserRegs, AUTOMATIC, REGSPACE) LpTAUJChannelReg;                                                 /* PRQA S 3432 # JV-01 */
  /* Pointer used for TAUJ Master channel control registers */
  P2VAR(Ocu_TAUJChannelUserRegs, AUTOMATIC, REGSPACE) LpTAUJMasterChannelReg;                                           /* PRQA S 3432 # JV-01 */
  /* Pointer pointing to the TAUJ Unit control registers */
  P2VAR(Ocu_TAUJUnitUserRegs, AUTOMATIC, REGSPACE) LpTAUJUnitUserRegs;                                                  /* PRQA S 3432 # JV-01 */
  ...
  LpTAUJUnitUserRegs->ucTAUJnTT = (uint8)(LpTAUChannelConfigData->usChannelBitValue) |
                                                        (uint8)(LpTAUChannelConfigData->usChannelBitValue >> OCU_ONE);
  ...
  *((volatile uint16 *)(LpTAUChannelConfigData->pMasterCMORReg)) = (uint16)OCU_ZERO;                                    /* PRQA S 0316 # JV-01 */
  ...
  LpTAUJChannelReg = (P2VAR(Ocu_TAUJChannelUserRegs, AUTOMATIC, REGSPACE))LpTAUChannelConfigData->pCDRReg;              /* PRQA S 0316, 3432 # JV-01, JV-01 */
  /* Set the pointer to TAU register base address - Master channel */
  LpTAUJMasterChannelReg = (P2VAR(Ocu_TAUJChannelUserRegs, AUTOMATIC, REGSPACE))LpTAUChannelConfigData->pMasterCDRReg;  /* PRQA S 0316, 3432 # JV-01, JV-01 */
  /* Reset the CDRm register of the configured channel - Slave channel  */
  LpTAUJChannelReg->ulTAUJnCDRm = OCU_SET_32BIT;
  /* Reset the CDRm register of the configured channel - Master channel  */
  LpTAUJMasterChannelReg->ulTAUJnCDRm = OCU_SET_32BIT;
  ...
  Ocu_GpChannelRamData[LddChannel].ddPinActionState = OCU_DISABLE;
  #endif
} /* End of API Ocu_HW_Tauj_ChannelDeInit */

#define OCU_STOP_SEC_PRIVATE_CODE
#include "Ocu_MemMap.h"                                                                                                 /* PRQA S 5087 # JV-01 */
#endif /* End of (OCU_DE_INIT_API == STD_ON) */
/***********************************************************************************************************************
** Function Name         : Ocu_HW_Tauj_SetPinState
**
** Service ID            : NA
**
...
**
** Reference ID          : OCU_DUD_ACT_032, OCU_DUD_ACT_032_GBL001, OCU_DUD_ACT_032_GBL002
***********************************************************************************************************************/
#if (OCU_SET_PIN_STATE_API == STD_ON)
#define OCU_START_SEC_PRIVATE_CODE
#include "Ocu_MemMap.h"                                                                                                 /* PRQA S 5087 # JV-01 */

FUNC(void, OCU_PRIVATE_CODE) Ocu_HW_Tauj_SetPinState(Ocu_ChannelType LddChannel, Ocu_PinStateType LddPinState)
{
  /* TAU unit config data */
  P2CONST(Ocu_TAUChannelConfigType, AUTOMATIC, OCU_CONFIG_DATA) LpTAUChannelConfigData;
  /* Pointer to the channel configuration */
  ...
  /* Pointer pointing to the TAUJ Unit control registers */
  P2VAR(Ocu_TAUJUnitUserRegs, AUTOMATIC, REGSPACE) LpTAUJUnitUserRegs;                                                  /* PRQA S 3432 # JV-01 */
  /* Declare a Local variable to store the current setting value of TAUJnTOE - TAUJn Channel Output Enable Register */
  VAR(uint8, AUTOMATIC) LucLastToeValue;
  /* Update the channel configuration pointer to point to the current channel */
  LpChannelConfig = &Ocu_GpChannelConfig[LddChannel];
  /* Set TAU channel config data pointer */
  LpTAUChannelConfigData = LpChannelConfig->pHWIPChannelConfig;                                                         /* PRQA S 0317 # JV-01 */
  ...
  LpTAUJUnitUserRegs = (P2VAR(Ocu_TAUJUnitUserRegs, AUTOMATIC, REGSPACE))                                               /* PRQA S 0316, 3432 # JV-01, JV-01 */
                                           Ocu_GpTAUUnitConfig[LpChannelConfig->ucTimerUnitIndex].pTAUUnitUserCntlRegs;
  /* Save the current value of the TAUJnTOE register for the selected slave channel */
  LucLastToeValue = LpTAUJUnitUserRegs->ucTAUJnTOE & (uint8)LpTAUChannelConfigData->usChannelBitValue;
  ...
  {
    /* Set one into the corresponding bit of TAUJnTO register */
    LpTAUJUnitUserRegs->ucTAUJnTO |= (uint8)LpTAUChannelConfigData->usChannelBitValue;
  }
  else /* LddPinState == OCU_LOW */
  {
    /* Set zero into the corresponding bit of TAUJnTO register */
    LpTAUJUnitUserRegs->ucTAUJnTO &= (uint8)~(LpTAUChannelConfigData->usChannelBitValue);
  } /* End of set the current output level */
  /* Write back the saved value of the TAUJnTOE register for the selected slave channel */
  LpTAUJUnitUserRegs->ucTAUJnTOE |= LucLastToeValue;
} /* End of API Ocu_HW_Tauj_SetPinState */

#define OCU_STOP_SEC_PRIVATE_CODE
#include "Ocu_MemMap.h"                                                                                                 /* PRQA S 5087 # JV-01 */
#endif /* OCU_SET_PIN_STATE_API == STD_ON */
/***********************************************************************************************************************
** Function Name         : Ocu_HW_Tauj_GetCounter
**
** Service ID            : NA
**
...
**
** Reference ID          : OCU_DUD_ACT_033, OCU_DUD_ACT_033_GBL001
***********************************************************************************************************************/
...
FUNC(Ocu_ValueType, OCU_PRIVATE_CODE) Ocu_HW_Tauj_GetCounter(Ocu_ChannelType LddChannel)
{
  /* Pointer to the channel configuration */
  P2CONST(Ocu_ChannelConfigType, AUTOMATIC, OCU_CONFIG_DATA) LpChannel;
  /* TAU unit config data */
  P2CONST(Ocu_TAUChannelConfigType, AUTOMATIC, OCU_CONFIG_DATA) LpTAUChannelConfigData;
  /* Defining a pointer to point to the TAUJ master registers */
  P2VAR(Ocu_TAUJChannelUserRegs, AUTOMATIC, REGSPACE) LpTAUJMasterChannelRegs;                                          /* PRQA S 3432, 3678 # JV-01, JV-01 */
  ...
  LddHwMasterCDRCounterValue = LpTAUJMasterChannelRegs->ulTAUJnCDRm;
  /* Read the current value from the master free-running counter */
  LddHwMasterCNTCounterValue = LpTAUJMasterChannelRegs->ulTAUJnCNTm;
  /* Check the counting direction */
  if (OCU_UPCOUNTING == Ocu_GblCountingDirection)                                                                       /* PRQA S 3416 # JV-01 */
  {
...
} /* End of API Ocu_HW_Tauj_GetCounter */

#define OCU_STOP_SEC_PRIVATE_CODE
#include "Ocu_MemMap.h"                                                                                                 /* PRQA S 5087 # JV-01 */
#endif /* End of precompile condition */
/***********************************************************************************************************************
** Function Name         : Ocu_HW_Tauj_SetPinAction
**
** Service ID            : NA
**
...
** Global Variables      : Ocu_GpChannelConfig, Ocu_GpChannelRamData, Ocu_GpTAUUnitConfig
**
** Functions invoked     : Ocu_HW_Tauj_EnableInterrupt, Ocu_HW_Tauj_DisableInterrupt
**
** Registers used        : TAUJnTOE
**
** Reference ID          : OCU_DUD_ACT_034, OCU_DUD_ACT_034_GBL001
***********************************************************************************************************************/
#if (OCU_SET_PIN_ACTION_API == STD_ON)
#define OCU_START_SEC_PRIVATE_CODE
#include "Ocu_MemMap.h"                                                                                                 /* PRQA S 5087 # JV-01 */

FUNC(void, OCU_PRIVATE_CODE) Ocu_HW_Tauj_SetPinAction(Ocu_ChannelType LddChannel, Ocu_PinActionType LddPinAction)
{
  /* TAU unit config data */
  P2CONST(Ocu_TAUChannelConfigType, AUTOMATIC, OCU_CONFIG_DATA) LpTAUChannelConfigData;
  /* Pointer to the channel configuration */
  ...
  if ((OCU_SET_HIGH == LddPinAction) || (OCU_SET_LOW == LddPinAction))
  {
    ...
    Ocu_HW_Tauj_EnableInterrupt(LddChannel);
  }
...
} /* End of API Ocu_HW_Tauj_SetPinAction */

#define OCU_STOP_SEC_PRIVATE_CODE
#include "Ocu_MemMap.h"                                                                                                 /* PRQA S 5087 # JV-01 */
#endif /* OCU_SET_PIN_ACTION_API == STD_ON */
/***********************************************************************************************************************
** Function Name         : Ocu_HW_Tauj_StartRestartChannel
**
** Service ID            : NA
**
...
**
** Functions invoked     : Ocu_HW_Tauj_EnableInterrupt
**
** Registers used        : TAUJnTS, TAUJnCNTm, TAUJnCDRm, TAUJnTT
**
** Reference ID          : OCU_DUD_ACT_036, OCU_DUD_ACT_036_GBL001, OCU_DUD_ACT_036_GBL002
** Reference ID          : OCU_DUD_ACT_036_GBL003, OCU_DUD_ACT_036_GBL004, OCU_DUD_ACT_036_GBL005
***********************************************************************************************************************/
#define OCU_START_SEC_PRIVATE_CODE
#include "Ocu_MemMap.h"                                                                                                 /* PRQA S 5087 # JV-01 */

FUNC(void, OCU_PRIVATE_CODE)Ocu_HW_Tauj_StartRestartChannel(Ocu_ChannelType LddChannel,Ocu_ValueType LddHwNewThreshold)
{
  /* TAU unit config data */
  P2CONST(Ocu_TAUChannelConfigType, AUTOMATIC, OCU_CONFIG_DATA) LpTAUChannelConfigData;
  /* Pointer to the channel configuration */
  P2CONST(Ocu_ChannelConfigType, AUTOMATIC, OCU_CONFIG_DATA) LpChannelConfig;
  /* Pointer used for master TAUJ channel control registers */
  P2VAR(Ocu_TAUJChannelUserRegs, AUTOMATIC, REGSPACE) LpTAUJChannelMasterRegs;                                          /* PRQA S 3432, 3678 # JV-01, JV-01 */
  /* Pointer used for slave TAUJ channel control registers */
  P2VAR(Ocu_TAUJChannelUserRegs, AUTOMATIC, REGSPACE) LpTAUJChannelSlaveRegs;                                           /* PRQA S 3432 # JV-01 */
  /* Pointer pointing to the TAUJ Unit control registers */
  P2VAR(Ocu_TAUJUnitUserRegs, AUTOMATIC, REGSPACE) LpTAUJUnitUserRegs;                                                  /* PRQA S 3432 # JV-01 */
  ...
  LpTAUJChannelSlaveRegs = (P2VAR(Ocu_TAUJChannelUserRegs, AUTOMATIC, REGSPACE))LpTAUChannelConfigData->pCDRReg;        /* PRQA S 0316, 3432 # JV-01, JV-01 */
  /* Set the pointer to TAU register base address of Master Channel */
  LpTAUJChannelMasterRegs = (P2VAR(Ocu_TAUJChannelUserRegs, AUTOMATIC, REGSPACE))LpTAUChannelConfigData->pMasterCDRReg; /* PRQA S 0316, 3432 # JV-01, JV-01 */
  /* Read the max counter value from the master free-running counter */
  LddHwMasterCDRCounterValue = (uint32)LpTAUJChannelMasterRegs->ulTAUJnCDRm;
  /* Read the current counter value from the master free-running counter */
  LddHwMasterCNTCounterValue = (uint32)LpTAUJChannelMasterRegs->ulTAUJnCNTm;
  /* Check the counting direction */
  if (OCU_UPCOUNTING == Ocu_GblCountingDirection)                                                                       /* PRQA S 3416 # JV-01 */
  {
    ...
    if (LddHwMasterCDRCounterValue >= LddHwMasterCNTCounterValue)
    {
      ...
      {
        /* The slave counter start to count down from the next tick
        ...
        {
          /* Let the slave channel counts from the remaining time to the next compare match */
          LpTAUJChannelSlaveRegs->ulTAUJnCDRm = LddHwNewThreshold - LddHwCounterValue - (uint32)OCU_TWO;                /* PRQA S 3383, 3384 # JV-01, JV-01 */
        }
        ...
        else
        {
          ...
          LpTAUJChannelSlaveRegs->ulTAUJnCDRm = (uint32)OCU_ZERO;
        }
      }
      else /* Interrupt for new threshold will not occur inside this cycle */
      {
        ...
        {
          /* The slave timer count down from 0 */
          LpTAUJChannelSlaveRegs->ulTAUJnCDRm = (uint32)OCU_ZERO;
        }
        else
        {
          /* Set the count down value = next threshold + current timer counter */
          LpTAUJChannelSlaveRegs->ulTAUJnCDRm = LddHwMasterCNTCounterValue + LddHwNewThreshold - OCU_ONE;               /* PRQA S 3383, 3384 # JV-01, JV-01 */
    ...
    else /* Else the master channel has not been started */
    {
      ...
      if ((uint32)OCU_ZERO != LddHwNewThreshold)
      {
        ...
        LpTAUJChannelSlaveRegs->ulTAUJnCDRm = LddHwNewThreshold - (uint32)OCU_ONE;
      }
      else /* case of new threshold is 0 */
      {
        /* Let the timer slave count from max HW tick */
        LpTAUJChannelSlaveRegs->ulTAUJnCDRm = LddHwMasterCDRCounterValue;
      }
  ...
  else /* Else OCU_DOWNCOUNTING */
  {
    ...
    if (LddHwMasterCDRCounterValue >= LddHwMasterCNTCounterValue)
    {
      ...
      if (LddHwNewThreshold < LddHwCounterValue)
      {
        ...
        if ((LddHwCounterValue - LddHwNewThreshold) >= (uint32)OCU_TWO)                                                 /* PRQA S 3383 # JV-01 */
        {
          ...
          LpTAUJChannelSlaveRegs->ulTAUJnCDRm = LddHwCounterValue - LddHwNewThreshold - (uint32)OCU_TWO;                /* PRQA S 3383, 3384 # JV-01, JV-01 */
        }
        /* If the new threshold minus the current is equal to 1 the first compare match event after setting the new
        threshold will be caused by one tick of delay */
        else
      ...
      else /* Interrupt for new threshold will not occur inside this cycle */
      {
        ...
        {
          /* Set the count down value = next threshold + current timer counter */
          LpTAUJChannelSlaveRegs->ulTAUJnCDRm =
                  LddHwMasterCNTCounterValue + LddHwMasterCDRCounterValue - LddHwNewThreshold - (uint32)OCU_ONE;        /* PRQA S 3383, 3384 # JV-01, JV-01 */
        } /* End of check corner case */
      } /* End of checking inside/outside current cycle */
    }
    else /* Else the master channel has not been started */
    {
      ...
      {
        /* Let the timer slave count from the new threshold */
        LpTAUJChannelSlaveRegs->ulTAUJnCDRm = LddHwMasterCDRCounterValue - LddHwNewThreshold - (uint32)OCU_ONE;         /* PRQA S 3383, 3384 # JV-01, JV-01 */
      }
  ...
  Ocu_HW_Tauj_EnableInterrupt(LddChannel);
} /* End of API Ocu_HW_Tauj_StartRestartChannel */

#define OCU_STOP_SEC_PRIVATE_CODE
#include "Ocu_MemMap.h"                                                                                                 /* PRQA S 5087 # JV-01 */
/***********************************************************************************************************************
** Function Name         : Ocu_HW_Tauj_StopChannel
**
** Service ID            : NA
**
...
**
** Reference ID          : OCU_DUD_ACT_037, OCU_DUD_ACT_037_CRT001, OCU_DUD_ACT_037_CRT002, OCU_DUD_ACT_037_GBL001
** Reference ID          : OCU_DUD_ACT_037_GBL002, OCU_DUD_ACT_037_GBL003
***********************************************************************************************************************/
#define OCU_START_SEC_PRIVATE_CODE
#include "Ocu_MemMap.h"                                                                                                 /* PRQA S 5087 # JV-01 */

FUNC(void, OCU_PRIVATE_CODE) Ocu_HW_Tauj_StopChannel(Ocu_ChannelType LddChannel)
{
  /* Pointer to the channel configuration */
  P2CONST(Ocu_ChannelConfigType, AUTOMATIC, OCU_CONFIG_DATA) LpChannel;
...
} /* End of API Ocu_HW_Tauj_StopChannel */
#define OCU_STOP_SEC_PRIVATE_CODE
#include "Ocu_MemMap.h"                                                                                                 /* PRQA S 5087 # JV-01 */
/***********************************************************************************************************************
** Function Name         : Ocu_HW_Tauj_SetThreshold
**
** Service ID            : NA
**
...
**
** Functions invoked     : Ocu_HW_Tauj_StartRestartChannel
**
** Registers used        : None
**
** Reference ID          : OCU_DUD_ACT_038, OCU_DUD_ACT_038_GBL001
***********************************************************************************************************************/
#if ((OCU_SET_ABSOLUTE_THRESHOLD_API == STD_ON) || (OCU_SET_RELATIVE_THRESHOLD_API == STD_ON))
#define OCU_START_SEC_PRIVATE_CODE
#include "Ocu_MemMap.h"                                                                                                 /* PRQA S 5087 # JV-01 */

FUNC(void, OCU_PRIVATE_CODE) Ocu_HW_Tauj_SetThreshold(Ocu_ChannelType LddChannel, Ocu_ValueType LddSwThresholdValue)
{
  /* Defining a pointer to point to the Channel Ram Data */
  P2VAR(Ocu_ChannelRamDataType, AUTOMATIC, OCU_CONFIG_DATA) LpRamData;                                                  /* PRQA S 3432 # JV-01 */
  /* Pointer to the channel configuration */
  ...
  if (OCU_CH_RUNNING == LpRamData->blChannelStatus)
  {
    ...
    Ocu_HW_Tauj_StartRestartChannel(LddChannel, LpRamData->ddHwLastThreshold);
  } /* else No action required */
} /* End of API Ocu_HW_Tauj_SetThreshold */

#define OCU_STOP_SEC_PRIVATE_CODE
#include "Ocu_MemMap.h"                                                                                                 /* PRQA S 5087 # JV-01 */
#endif /* ((OCU_SET_ABSOLUTE_THRESHOLD_API == STD_ON) || (OCU_SET_RELATIVE_THRESHOLD_API == STD_ON)) */
/***********************************************************************************************************************
** Function Name         : Ocu_HW_Tauj_EnableInterrupt
**
** Service ID            : NA
**
...
** Registers used        : EICn
**
** Reference ID          : OCU_DUD_ACT_040, OCU_DUD_ACT_040_GBL001, OCU_DUD_ACT_040_GBL002
***********************************************************************************************************************/
#define OCU_START_SEC_PRIVATE_CODE
#include "Ocu_MemMap.h"                                                                                                 /* PRQA S 5087 # JV-01 */

FUNC(void, OCU_PRIVATE_CODE) Ocu_HW_Tauj_EnableInterrupt(Ocu_ChannelType LddChannel)                                    /* PRQA S 3006 # JV-01 */
{
  /* Pointer to the channel configuration */
  P2CONST(Ocu_ChannelConfigType, AUTOMATIC, OCU_CONFIG_DATA) LpChannel;
...
} /* End of API Ocu_HW_Tauj_EnableInterrupt */

#define OCU_STOP_SEC_PRIVATE_CODE
#include "Ocu_MemMap.h"                                                                                                 /* PRQA S 5087 # JV-01 */
/***********************************************************************************************************************
** Function Name         : Ocu_HW_Tauj_DisableInterrupt
**
** Service ID            : NA
**
...
** Registers used        : EICn
**
** Reference ID          : OCU_DUD_ACT_041, OCU_DUD_ACT_041_GBL001, OCU_DUD_ACT_041_GBL002
***********************************************************************************************************************/
#define OCU_START_SEC_PRIVATE_CODE
#include "Ocu_MemMap.h"                                                                                                 /* PRQA S 5087 # JV-01 */

FUNC(void, OCU_PRIVATE_CODE) Ocu_HW_Tauj_DisableInterrupt(Ocu_ChannelType LddChannel)                                   /* PRQA S 3006 # JV-01 */
{
  /* Pointer to the channel configuration */
  P2CONST(Ocu_ChannelConfigType, AUTOMATIC, OCU_CONFIG_DATA) LpChannel;
  /* Updating the channel config parameter to the current channel */
  ...
  #endif
} /* End of API Ocu_HW_Tauj_DisableInterrupt */

#define OCU_STOP_SEC_PRIVATE_CODE
#include "Ocu_MemMap.h"                                                                                                 /* PRQA S 5087 # JV-01 */
/***********************************************************************************************************************
** Function Name         : Ocu_HW_Tauj_CbkNotification
**
** Service ID            : NA
**
...
**
** Registers Used        : EICn, TAUJnTO, ulTAUJnCDRm, TAUJnTS
**
** Reference ID          : OCU_DUD_ACT_042, OCU_DUD_ACT_042_ERR001
** Reference ID          : OCU_DUD_ACT_042_GBL001, OCU_DUD_ACT_042_GBL002, OCU_DUD_ACT_042_GBL003
** Reference ID          : OCU_DUD_ACT_042_CRT001, OCU_DUD_ACT_042_CRT002, OCU_DUD_ACT_042_CRT003
** Reference ID          : OCU_DUD_ACT_042_CRT004, OCU_DUD_ACT_042_CRT005, OCU_DUD_ACT_042_CRT006
** Reference ID          : OCU_DUD_ACT_042_GBL004
***********************************************************************************************************************/
#define OCU_START_SEC_CODE_FAST
#include "Ocu_MemMap.h"                                                                                                 /* PRQA S 5087 # JV-01 */

FUNC(void, OCU_CODE_FAST) Ocu_HW_Tauj_CbkNotification(uint8 LucChannelIdx)
{
  /* Pointer to the channel configuration */
  P2CONST(Ocu_ChannelConfigType, AUTOMATIC, OCU_CONFIG_DATA) LpChannel;
  /* Defining a pointer to point to the Channel Ram Data */
  ...
  #endif /* End of OCU_INTERRUPT_CONSISTENCY_CHECK == STD_ON */
  {
    ...
    LpTAUJUnitUserRegs =
        (P2VAR(Ocu_TAUJUnitUserRegs, AUTOMATIC, REGSPACE))Ocu_GpTAUUnitConfig[LpChannel->ucTimerUnitIndex]              /* PRQA S 0316, 3432 # JV-01, JV-01 */
    ...
    if (OCU_TRUE == LpRamData->blRequireRewriteCountValue)
    {
      ...
      LpTAUJChannelSlaveRegs = (P2VAR(Ocu_TAUJChannelUserRegs, AUTOMATIC, REGSPACE))LpTAUChannelConfigData->pCDRReg;    /* PRQA S 0316, 3432 # JV-01, JV-01 */
      /* Set the pointer to TAU register base address of Master Channel */
      LpTAUJChannelMasterRegs = (P2VAR(Ocu_TAUJChannelUserRegs, AUTOMATIC, REGSPACE))                                   /* PRQA S 0316, 3432 # JV-01, JV-01 */
                                                                                 LpTAUChannelConfigData->pMasterCDRReg; 
      /* The slave channel will count down from the max tick */
      LpTAUJChannelSlaveRegs->ulTAUJnCDRm = LpTAUJChannelMasterRegs->ulTAUJnCDRm;
      ...
      #endif
      {
        ...
        Ocu_HW_Tauj_DisableInterrupt(LucChannelIdx);
    ...
    if (OCU_TRUE == LpChannel->blOutputPinUsed)
    {
      ...
      {
        /* Set the corresponding bit of TAUJnTO register */
        LpTAUJUnitUserRegs->ucTAUJnTO |= (uint8)LpTAUChannelConfigData->usChannelBitValue;
        /* Disable the interrupt if it isn't used for notification */
        #if (OCU_NOTIFICATION_SUPPORTED == STD_ON)
        if (OCU_FALSE == LblNotifyStatus)
      ...
      {
        /* Reset the corresponding bit of TAUJnTO register */
        LpTAUJUnitUserRegs->ucTAUJnTO &= (uint8)~(LpTAUChannelConfigData->usChannelBitValue);
        /* Disable the interrupt if it isn't used for notification */
        #if (OCU_NOTIFICATION_SUPPORTED == STD_ON)
        if (OCU_FALSE == LblNotifyStatus)
...
} /* End of API Ocu_HW_Tauj_CbkNotification */

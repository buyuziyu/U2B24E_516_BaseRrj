...
/* Included for declaration of the Ocu_HW_Tauj_CbkNotification() function */
#include "Ocu_TAUJ_LLDriver.h"
/***********************************************************************************************************************
**                                                Version Information                                                 **
***********************************************************************************************************************/
/* AUTOSAR release version information */
#define OCU_TAUJ_IRQ_C_AR_RELEASE_MAJOR_VERSION    OCU_AR_RELEASE_MAJOR_VERSION_VALUE
#define OCU_TAUJ_IRQ_C_AR_RELEASE_MINOR_VERSION    OCU_AR_RELEASE_MINOR_VERSION_VALUE
#define OCU_TAUJ_IRQ_C_AR_RELEASE_REVISION_VERSION OCU_AR_RELEASE_REVISION_VERSION_VALUE
/* File version information */
#define OCU_TAUJ_IRQ_C_SW_MAJOR_VERSION            OCU_SW_MAJOR_VERSION_VALUE
#define OCU_TAUJ_IRQ_C_SW_MINOR_VERSION            OCU_SW_MINOR_VERSION_VALUE
/***********************************************************************************************************************
**                                                   Version Check                                                    **
***********************************************************************************************************************/
#if (OCU_TAUJ_IRQ_AR_RELEASE_MAJOR_VERSION != OCU_TAUJ_IRQ_C_AR_RELEASE_MAJOR_VERSION)
#error "Ocu_TAUJ_Irq.c : Mismatch in Release Major Version"
#endif
#if (OCU_TAUJ_IRQ_AR_RELEASE_MINOR_VERSION != OCU_TAUJ_IRQ_C_AR_RELEASE_MINOR_VERSION)
#error "Ocu_TAUJ_Irq.c : Mismatch in Release Minor Version"
#endif
#if (OCU_TAUJ_IRQ_AR_RELEASE_REVISION_VERSION != OCU_TAUJ_IRQ_C_AR_RELEASE_REVISION_VERSION)
#error "Ocu_TAUJ_Irq.c : Mismatch in Release Revision Version"
#endif
#if (OCU_TAUJ_IRQ_SW_MAJOR_VERSION != OCU_TAUJ_IRQ_C_SW_MAJOR_VERSION)
#error "Ocu_TAUJ_Irq.c : Mismatch in Software Major Version"
#endif
#if (OCU_TAUJ_IRQ_SW_MINOR_VERSION != OCU_TAUJ_IRQ_C_SW_MINOR_VERSION)
#error "Ocu_TAUJ_Irq.c : Mismatch in Software Minor Version"
#endif
...
**
** Function(s) invoked  : Ocu_HW_Tauj_CbkNotification
**
** Registers Used       : None
**
** Reference ID         : OCU_DUD_ACT_044
***********************************************************************************************************************/
...
#else
_INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUJ0_CH01_ISR(void)                                                              /* PRQA S 1503 # JV-01 */
#endif
{
  Ocu_HW_Tauj_CbkNotification((uint8)OCU_TAUJ0_CH01);
}
...
/* Defines the CAT1 interrupt mapping */
#else
_INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUJ0_CH03_ISR(void)                                                              /* PRQA S 1503 # JV-01 */
#endif
{
  Ocu_HW_Tauj_CbkNotification((uint8)OCU_TAUJ0_CH03);
}
...
/* Defines the CAT1 interrupt mapping */
#else
_INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUJ1_CH01_ISR(void)                                                              /* PRQA S 1503 # JV-01 */
#endif
{
  Ocu_HW_Tauj_CbkNotification((uint8)OCU_TAUJ1_CH01);
}
...
/* Defines the CAT1 interrupt mapping */
#else
_INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUJ1_CH03_ISR(void)                                                              /* PRQA S 1503 # JV-01 */
#endif
{
  Ocu_HW_Tauj_CbkNotification((uint8)OCU_TAUJ1_CH03);
}
...
/* Defines the CAT1 interrupt mapping */
#else
_INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUJ2_CH01_ISR(void)                                                              /* PRQA S 1503 # JV-01 */
#endif
{
  Ocu_HW_Tauj_CbkNotification((uint8)OCU_TAUJ2_CH01);
}
...
/* Defines the CAT1 interrupt mapping */
#else
_INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUJ2_CH03_ISR(void)                                                              /* PRQA S 1503 # JV-01 */
#endif
{
  Ocu_HW_Tauj_CbkNotification((uint8)OCU_TAUJ2_CH03);
}
...
/* Defines the CAT1 interrupt mapping */
#else
_INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUJ3_CH01_ISR(void)                                                              /* PRQA S 1503 # JV-01 */
#endif
{
  Ocu_HW_Tauj_CbkNotification((uint8)OCU_TAUJ3_CH01);
}
...
/* Defines the CAT1 interrupt mapping */
#else
_INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUJ3_CH03_ISR(void)                                                              /* PRQA S 1503 # JV-01 */
#endif
{
  Ocu_HW_Tauj_CbkNotification((uint8)OCU_TAUJ3_CH03);
}

 ...
 *  1.1.1  30/08/2024  : As part of Multi Variant support, following changes are made:
                         1. Add declaration of Ocu_GblCountingDirection, Ocu_GucKernelCoreId, Ocu_GulPollingTimes
...
#define OCU_RAM_AR_RELEASE_MAJOR_VERSION    OCU_AR_RELEASE_MAJOR_VERSION
#define OCU_RAM_AR_RELEASE_MINOR_VERSION    OCU_AR_RELEASE_MINOR_VERSION
#define OCU_RAM_AR_RELEASE_REVISION_VERSION OCU_AR_RELEASE_REVISION_VERSION

/* File version information */
#define OCU_RAM_SW_MAJOR_VERSION            OCU_SW_MAJOR_VERSION
#define OCU_RAM_SW_MINOR_VERSION            OCU_SW_MINOR_VERSION
#define OCU_RAM_SW_PATCH_VERSION            OCU_SW_PATCH_VERSION
...
extern P2CONST(Ocu_ChannelConfigType, OCU_VAR_NO_INIT, OCU_CONFIG_CONST) volatile Ocu_GpChannelConfig;
/* Global pointer variable for channel data */
extern P2VAR(Ocu_ChannelRamDataType, OCU_VAR_NO_INIT, OCU_VAR_NO_INIT) volatile Ocu_GpChannelRamData;                   /* PRQA S 3432 # JV-01 */
...
extern volatile VAR(boolean, OCU_VAR_INIT) Ocu_GblDriverStatus;
...
extern volatile boolean Ocu_GblCountingDirection;
#define OCU_STOP_SEC_VAR_NO_INIT_BOOLEAN
#include "Ocu_MemMap.h"

#define OCU_START_SEC_VAR_INIT_PTR
#include "Ocu_MemMap.h"
/* Function pointer variable for timer unit configuration */
extern P2CONST(Ocu_HwFuncTableType, OCU_VAR_INIT, OCU_CONFIG_DATA) Ocu_GaaHwFunc[];                                     /* PRQA S 3684 # JV-01 */
...
extern uint8 Ocu_GucKernelCoreId;
...
extern uint32 Ocu_GulPollingTimes;

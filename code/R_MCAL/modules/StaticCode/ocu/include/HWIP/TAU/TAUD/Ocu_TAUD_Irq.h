...
#ifndef OCU_TAUD_IRQ_H
#define OCU_TAUD_IRQ_H
...
#define OCU_TAUD_IRQ_AR_RELEASE_MAJOR_VERSION    OCU_AR_RELEASE_MAJOR_VERSION
#define OCU_TAUD_IRQ_AR_RELEASE_MINOR_VERSION    OCU_AR_RELEASE_MINOR_VERSION
#define OCU_TAUD_IRQ_AR_RELEASE_REVISION_VERSION OCU_AR_RELEASE_REVISION_VERSION
/* File version information */
#define OCU_TAUD_IRQ_SW_MAJOR_VERSION            OCU_SW_MAJOR_VERSION
#define OCU_TAUD_IRQ_SW_MINOR_VERSION            OCU_SW_MINOR_VERSION
#define OCU_TAUD_IRQ_SW_PATCH_VERSION            OCU_SW_PATCH_VERSION
/***********************************************************************************************************************
**                                                   Global Symbols                                                   **
***********************************************************************************************************************/
...
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD0_CH01_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD0_CH03_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD0_CH05_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD0_CH07_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD0_CH09_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD0_CH11_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD0_CH13_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD0_CH15_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD1_CH01_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD1_CH03_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD1_CH05_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD1_CH07_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD1_CH09_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD1_CH11_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD1_CH13_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD1_CH15_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD2_CH01_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD2_CH03_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD2_CH05_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD2_CH07_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD2_CH09_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD2_CH11_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD2_CH13_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD2_CH15_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD3_CH01_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD3_CH03_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD3_CH05_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD3_CH07_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD3_CH09_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD3_CH11_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD3_CH13_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, OCU_CODE_FAST) TAUD3_CH15_ISR(void);
#endif

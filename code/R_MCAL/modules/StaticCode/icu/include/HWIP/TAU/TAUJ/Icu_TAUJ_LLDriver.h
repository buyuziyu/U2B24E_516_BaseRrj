 ...
 *                       1.Add function Icu_HW_Tauj_EdgeCountingInit and Icu_HW_Tauj_ResetEdgeCount
 *                       2.Remove Icu_HW_Tauj_SetMode, remove pre-compile condition Icu_HW_Tauj_StartCountMeasurement
...
FUNC(void, ICU_PRIVATE_CODE) Icu_HW_Tauj_EdgeCountingInit
...
extern FUNC(void, ICU_PRIVATE_CODE) Icu_HW_Tauj_ChannelInit(const Icu_ChannelType LddChannelIndex);
...
#if (ICU_EDGE_COUNT_API == STD_ON)
extern FUNC(void, ICU_PRIVATE_CODE) Icu_HW_Tauj_ResetEdgeCount(const Icu_ChannelType LddChannel);
#endif

#if (ICU_DE_INIT_API == STD_ON)
extern FUNC(void, ICU_PRIVATE_CODE) Icu_HW_Tauj_UnitDeInit(void);

extern FUNC(void, ICU_PRIVATE_CODE) Icu_HW_Tauj_ChannelDeInit(const Icu_ChannelType LddChannelIndex);
#endif

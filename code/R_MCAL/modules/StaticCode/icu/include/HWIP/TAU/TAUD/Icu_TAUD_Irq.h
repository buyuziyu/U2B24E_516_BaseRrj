 ...
 *                       1.Add precompile condition ICU_TAUD_UNIT_USED
 ...
 * 1.4.1:  15/09/2021  : Add ISR for TAUD3.
...
/**********************************************************************************************************************/
#ifndef ICU_TAUD_IRQ_H
#define ICU_TAUD_IRQ_H
/***********************************************************************************************************************
**                                                  Include Section                                                   **
***********************************************************************************************************************/
...
#define ICU_TAUD_IRQ_AR_RELEASE_MAJOR_VERSION    ICU_AR_RELEASE_MAJOR_VERSION
#define ICU_TAUD_IRQ_AR_RELEASE_MINOR_VERSION    ICU_AR_RELEASE_MINOR_VERSION
#define ICU_TAUD_IRQ_AR_RELEASE_REVISION_VERSION ICU_AR_RELEASE_REVISION_VERSION

/* File version information */
#define ICU_TAUD_IRQ_SW_MAJOR_VERSION            ICU_SW_MAJOR_VERSION
#define ICU_TAUD_IRQ_SW_MINOR_VERSION            ICU_SW_MINOR_VERSION
...
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD0_CH00_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD0_CH01_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD0_CH02_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD0_CH03_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD0_CH04_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD0_CH05_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD0_CH06_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD0_CH07_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD0_CH08_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD0_CH09_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD0_CH10_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD0_CH11_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD0_CH12_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD0_CH13_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD0_CH14_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD0_CH15_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD1_CH00_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD1_CH01_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD1_CH02_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD1_CH03_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD1_CH04_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD1_CH05_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD1_CH06_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD1_CH07_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD1_CH08_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD1_CH09_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD1_CH10_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD1_CH11_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD1_CH12_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD1_CH13_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD1_CH14_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD1_CH15_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD2_CH00_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD2_CH01_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD2_CH02_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD2_CH03_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD2_CH04_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD2_CH05_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD2_CH06_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD2_CH07_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD2_CH08_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD2_CH09_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD2_CH10_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD2_CH11_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD2_CH12_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD2_CH13_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD2_CH14_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD2_CH15_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD3_CH00_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD3_CH01_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD3_CH02_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD3_CH03_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD3_CH04_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD3_CH05_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD3_CH06_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD3_CH07_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD3_CH08_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD3_CH09_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD3_CH10_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD3_CH11_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD3_CH12_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD3_CH13_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD3_CH14_ISR(void);
#endif
...
/* Defines the CAT1 interrupt mapping */
#else
extern _INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUD3_CH15_ISR(void);
#endif

...
#define ICU_LLDRIVER_AR_RELEASE_REVISION_VERSION ICU_AR_RELEASE_REVISION_VERSION
...
extern FUNC(Icu_LevelType, ICU_PRIVATE_CODE) Icu_HW_GetInputLevel(const Icu_ChannelType LddChannel);
#endif

#if (ICU_SET_MODE_API == STD_ON)
FUNC(void, ICU_PRIVATE_CODE) Icu_HW_SetMode(const Icu_ChannelType LddChannel, const Icu_ModeType LenMode);
#endif /* End of (ICU_SET_MODE_API == STD_ON) */

#endif /* ICU_LLDRIVER_HEADER */

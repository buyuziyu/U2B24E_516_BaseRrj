...
#define ICU_TAUJ_IRQ_C_AR_RELEASE_MAJOR_VERSION    ICU_AR_RELEASE_MAJOR_VERSION_VALUE
#define ICU_TAUJ_IRQ_C_AR_RELEASE_MINOR_VERSION    ICU_AR_RELEASE_MINOR_VERSION_VALUE
#define ICU_TAUJ_IRQ_C_AR_RELEASE_REVISION_VERSION ICU_AR_RELEASE_REVISION_VERSION_VALUE

/* File version information */
#define ICU_TAUJ_IRQ_C_SW_MAJOR_VERSION            ICU_SW_MAJOR_VERSION_VALUE
#define ICU_TAUJ_IRQ_C_SW_MINOR_VERSION            ICU_SW_MINOR_VERSION_VALUE

/***********************************************************************************************************************
**                                                   Version Check                                                    **
***********************************************************************************************************************/
#if (ICU_TAUJ_IRQ_AR_RELEASE_MAJOR_VERSION != ICU_TAUJ_IRQ_C_AR_RELEASE_MAJOR_VERSION)
  #error "Icu_TAUJ_Irq.c : Mismatch in Release Major Version"
#endif

#if (ICU_TAUJ_IRQ_AR_RELEASE_MINOR_VERSION != ICU_TAUJ_IRQ_C_AR_RELEASE_MINOR_VERSION)
  #error "Icu_TAUJ_Irq.c : Mismatch in Release Minor Version"
#endif

#if (ICU_TAUJ_IRQ_AR_RELEASE_REVISION_VERSION != ICU_TAUJ_IRQ_C_AR_RELEASE_REVISION_VERSION)
  #error "Icu_TAUJ_Irq.c : Mismatch in Release Revision Version"
#endif

#if (ICU_TAUJ_IRQ_SW_MAJOR_VERSION != ICU_TAUJ_IRQ_C_SW_MAJOR_VERSION)
  #error "Icu_TAUJ_Irq.c : Mismatch in Software Major Version"
#endif

#if (ICU_TAUJ_IRQ_SW_MINOR_VERSION != ICU_TAUJ_IRQ_C_SW_MINOR_VERSION)
  #error "Icu_TAUJ_Irq.c : Mismatch in Software Minor Version"
#endif
...
** Service ID           : NA
**
** Description          : These are Interrupt routines for the timer TAUJn Channel m, where n represents 
**                        the TAUJ Units and m represents channels associated for each Unit.
**
...
**
** Function(s) invoked  : Icu_HW_Tauj_TimerIsr
**
** Registers Used       : None
**
** Reference ID         : ICU_DUD_ACT_067
***********************************************************************************************************************/
...
#else
_INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUJ0_CH00_ISR(void)                                                              /* PRQA S 1503 # JV-01 */
#endif
{
  Icu_HW_Tauj_TimerIsr(ICU_TAUJ0_CH00);
}
...
/* Defines the CAT1 interrupt mapping */
#else
_INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUJ0_CH01_ISR(void)                                                              /* PRQA S 1503 # JV-01 */
#endif
{
  Icu_HW_Tauj_TimerIsr(ICU_TAUJ0_CH01);
}
...
/* Defines the CAT1 interrupt mapping */
#else
_INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUJ0_CH02_ISR(void)                                                              /* PRQA S 1503 # JV-01 */
#endif
{
  Icu_HW_Tauj_TimerIsr(ICU_TAUJ0_CH02);
}
...
/* Defines the CAT1 interrupt mapping */
#else
_INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUJ0_CH03_ISR(void)                                                              /* PRQA S 1503 # JV-01 */
#endif
{
  Icu_HW_Tauj_TimerIsr(ICU_TAUJ0_CH03);
}
...
/* Defines the CAT1 interrupt mapping */
#else
_INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUJ1_CH00_ISR(void)                                                              /* PRQA S 1503 # JV-01 */
#endif
{
  Icu_HW_Tauj_TimerIsr(ICU_TAUJ1_CH00);
}
...
/* Defines the CAT1 interrupt mapping */
#else
_INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUJ1_CH01_ISR(void)                                                              /* PRQA S 1503 # JV-01 */
#endif
{
  Icu_HW_Tauj_TimerIsr(ICU_TAUJ1_CH01);
}
...
/* Defines the CAT1 interrupt mapping */
#else
_INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUJ1_CH02_ISR(void)                                                              /* PRQA S 1503 # JV-01 */
#endif
{
  Icu_HW_Tauj_TimerIsr(ICU_TAUJ1_CH02);
}
...
/* Defines the CAT1 interrupt mapping */
#else
_INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUJ1_CH03_ISR(void)                                                              /* PRQA S 1503 # JV-01 */
#endif
{
  Icu_HW_Tauj_TimerIsr(ICU_TAUJ1_CH03);
}
...
/* Defines the CAT1 interrupt mapping */
#else
_INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUJ2_CH00_ISR(void)                                                              /* PRQA S 1503 # JV-01 */
#endif
{
  Icu_HW_Tauj_TimerIsr(ICU_TAUJ2_CH00);
}
...
/* Defines the CAT1 interrupt mapping */
#else
_INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUJ2_CH01_ISR(void)                                                              /* PRQA S 1503 # JV-01 */
#endif
{
  Icu_HW_Tauj_TimerIsr(ICU_TAUJ2_CH01);
}
...
/* Defines the CAT1 interrupt mapping */
#else
_INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUJ2_CH02_ISR(void)                                                              /* PRQA S 1503 # JV-01 */
#endif
{
  Icu_HW_Tauj_TimerIsr(ICU_TAUJ2_CH02);
}
...
/* Defines the CAT1 interrupt mapping */
#else
_INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUJ2_CH03_ISR(void)                                                              /* PRQA S 1503 # JV-01 */
#endif
{
  Icu_HW_Tauj_TimerIsr(ICU_TAUJ2_CH03);
}
...
/* Defines the CAT1 interrupt mapping */
#else
_INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUJ3_CH00_ISR(void)                                                              /* PRQA S 1503 # JV-01 */
#endif
{
  Icu_HW_Tauj_TimerIsr(ICU_TAUJ3_CH00);
}
...
/* Defines the CAT1 interrupt mapping */
#else
_INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUJ3_CH01_ISR(void)                                                              /* PRQA S 1503 # JV-01 */
#endif
{
  Icu_HW_Tauj_TimerIsr(ICU_TAUJ3_CH01);
}
...
/* Defines the CAT1 interrupt mapping */
#else
_INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUJ3_CH02_ISR(void)                                                              /* PRQA S 1503 # JV-01 */
#endif
{
  Icu_HW_Tauj_TimerIsr(ICU_TAUJ3_CH02);
}
...
/* Defines the CAT1 interrupt mapping */
#else
_INTERRUPT_ FUNC(void, ICU_CODE_FAST) TAUJ3_CH03_ISR(void)                                                              /* PRQA S 1503 # JV-01 */
#endif
{
  Icu_HW_Tauj_TimerIsr(ICU_TAUJ3_CH03);
}

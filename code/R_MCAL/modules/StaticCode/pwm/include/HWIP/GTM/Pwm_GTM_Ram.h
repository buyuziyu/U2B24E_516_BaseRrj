...
#ifndef PWM_GTM_RAM_H
#define PWM_GTM_RAM_H
...
#define PWM_GTM_RAM_AR_RELEASE_MAJOR_VERSION    PWM_AR_RELEASE_MAJOR_VERSION
#define PWM_GTM_RAM_AR_RELEASE_MINOR_VERSION    PWM_AR_RELEASE_MINOR_VERSION
#define PWM_GTM_RAM_AR_RELEASE_REVISION_VERSION PWM_AR_RELEASE_REVISION_VERSION

/* Software module version information */
#define PWM_GTM_RAM_SW_MAJOR_VERSION            PWM_SW_MAJOR_VERSION
#define PWM_GTM_RAM_SW_MINOR_VERSION            PWM_SW_MINOR_VERSION
#define PWM_GTM_RAM_SW_PATCH_VERSION            PWM_SW_PATCH_VERSION
...
extern P2CONST(Pwm_GTMUnitConfigType, PWM_VAR_NO_INIT, PWM_CONFIG_CONST) volatile Pwm_GpGTMUnitConfig;
...
extern CONST(Pwm_HwFuncTableType, PWM_CONST) Pwm_GtmFunc;

 ...
 *                     : Add macro SPI_MAX_MSPI_ORED,SPI_INTERRUPT_MASK to support Ored Interrupt function
 *                     : Remove QAC warning message 1534
 * 2.1.0:  27/02/2024  : Update SW-VERSION to 2.1.0
 * 2.0.2:  14/12/2023  : Update SW-VERSION to 2.0.2
 * 2.0.1:  23/10/2023  : Fixed QAC warning message 1534 support Amendment 2
...
#define SPI_MAX_MSPI_ORED                        4U
#define SPI_INTERRUPT_MASK                       0xFFFFU

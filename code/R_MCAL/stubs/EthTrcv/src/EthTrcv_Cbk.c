...
#define ETHTRCV_C_AR_RELEASE_MAJOR_VERSION \
                                           ETH_AR_RELEASE_MAJOR_VERSION_VALUE
#define ETHTRCV_C_AR_RELEASE_MINOR_VERSION \
                                           ETH_AR_RELEASE_MINOR_VERSION_VALUE
#define ETHTRCV_C_AR_RELEASE_REVISION_VERSION \
                                        ETH_AR_RELEASE_REVISION_VERSION_VALUE

/* File version information */
#define ETHTRCV_SW_MAJOR_VERSION    ETH_SW_MAJOR_VERSION
#define ETHTRCV_SW_MINOR_VERSION    ETH_SW_MINOR_VERSION
...
*******************************************************************************/
void EthTrcv_ReadMiiIndication(uint8 CtrlIdx,uint8 TrcvIdx,
                               uint8 RegIdx, uint16 RegVal)
{
  #ifdef ETH_DEBUG_CONSOLE_MODE
  printf("CallBack EthTrcv_ReadMiiIndication\n");
  #endif
}
...
*******************************************************************************/
void EthTrcv_WriteMiiIndication(uint8 CtrlIdx,uint8 TrcvIdx,
                               uint8 RegIdx)
{
  #ifdef ETH_DEBUG_CONSOLE_MODE
  printf("CallBack EthTrcv_WriteMiiIndication\n");
  #endif
}

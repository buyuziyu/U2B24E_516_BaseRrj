...
#define ETHTRCV_TYPES_AR_RELEASE_MAJOR_VERSION      4
#define ETHTRCV_TYPES_AR_RELEASE_MINOR_VERSION      8
#define ETHTRCV_TYPES_AR_RELEASE_REVISION_VERSION   0

/* Module software version information */
#define ETHTRCV_TYPES_SW_MAJOR_VERSION         2
#define ETHTRCV_TYPES_SW_MINOR_VERSION         2

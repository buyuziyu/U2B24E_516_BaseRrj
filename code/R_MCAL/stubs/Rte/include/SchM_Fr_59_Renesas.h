 ...
 */
extern void SchM_Enter_Fr_59_Renesas_FR_INTERRUPT_CONTROL_PROTECTION(void);
extern void SchM_Exit_Fr_59_Renesas_FR_INTERRUPT_CONTROL_PROTECTION(void);
#endif /* SCHM_FR_H */

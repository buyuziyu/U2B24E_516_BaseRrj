 ...
 * 2.1.1:  27/06/2024  : Update SW-VERSION 2.1.1
 * 2.1.0:  23/02/2024  : Update SW-VERSION 2.1.0
...
extern void SchM_Enter_Adc_ADC_RAM_DATA_PROTECTION_GLOBAL(void);
extern void SchM_Exit_Adc_ADC_RAM_DATA_PROTECTION_GLOBAL(void);

 ...
 * 2.1.2:  31/10/2024  : Update SW-VERSION to 2.1.2 for U2Bx Beta2 release
 * 2.1.1:  24/07/2024  : Update SW-VERSION to 2.1.1
 * 2.1.0:  23/02/2024  : Update SW-VERSION to 2.1.0
 * 2.0.0:  26/07/2023  : Remove SchM_Enter_Gpt_GPT_RAM_DATA_PROTECTION,
...
**                      Global Symbols                                        **
*******************************************************************************/
#define GPT_CRITICAL_SECTION_WAIT          40U
/*******************************************************************************
**                      Global Data Types                                     **
*******************************************************************************/
...
extern void SchM_Enter_Gpt_GPT_RAM_DATA_PROTECTION_GLOBAL(void);
extern void SchM_Exit_Gpt_GPT_RAM_DATA_PROTECTION_GLOBAL(void);
extern void SchM_Enter_Gpt_GPT_INTERRUPT_CONTROL_PROTECTION(void);
extern void SchM_Exit_Gpt_GPT_INTERRUPT_CONTROL_PROTECTION(void);
extern void SchM_Enter_Gpt_GPT_INTERRUPT_CONTROL_PROTECTION_GLOBAL(void);
extern void SchM_Exit_Gpt_GPT_INTERRUPT_CONTROL_PROTECTION_GLOBAL(void);
#endif /* SCHM_GPT_H */

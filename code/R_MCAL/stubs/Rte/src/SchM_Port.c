...
**                      Global Symbols                                        **
*******************************************************************************/
static uint32 SchM_GLcPortDINestCount[NUM_CPU] = {0UL, 0UL, 0UL, 0UL, 0UL, 0UL};
...
/*******************************************************************************
**        SchM_Enter_Port_PORT_INTERRUPT_CONTROL_PROTECTION()                 **
*******************************************************************************/
void SchM_Enter_Port_PORT_INTERRUPT_CONTROL_PROTECTION_INTER_GLOBAL(void)
{
  uint8 LucPE = 0;
  LucPE = GetCoreID();
  DISABLE_INTERRUPT();
  SchM_GLcPortDINestCount[LucPE]++;
}

/*******************************************************************************
**        SchM_Exit_Port_PORT_INTERRUPT_CONTROL_PROTECTION()                  **
*******************************************************************************/
void SchM_Exit_Port_PORT_INTERRUPT_CONTROL_PROTECTION_INTER_GLOBAL(void)
{
  uint8 LucPE = 0;
  LucPE = GetCoreID();
  if (0U < SchM_GLcPortDINestCount[LucPE])
  {
    SchM_GLcPortDINestCount[LucPE]--;
    if (0U == SchM_GLcPortDINestCount[LucPE])
    {
...
/*******************************************************************************
**        SchM_Enter_Port_PORT_INTERRUPT_CONTROL_PROTECTION_GLOBAL()          **
*******************************************************************************/
void SchM_Enter_Port_PORT_INTERRUPT_CONTROL_PROTECTION_GLOBAL(void)
{
...
/*******************************************************************************
**        SchM_Exit_Port_PORT_INTERRUPT_CONTROL_PROTECTION_GLOBAL()           **
*******************************************************************************/
void SchM_Exit_Port_PORT_INTERRUPT_CONTROL_PROTECTION_GLOBAL(void)
{
  #ifdef USE_MULTI_CORE

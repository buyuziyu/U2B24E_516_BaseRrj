 ...
 * 2.0.0:  16/08/2023  : Add critical section for global variable protection
...
/*******************************************************************************
**        SchM_Enter_Can_CAN_INTERRUPT_CONTROL_PROTECTION_GLOBAL()            **
*******************************************************************************/
void SchM_Enter_Can_CAN_INTERRUPT_CONTROL_PROTECTION_GLOBAL(void)
{
...
/*******************************************************************************
**        SchM_Exit_Can_CAN_INTERRUPT_CONTROL_PROTECTION_GLOBAL()             **
*******************************************************************************/
void SchM_Exit_Can_CAN_INTERRUPT_CONTROL_PROTECTION_GLOBAL(void)
{
  #ifdef USE_MULTI_CORE
...
/*******************************************************************************
**        SchM_Enter_Can_CAN_RAM_DATA_PROTECTION_GLOBAL()            **
*******************************************************************************/
void SchM_Enter_Can_CAN_RAM_DATA_PROTECTION_GLOBAL(void)
{
  #ifdef USE_MULTI_CORE
...
/*******************************************************************************
**        SchM_Exit_Can_CAN_RAM_DATA_PROTECTION_GLOBAL()             **
*******************************************************************************/
void SchM_Exit_Can_CAN_RAM_DATA_PROTECTION_GLOBAL(void)
{
  #ifdef USE_MULTI_CORE

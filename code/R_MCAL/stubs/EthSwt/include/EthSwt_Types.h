...
#define ETHSWT_TYPES_AR_RELEASE_MINOR_VERSION      8
#define ETHSWT_TYPES_AR_RELEASE_REVISION_VERSION   0

/* Module software version information */
#define ETHSWT_TYPES_SW_MAJOR_VERSION         2
#define ETHSWT_TYPES_SW_MINOR_VERSION         0

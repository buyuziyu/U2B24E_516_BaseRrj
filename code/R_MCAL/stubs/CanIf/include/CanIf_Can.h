 ...
 * 2.0.2:  06/06/2024 : Add Function Prototype for CanIf_XLRxIndication
...
extern void CanIf_XLRxIndication (const CanXL_HwType* Mailbox,
                                  const PduInfoType* PduInfoPtr);
...
/* Error Passive transition referring to the corresponding CAN controller */
extern void CanIf_ControllerErrorStatePassive(uint8 ControllerId, \
                                       uint16 RxErrorCounter, \
                                       uint16 TxErrorCounter);

/* Can Bus Error referring to the corresponding CAN controller */
extern void CanIf_ErrorNotification(uint8 ControllerId, \

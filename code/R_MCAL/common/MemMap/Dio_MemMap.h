 ...
 * 2.1.1:   11/06/2024  : Update SW-Version to 2.1.1
 * 2.1.0:   23/02/2024  : Update SW-VERSION to 2.1.0
 * 2.0.2:   22/01/2024  : Update SW-Version 2.0.2
 * 2.0.1:   10/10/2023  : Add tag {configClass} in memory section 
 *                        for CONFIG_DATA
...
#define DIO_MEMMAP_AR_RELEASE_MINOR_VERSION      8
...
#define DIO_MEMMAP_SW_MINOR_VERSION   4
...
/* -------------------------------------------------------------------------- */
     ...
     #pragma ghs section bss=".DIO_CFG_RAM_UNSPECIFIED"
   #endif
     ...
     #pragma ghs startdata
     #pragma ghs section rodata=".DIO_CFG_DATA_1BIT"
   #endif
     ...
     #pragma ghs startdata
     #pragma ghs section rodata=".DIO_CFG_DATA_8BIT"
   #endif
     ...
     #pragma ghs startdata
     #pragma ghs section rodata=".DIO_CFG_DATA_16BIT"
   #endif
     ...
     #pragma ghs startdata
     #pragma ghs section rodata=".DIO_CFG_DATA_32BIT"
   #endif
...
#elif defined (DIO_START_SEC_CONFIG_DATA_PREBUILD_UNSPECIFIED)
   #ifdef DIO_CONFIG_DATA_UNSPECIFIED_SEC_STARTED
     #error "Memory section is not stopped"
   #else
     #define DIO_CONFIG_DATA_UNSPECIFIED_SEC_STARTED
     #undef  DIO_START_SEC_CONFIG_DATA_PREBUILD_UNSPECIFIED
     #pragma ghs startdata
     #pragma ghs section rodata=".DIO_CFG_DATA_UNSPECIFIED"
   #endif
#elif defined (DIO_STOP_SEC_CONFIG_DATA_PREBUILD_UNSPECIFIED)
   #ifndef DIO_CONFIG_DATA_UNSPECIFIED_SEC_STARTED
     #error "Memory section is not started"
   #else
     #undef  DIO_CONFIG_DATA_UNSPECIFIED_SEC_STARTED
     #undef  DIO_STOP_SEC_CONFIG_DATA_PREBUILD_UNSPECIFIED
     #define DEFAULT_STOP_SEC_CONST_UNSPECIFIED
   #endif
     ...
     #pragma ghs startdata
     #pragma ghs section rodata=".DIO_CFG_DBTOC_UNSPECIFIED"
   #endif

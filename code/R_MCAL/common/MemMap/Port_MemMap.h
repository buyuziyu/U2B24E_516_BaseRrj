...
*******************************************************************************/
/*
 * 2.4.1:  08/06/2025  :Update SW-VERSION to 2.4.1
 ...
 *                      U2Bx Final Release
 * 2.1.2   31/10/2024   Update SW-VERSION for RH850/U2Bx-E MCAL Ver22.00.03
 * 2.1.1   12/07/2024   Update SW-VERSION to 2.1.1
...
#define PORT_MEMMAP_AR_RELEASE_MINOR_VERSION      8
#define PORT_MEMMAP_AR_RELEASE_REVISION_VERSION   0

/*
 * File version information
 */
#define PORT_MEMMAP_SW_MAJOR_VERSION   2
#define PORT_MEMMAP_SW_MINOR_VERSION   4
#define PORT_MEMMAP_SW_PATCH_VERSION   1
...
/* -------------------------------------------------------------------------- */
     ...
     #pragma ghs section bss=".PORT_CFG_RAM_UNSPECIFIED"
   #endif
     ...
     #pragma ghs startdata
     #pragma ghs section rodata=".PORT_CFG_DATA_1BIT"
   #endif
     ...
     #pragma ghs startdata
     #pragma ghs section rodata=".PORT_CFG_DATA_8BIT"
   #endif
     ...
     #pragma ghs startdata
     #pragma ghs section rodata=".PORT_CFG_DATA_16BIT"
   #endif
     ...
     #pragma ghs startdata
     #pragma ghs section rodata=".PORT_CFG_DATA_32BIT"
   #endif
...
#elif defined (PORT_START_SEC_CONFIG_DATA_POSTBUILD_UNSPECIFIED)
   #ifdef PORT_CONFIG_DATA_UNSPECIFIED_SEC_STARTED
     #error "Memory section is not stopped"
   #else
     #define PORT_CONFIG_DATA_UNSPECIFIED_SEC_STARTED
     #undef  PORT_START_SEC_CONFIG_DATA_POSTBUILD_UNSPECIFIED
     #pragma ghs startdata
     #pragma ghs section rodata=".PORT_CFG_DATA_UNSPECIFIED"
   #endif
#elif defined (PORT_STOP_SEC_CONFIG_DATA_POSTBUILD_UNSPECIFIED)
   #ifndef PORT_CONFIG_DATA_UNSPECIFIED_SEC_STARTED
     #error "Memory section is not started"
   #else
     #undef  PORT_CONFIG_DATA_UNSPECIFIED_SEC_STARTED
     #undef  PORT_STOP_SEC_CONFIG_DATA_POSTBUILD_UNSPECIFIED
     #define DEFAULT_STOP_SEC_CONST_UNSPECIFIED
   #endif
     ...
     #pragma ghs startdata
     #pragma ghs section rodata=".PORT_CFG_DBTOC_UNSPECIFIED"
   #endif
...
*******************************************************************************/
/* general start of #elif chain with #if                                     */
#if defined (START_WITH_IF)

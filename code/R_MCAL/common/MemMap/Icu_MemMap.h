 ...
 *                           ICU_MEMMAP_SW_PATCH_VERSION to 1
 ...
 * 2.0.2      10/01/2024     Change SW version to 2.0.2
 * 2.0.1      22/09/2023     Initial Version
 *            14/10/2023     Change section SEC_CONFIG_DATA_UNSPECIFIED to
 *                           SEC_CONFIG_DATA_POSTBUILD_UNSPECIFIED
 *                           Remove memory section 
 *                           ICU_START/STOP_SEC_DBTOC_DATA_UNSPECIFIED
 */
/******************************************************************************/
...
#define ICU_MEMMAP_AR_RELEASE_MINOR_VERSION      8
#define ICU_MEMMAP_AR_RELEASE_REVISION_VERSION   0

/*
 * File version information
 */
#define ICU_MEMMAP_SW_MAJOR_VERSION   2
#define ICU_MEMMAP_SW_MINOR_VERSION   4
#define ICU_MEMMAP_SW_PATCH_VERSION   1
 ...
 * This first #ifdef makes integration of delivered parts of Icu_MemMap.h
...
/* -------------------------------------------------------------------------- */
    ...
    #define DEFAULT_STOP_SEC_CONST_PTR
     ...
     #pragma ghs section bss=".ICU_CFG_RAM_UNSPECIFIED"
   #endif
...
#elif defined (ICU_START_SEC_CONFIG_DATA_POSTBUILD_UNSPECIFIED)
   #ifdef ICU_CONFIG_DATA_UNSPECIFIED_SEC_STARTED
     #error "Memory section is not stopped"
   #else
     #define ICU_CONFIG_DATA_UNSPECIFIED_SEC_STARTED
     #undef  ICU_START_SEC_CONFIG_DATA_POSTBUILD_UNSPECIFIED
     #pragma ghs startdata
     #pragma ghs section rodata=".ICU_CFG_DATA_UNSPECIFIED"
   #endif
#elif defined (ICU_STOP_SEC_CONFIG_DATA_POSTBUILD_UNSPECIFIED)
   #ifndef ICU_CONFIG_DATA_UNSPECIFIED_SEC_STARTED
     #error "Memory section is not started"
   #else
     #undef  ICU_CONFIG_DATA_UNSPECIFIED_SEC_STARTED
     #undef  ICU_STOP_SEC_CONFIG_DATA_POSTBUILD_UNSPECIFIED
     #define DEFAULT_STOP_SEC_CONST_UNSPECIFIED
   #endif
...
/* For multi core */
#elif defined (ICU_START_SEC_PUBLIC_CODE_GLOBAL)
   #ifdef PUBLIC_CODE_SEC_STARTED
     #error "Memory section is not stopped"
   #else
     #define PUBLIC_CODE_SEC_STARTED
     #undef  ICU_START_SEC_PUBLIC_CODE_GLOBAL
     #pragma ghs section text=".ICU_PUBLIC_CODE_ROM"
   #endif
#elif defined (ICU_STOP_SEC_PUBLIC_CODE_GLOBAL)
   #ifndef PUBLIC_CODE_SEC_STARTED
      #error "Memory section is not started"
   #else
     #undef  PUBLIC_CODE_SEC_STARTED
     #undef  ICU_STOP_SEC_PUBLIC_CODE_GLOBAL
     #define DEFAULT_STOP_SEC_CODE
   #endif
#elif defined (ICU_START_SEC_PUBLIC_CODE_LOCAL)
   #ifdef PUBLIC_CODE_SEC_STARTED
     #error "Memory section is not stopped"
   #else
     #define PUBLIC_CODE_SEC_STARTED
     #undef  ICU_START_SEC_PUBLIC_CODE_LOCAL
     #pragma ghs section text=".ICU_PUBLIC_CODE_ROM"
   #endif
#elif defined (ICU_STOP_SEC_PUBLIC_CODE_LOCAL)
   #ifndef PUBLIC_CODE_SEC_STARTED
      #error "Memory section is not started"
   #else
     #undef  PUBLIC_CODE_SEC_STARTED
     #undef  ICU_STOP_SEC_PUBLIC_CODE_LOCAL
     #define DEFAULT_STOP_SEC_CODE
   #endif
/* End of multi core */
...
/* -------------------------------------------------------------------------- */
#else
  #error "Icu_MemMap.h: No valid section define found"
#endif  /* START_WITH_IF */

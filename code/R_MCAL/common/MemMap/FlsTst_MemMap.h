...
*******************************************************************************/
/*
 * 1.4.0      30/06/2025     Update SW-VERSION
 * 1.4.0      31/05/2025     Update SW-VERSION for
 *                           RH850/Ver22.01.01 U2Cx Release
 * 1.3.1      31/03/2025     Update SW-VERSION for RH850/Ver22.00.02 U2Bx-E
 * 1.3.0      28/02/2025     Update SW-VERSION for 
 *                           RH850/U2Cx MCAL Ver22.01.00/Ver22.01.00.D Release
 * 1.2.0      31/12/2024     Update SW-VERSION for Ver22.02.00/Ver22.02.00.D
 *                           Final Release
 * 1.1.2      31/10/2024     Update version 1.1.2 
 * 1.1.1      22/07/2024     Update version 1.1.1 
 * 1.1.0      23/02/2024     Update SW-VERSION to 1.1.0
 * 1.0.1      05/10/2023     CONFIG_DATA_UNSPECIFIED to 
 * CONFIG_DATA_POSTBUILD_UNSPECIFIED. Remove DBTOC_DATA_UNSPECIFIED
 * 1.0.0      22/09/2023     Initial Version
 */
/******************************************************************************/
...
#define FLSTST_MEMMAP_AR_RELEASE_MINOR_VERSION      8
#define FLSTST_MEMMAP_AR_RELEASE_REVISION_VERSION   0

/*
 * File version information
 */
#define FLSTST_MEMMAP_SW_MAJOR_VERSION   1
#define FLSTST_MEMMAP_SW_MINOR_VERSION   4
 ...
 * This first #ifdef makes integration of delivered parts of FlsTst_MemMap.h
...
/* -------------------------------------------------------------------------- */
...
#elif defined (FLSTST_START_SEC_VAR_NO_INIT_BOOLEAN)
   ...
   #endif
#elif defined (FLSTST_STOP_SEC_VAR_NO_INIT_BOOLEAN)
...
#elif defined (FLSTST_START_SEC_VAR_NO_INIT_32)
   ...
   #endif
#elif defined (FLSTST_STOP_SEC_VAR_NO_INIT_32)
...
#elif defined (FLSTST_START_SEC_VAR_INIT_UNSPECIFIED)
   ...
   #endif
#elif defined (FLSTST_STOP_SEC_VAR_INIT_UNSPECIFIED)
...
#elif defined (FLSTST_START_SEC_VAR_NO_INIT_UNSPECIFIED)
   ...
   #endif
#elif defined (FLSTST_STOP_SEC_VAR_NO_INIT_UNSPECIFIED)
...
#elif defined (FLSTST_START_SEC_CONFIG_DATA_POSTBUILD_UNSPECIFIED)
   #ifdef CONFIG_DATA_POSTBUILD_UNSPECIFIED_SEC_STARTED
     #error "Memory section is not stopped"
   #else
     #define CONFIG_DATA_POSTBUILD_UNSPECIFIED_SEC_STARTED
     #undef  FLSTST_START_SEC_CONFIG_DATA_POSTBUILD_UNSPECIFIED
     #pragma ghs startdata
     #pragma ghs section rodata=".FLSTST_CFG_DATA_UNSPECIFIED"
   #endif
#elif defined (FLSTST_STOP_SEC_CONFIG_DATA_POSTBUILD_UNSPECIFIED)
   #ifndef CONFIG_DATA_POSTBUILD_UNSPECIFIED_SEC_STARTED
      #error "Memory section is not started"
   #else
     #undef  CONFIG_DATA_POSTBUILD_UNSPECIFIED_SEC_STARTED
     #undef  FLSTST_STOP_SEC_CONFIG_DATA_POSTBUILD_UNSPECIFIED
     #pragma ghs section rodata=default
     #pragma ghs enddata
   #endif

#elif defined (FLSTST_START_SEC_PUBLIC_CODE)
   #ifdef PUBLIC_CODE_SEC_STARTED
     #error "Memory section is not stopped"
   #else
     #define PUBLIC_CODE_SEC_STARTED
     #undef  FLSTST_START_SEC_PUBLIC_CODE
     #pragma ghs section text=".FLSTST_PUBLIC_CODE_ROM"
   #endif
#elif defined (FLSTST_STOP_SEC_PUBLIC_CODE)
...
#elif defined (FLSTST_START_SEC_PRIVATE_CODE)
   #ifdef PRIVATE_CODE_SEC_STARTED
     #error "Memory section is not stopped"
   #else
     #define PRIVATE_CODE_SEC_STARTED
     #undef  FLSTST_START_SEC_PRIVATE_CODE
     #pragma ghs section text=".FLSTST_PRIVATE_CODE_ROM"
   #endif
#elif defined (FLSTST_STOP_SEC_PRIVATE_CODE)
     ...
     #define DEFAULT_STOP_SEC_CODE
   #endif
#elif defined (FLSTST_STOP_SEC_PRIVATERAM_CODE)
   #ifndef PRIVATE_CODE_SEC_STARTED
      #error "Memory section is not started"
   #else
     #undef  PRIVATE_CODE_SEC_STARTED
     #undef  FLSTST_STOP_SEC_PRIVATERAM_CODE
     #define DEFAULT_STOP_SEC_CODE
   #endif

#elif defined (FLSTST_START_SEC_APPL_CODE)
   #undef      FLSTST_START_SEC_APPL_CODE
   #pragma ghs section text=".FLSTST_APPL_CODE_ROM"
#elif defined (FLSTST_STOP_SEC_APPL_CODE)
   ...
   #define DEFAULT_STOP_SEC_CODE
     ...
     #pragma ghs section text=".FLSTST_FAST_CODE_ROM"
   #endif
...
/* -------------------------------------------------------------------------- */
#else
  #error "FlsTst_MemMap.h: No valid section define found"
#endif  /* START_WITH_IF */

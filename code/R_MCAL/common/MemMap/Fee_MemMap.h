...
*******************************************************************************/
/*
 * 1.1.1:     30/06/2025     Update FEE_MEMMAP_SW_PATCH_VERSION to 1
 ...
 * 0.0.2      31/10/2024     Update SW-VERSION to 0.0.2
 * 0.0.1      12/08/2024     Initial Version
 */
/******************************************************************************/
...
#define FEE_MEMMAP_AR_RELEASE_MINOR_VERSION      8
...
#define FEE_MEMMAP_SW_MINOR_VERSION   1
#define FEE_MEMMAP_SW_PATCH_VERSION   1
...
/***/
#elif defined (FEE_START_SEC_VAR_NO_INIT_BOOLEAN)
   ...
   #endif
#elif defined (FEE_STOP_SEC_VAR_NO_INIT_BOOLEAN)
...
#elif defined (FEE_START_SEC_VAR_FAST_INIT_BOOLEAN)
   ...
   #endif
#elif defined (FEE_STOP_SEC_VAR_FAST_INIT_BOOLEAN)
...
#elif defined (FEE_START_SEC_VAR_FAST_INIT_8)
   ...
   #endif
#elif defined (FEE_STOP_SEC_VAR_FAST_INIT_8)
...
#elif defined (FEE_START_SEC_VAR_NO_INIT_16)
   ...
   #endif
#elif defined (FEE_STOP_SEC_VAR_NO_INIT_16)
...
#elif defined (FEE_START_SEC_VAR_FAST_INIT_16)
   ...
   #endif
#elif defined (FEE_STOP_SEC_VAR_FAST_INIT_16)
...
/* *** */
   ...
   #endif
#elif defined (FEE_STOP_SEC_VAR_FAST_INIT_32)
   ...
   #endif
/***/
#elif defined (FEE_START_SEC_VAR_FAST_INIT_UNSPECIFIED)
   ...
   #endif
#elif defined (FEE_STOP_SEC_VAR_FAST_INIT_UNSPECIFIED)
...
#elif defined (FEE_START_SEC_BURAM_VAR_NO_INIT_UNSPECIFIED)
   #ifdef VAR_NOINIT_UNSPECIFIED_SEC_STARTED
     #error "Memory section is not stopped"
   #else
     #define VAR_NOINIT_UNSPECIFIED_SEC_STARTED
     #undef  FEE_START_SEC_BURAM_VAR_NOINIT_UNSPECIFIED
     #pragma ghs startdata
     #pragma ghs section bss=".FEE_CFG_BURAM_UNSPECIFIED"
   #endif
#elif defined (FEE_STOP_SEC_BURAM_VAR_NO_INIT_UNSPECIFIED)
   #ifndef VAR_NOINIT_UNSPECIFIED_SEC_STARTED
     #error "Memory section is not started"
   #else
     #undef  VAR_NOINIT_UNSPECIFIED_SEC_STARTED
     #undef  FEE_STOP_SEC_BURAM_VAR_NOINIT_UNSPECIFIED
     #pragma ghs section bss=default
     #pragma ghs enddata
   #endif

#elif defined (FEE_START_SEC_CONFIG_VAR_NO_INIT_UNSPECIFIED)
   #ifdef VAR_NOINIT_UNSPECIFIED_SEC_STARTED
     #error "Memory section is not stopped"
   #else
     #define VAR_NOINIT_UNSPECIFIED_SEC_STARTED
     ...
     #pragma ghs startdata
     #pragma ghs section bss=".FEE_CFG_RAM_UNSPECIFIED"
   #endif
#elif defined (FEE_STOP_SEC_CONFIG_VAR_NO_INIT_UNSPECIFIED)
   #ifndef VAR_NOINIT_UNSPECIFIED_SEC_STARTED
     #error "Memory section is not started"
   #else
     #undef  VAR_NOINIT_UNSPECIFIED_SEC_STARTED
   ...
   #ifdef FEE_CONFIG_DATA_BOOLEAN_SEC_STARTED
     #error "Memory section is not stopped"
   #else
     #define FEE_CONFIG_DATA_BOOLEAN_SEC_STARTED
     #undef  FEE_START_SEC_CONFIG_DATA_BOOLEAN
     #pragma ghs startdata
     #pragma ghs section rodata=".FEE_CFG_DATA_1BIT"
   #endif
#elif defined (FEE_STOP_SEC_CONFIG_DATA_BOOLEAN)
   #ifndef FEE_CONFIG_DATA_BOOLEAN_SEC_STARTED
     #error "Memory section is not started"
   #else
     #undef  FEE_CONFIG_DATA_BOOLEAN_SEC_STARTED
     #undef  FEE_STOP_SEC_CONFIG_DATA_BOOLEAN
     #define DEFAULT_STOP_SEC_CONST_1BIT
   #endif

#elif defined (FEE_START_SEC_CONFIG_DATA_8)
   #ifdef FEE_CONFIG_DATA_8_SEC_STARTED
     #error "Memory section is not stopped"
   #else
     #define FEE_CONFIG_DATA_8_SEC_STARTED
     #undef  FEE_START_SEC_CONFIG_DATA_8
     #pragma ghs startdata
     #pragma ghs section rodata=".FEE_CFG_DATA_8BIT"
   #endif
#elif defined (FEE_STOP_SEC_CONFIG_DATA_8)
   #ifndef FEE_CONFIG_DATA_8_SEC_STARTED
     #error "Memory section is not started"
   #else
     #undef  FEE_CONFIG_DATA_8_SEC_STARTED
     #undef  FEE_STOP_SEC_CONFIG_DATA_8
     #define DEFAULT_STOP_SEC_CONST_8BIT
   #endif

#elif defined (FEE_START_SEC_CONFIG_DATA_16)
   #ifdef FEE_CONFIG_DATA_16_SEC_STARTED
     #error "Memory section is not stopped"
   #else
     #define FEE_CONFIG_DATA_16_SEC_STARTED
     #undef  FEE_START_SEC_CONFIG_DATA_16
     #pragma ghs startdata
     #pragma ghs section rodata=".FEE_CFG_DATA_16BIT"
   #endif
#elif defined (FEE_STOP_SEC_CONFIG_DATA_16)
   #ifndef FEE_CONFIG_DATA_16_SEC_STARTED
     #error "Memory section is not started"
   #else
     #undef  FEE_CONFIG_DATA_16_SEC_STARTED
     #undef  FEE_STOP_SEC_CONFIG_DATA_16
     #define DEFAULT_STOP_SEC_CONST_16BIT
   #endif

#elif defined (FEE_START_SEC_CONFIG_DATA_32)
   #ifdef FEE_CONFIG_DATA_32_SEC_STARTED
     #error "Memory section is not stopped"
   #else
     #define FEE_CONFIG_DATA_32_SEC_STARTED
     #undef  FEE_START_SEC_CONFIG_DATA_32
     #pragma ghs startdata
     #pragma ghs section rodata=".FEE_CFG_DATA_32BIT"
   #endif
#elif defined (FEE_STOP_SEC_CONFIG_DATA_32)
   #ifndef FEE_CONFIG_DATA_32_SEC_STARTED
     #error "Memory section is not started"
   #else
     #undef  FEE_CONFIG_DATA_32_SEC_STARTED
     #undef  FEE_STOP_SEC_CONFIG_DATA_32
     #define DEFAULT_STOP_SEC_CONST_32BIT
   #endif

#elif defined (FEE_START_SEC_CONFIG_DATA_PREBUILD_UNSPECIFIED)
   #ifdef FEE_CONFIG_DATA_PREBUILD_UNSPECIFIED_SEC_STARTED
     #error "Memory section is not stopped"
   #else
     #define FEE_CONFIG_DATA_PREBUILD_UNSPECIFIED_SEC_STARTED
     #undef  FEE_START_SEC_CONFIG_DATA_PREBUILD_UNSPECIFIED
     #pragma ghs startdata
     #pragma ghs section rodata=".FEE_CFG_DATA_UNSPECIFIED"
   #endif
#elif defined (FEE_STOP_SEC_CONFIG_DATA_PREBUILD_UNSPECIFIED)
   #ifndef FEE_CONFIG_DATA_PREBUILD_UNSPECIFIED_SEC_STARTED
     #error "Memory section is not started"
   #else
     #undef  FEE_CONFIG_DATA_PREBUILD_UNSPECIFIED_SEC_STARTED
     #undef  FEE_STOP_SEC_CONFIG_DATA_PREBUILD_UNSPECIFIED
     #define DEFAULT_STOP_SEC_CONST_UNSPECIFIED
   #endif
     ...
     #pragma ghs startdata
     #pragma ghs section rodata=".FEE_CFG_DBTOC_UNSPECIFIED"
   #endif
     ...
     #pragma ghs section text=".FEE_FAST_CODE_ROM"
   #endif
...
/* -------------------------------------------------------------------------- */
#else
  #error "Fee_MemMap.h: No valid section define found"
#endif  /* START_WITH_IF */

...
*******************************************************************************/
/*
 * 2.4.1: 30/06/2025     Update CAN_MEMMAP_SW_MINOR_VERSION to 4U
 ...
 * 2.1.1: 30/08/2024     Change APPL_CODE to CALLOUT_CODE and CONFIG_DATA_8
 *                       to CONFIG_DATA_PREBUILD_8
 * 2.1.0: 23/02/2024     Update SW-VERSION to 2.1.0
 * 2.0.2: 06/01/2023     Add memory section for CANXL
 * 2.0.1: 14/10/2023     Update memory section for 
 *                       CONFIG_DATA_PREBUILD_UNSPECIFIED and 
 *                       CONFIG_DATA_POSTBUILD_UNSPECIFIED
 *        22/09/2023     Initial Versions
 */
/******************************************************************************/
...
#define CAN_MEMMAP_AR_RELEASE_MINOR_VERSION      8
#define CAN_MEMMAP_AR_RELEASE_REVISION_VERSION   0

/*
 * File version information
 */
#define CAN_MEMMAP_SW_MAJOR_VERSION   2
#define CAN_MEMMAP_SW_MINOR_VERSION   4
#define CAN_MEMMAP_SW_PATCH_VERSION   1
...
/* -------------------------------------------------------------------------- */
     ...
     #pragma ghs section bss=".CAN_CFG_RAM_UNSPECIFIED"
   #endif
     ...
     #pragma ghs startdata
     #pragma ghs section rodata=".CAN_CFG_DATA_1BIT"
   #endif
...
#elif defined (CAN_START_SEC_CONFIG_DATA_PREBUILD_8)
   #ifdef CAN_CONFIG_DATA_PREBUILD_8_SEC_STARTED
     #error "Memory section is not stopped"
   #else
     #define CAN_CONFIG_DATA_PREBUILD_8_SEC_STARTED
     #undef  CAN_START_SEC_CONFIG_DATA_PREBUILD_8
     #pragma ghs startdata
     #pragma ghs section rodata=".CAN_CFG_DATA_8BIT"
   #endif
#elif defined (CAN_STOP_SEC_CONFIG_DATA_PREBUILD_8)
   #ifndef CAN_CONFIG_DATA_PREBUILD_8_SEC_STARTED
     #error "Memory section is not started"
   #else
     #undef  CAN_CONFIG_DATA_PREBUILD_8_SEC_STARTED
     #undef  CAN_STOP_SEC_CONFIG_DATA_PREBUILD_8
     #define DEFAULT_STOP_SEC_CONST_8BIT
   #endif
     ...
     #pragma ghs startdata
     #pragma ghs section rodata=".CAN_CFG_DATA_16BIT"
   #endif
     ...
     #pragma ghs startdata
     #pragma ghs section rodata=".CAN_CFG_DATA_32BIT"
   #endif
     ...
     #pragma ghs startdata
     #pragma ghs section rodata=".CAN_CFG_DATA_UNSPECIFIED"
   #endif
...
#elif defined (CAN_START_SEC_CONFIG_DATA_PREBUILD_UNSPECIFIED)
   #ifdef CAN_CONFIG_DATA_UNSPECIFIED_SEC_STARTED
     #error "Memory section is not stopped"
   #else
     #define CAN_CONFIG_DATA_UNSPECIFIED_SEC_STARTED
     #undef  CAN_START_SEC_CONFIG_DATA_PREBUILD_UNSPECIFIED
     #pragma ghs startdata
     #pragma ghs section rodata=".CAN_CFG_DATA_UNSPECIFIED"
   #endif
#elif defined (CAN_STOP_SEC_CONFIG_DATA_PREBUILD_UNSPECIFIED)
   #ifndef CAN_CONFIG_DATA_UNSPECIFIED_SEC_STARTED
     #error "Memory section is not started"
   #else
     #undef  CAN_CONFIG_DATA_UNSPECIFIED_SEC_STARTED
     #undef  CAN_STOP_SEC_CONFIG_DATA_PREBUILD_UNSPECIFIED
     #define DEFAULT_STOP_SEC_CONST_UNSPECIFIED
   #endif
   ...
   #pragma ghs startdata
   #pragma ghs section rodata=".CAN_CFG_DBCC_UNSPECIFIED"
   ...
   #define DEFAULT_STOP_SEC_CONST_UNSPECIFIED
     ...
     #pragma ghs section text=".CAN_CALLOUT_CODE_ROM"
   #endif
...
/* -------------------------------------------------------------------------- */
/* CANXL SPECIFIC MEMORY                                                      */
/* -------------------------------------------------------------------------- */
#elif defined (CAN_START_SEC_VAR_FIFO_S_MEM_UNIT0_32)
   #ifdef INTERNAL_VAR_FIFO_S_MEM_UNIT0_32_SEC_STARTED
     #error "Memory section is not stopped"
   #else
     #define INTERNAL_VAR_FIFO_S_MEM_UNIT0_32_SEC_STARTED
     #undef  CAN_START_SEC_VAR_FIFO_S_MEM_UNIT0_32
     #define DEFAULT_START_SEC_VAR_FIFO_S_MEM_UNIT0_32
	 #pragma ghs startdata
     #pragma ghs section bss=".CANXL_FIFO_S_MEM_UNIT0"
   #endif
#elif defined (CAN_STOP_SEC_VAR_FIFO_S_MEM_UNIT0_32)
   #ifndef INTERNAL_VAR_FIFO_S_MEM_UNIT0_32_SEC_STARTED
      #error "Memory section is not started"
   #else
     #undef  INTERNAL_VAR_FIFO_S_MEM_UNIT0_32_SEC_STARTED
     #undef  CAN_STOP_SEC_VAR_FIFO_S_MEM_UNIT0_32
     #define DEFAULT_STOP_SEC_VAR_FIFO_S_MEM_UNIT0_32
	 #pragma ghs section bss=default
     #pragma ghs enddata
   #endif

#elif defined (CAN_START_SEC_VAR_FIFO_S_MEM_UNIT1_32)
   #ifdef INTERNAL_VAR_FIFO_S_MEM_UNIT1_32_SEC_STARTED
     #error "Memory section is not stopped"
   #else
     #define INTERNAL_VAR_FIFO_S_MEM_UNIT1_32_SEC_STARTED
     #undef  CAN_START_SEC_VAR_FIFO_S_MEM_UNIT1_32
     #define DEFAULT_START_SEC_VAR_FIFO_S_MEM_UNIT1_32
	 #pragma ghs startdata
     #pragma ghs section bss=".CANXL_FIFO_S_MEM_UNIT1"
   #endif
#elif defined (CAN_STOP_SEC_VAR_FIFO_S_MEM_UNIT1_32)
   #ifndef INTERNAL_VAR_FIFO_S_MEM_UNIT1_32_SEC_STARTED
      #error "Memory section is not started"
   #else
     #undef  INTERNAL_VAR_FIFO_S_MEM_UNIT1_32_SEC_STARTED
     #undef  CAN_STOP_SEC_VAR_FIFO_S_MEM_UNIT1_32
     #define DEFAULT_STOP_SEC_VAR_FIFO_S_MEM_UNIT1_32
	 #pragma ghs section bss=default
     #pragma ghs enddata
   #endif

#elif defined (CAN_START_SEC_VAR_DATA_CONTAINER_S_MEM_UNIT0_8)
   #ifdef INTERNAL_VAR_DATA_CONTAINER_S_MEM_UNIT0_8
     #error "Memory section is not stopped"
   #else
     #define INTERNAL_VAR_DATA_CONTAINER_S_MEM_UNIT0_8
     #undef  CAN_START_SEC_VAR_DATA_CONTAINER_S_MEM_UNIT0_8
     #define DEFAULT_START_SEC_VAR_DATA_CONTAINER_S_MEM_UNIT0_8
	 #pragma ghs startdata
     #pragma ghs section bss=".CANXL_DATA_CONTAINER_UNIT0"
   #endif
#elif defined (CAN_STOP_SEC_VAR_DATA_CONTAINER_S_MEM_UNIT0_8)
   #ifndef INTERNAL_VAR_DATA_CONTAINER_S_MEM_UNIT0_8
      #error "Memory section is not started"
   #else
     #undef  INTERNAL_VAR_DATA_CONTAINER_S_MEM_UNIT0_8
     #undef  CAN_STOP_SEC_VAR_DATA_CONTAINER_S_MEM_UNIT0_8
     #define DEFAULT_STOP_SEC_VAR_DATA_CONTAINER_S_MEM_UNIT0_8
	 #pragma ghs section bss=default
     #pragma ghs enddata
   #endif
   
#elif defined (CAN_START_SEC_VAR_DATA_CONTAINER_S_MEM_UNIT1_8)
   #ifdef INTERNAL_VAR_DATA_CONTAINER_S_MEM_UNIT1_8
     #error "Memory section is not stopped"
   #else
     #define INTERNAL_VAR_DATA_CONTAINER_S_MEM_UNIT1_8
     #undef  CAN_START_SEC_VAR_DATA_CONTAINER_S_MEM_UNIT1_8
     #define DEFAULT_START_SEC_VAR_DATA_CONTAINER_S_MEM_UNIT1_8
	 #pragma ghs startdata
     #pragma ghs section bss=".CANXL_DATA_CONTAINER_UNIT1"
   #endif
#elif defined (CAN_STOP_SEC_VAR_DATA_CONTAINER_S_MEM_UNIT1_8)
   #ifndef INTERNAL_VAR_DATA_CONTAINER_S_MEM_UNIT1_8
      #error "Memory section is not started"
   #else
     #undef  INTERNAL_VAR_DATA_CONTAINER_S_MEM_UNIT1_8
     #undef  CAN_STOP_SEC_VAR_DATA_CONTAINER_S_MEM_UNIT1_8
     #define DEFAULT_STOP_SEC_VAR_DATA_CONTAINER_S_MEM_UNIT1_8
	 #pragma ghs section bss=default
     #pragma ghs enddata
   #endif

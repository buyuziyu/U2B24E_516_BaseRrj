...
struct RecursiveMutex theLocks[LOCK_COUNT] = {
...
static pthread_mutex_t theLocks[LOCK_COUNT] = {
...
static CRITICAL_SECTION winLocks[LOCK_COUNT];
static _Once_t winOnce[LOCK_COUNT] = { 0, 0, 0, 0, 0, 0, 0, 0, 0 };

...
/* Variants for -simd_mem_funcs */
#if defined(__GHS_SIMD_ALTERNATE_COMPILE)
# define memset __ghs_simd_memset
# define memcpy __ghs_simd_memcpy
# define memcmp __ghs_simd_memcmp
# define __ghs_forward_memcpy __ghs_simd_forward_memcpy
#endif

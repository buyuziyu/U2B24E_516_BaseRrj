...
#if defined(LIBCISANSI)||defined(SUNOS)||(defined(ANYSYSV)&&(\
...
/*#include <sys/time.h>*/
#if !defined(__INTEGRITY) && !defined(__GHS_USE_MINGW_LIBRARY)
 ...
 * but no longer does. Check for R_OK and if it has not been set
 ...
 * fall back on the 32-bit version. */
     ...
     defined(__ARM64__) || defined(__i386) || defined(__m68k)) && \

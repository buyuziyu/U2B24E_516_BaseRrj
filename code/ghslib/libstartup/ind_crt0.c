...
/* is called, ind_crt0.c must be compiled with a value for -globalreg	*/
/* at least as large as the number of global registers used in any	*/
/* program or library linked with ind_crt0.c. If no program or library	*/
/* file uses global registers, the option can be omitted from this	*/
/* file. If you don't know if program or library code uses global	*/
/* registers, you can compile this routine with -globalreg=99.		*/
/*									*/
...
#if defined(__PPC64_ABI__) && !defined(__PPC64_EABI2__)
...
# undef CONST_FUNCP
# define CONST_FUNCP *
# define ROADJUST(x) __ghs_funcadjust(x)
...
#pragma ghs endnowarning 1977
    ...
    if (!__ghs_weak_func_exists(__ghs_board_cache_sync))
	boardcachesyncp = 0;
#endif /* defined(__ghs_pic) || defined(__ghs_ropi) */
...
#pragma ghs endnowarning 1977
	...
	BASE [PIC_SEC]	= ((caddr_t) __ghs_funcadjust(__ghsbegin_picbase)) - picbase;
...
/*----------------------------------------------------------------------*/
    ...
    void **b = (void **) ((char *)__ghs_funcadjust(__ghsbinfo_clear) + SCIFIX); 
    void **e = (void **) ((char *)__ghs_funcadjust(__ghseinfo_clear) + SCIFIX); 
    void **a = __ghs_funcadjust(__ghsbinfo_aclear) ?
	((void **) ((char *)__ghs_funcadjust(__ghsbinfo_aclear) + SCIFIX)) : e;
...
/*----------------------------------------------------------------------*/
    ...
    void **b = (void **) ((char *)__ghs_funcadjust(__ghsbinfo_copy) + SCIFIX);
    void **m = (void **) ((char *)__ghs_funcadjust(__ghsbinfo_tcopy) + SCIFIX);
    void **e = (void **) ((char *)__ghs_funcadjust(__ghseinfo_copy) + SCIFIX);
...
/*----------------------------------------------------------------------*/
    ...
    if (__ghs_weak_func_exists(__ghs_decompress))
    {
    void **b = (void **) ((char *)__ghs_funcadjust(__ghsbinfo_comcopy) + SCIFIX);
    void **m = (void **) ((char *)__ghs_funcadjust(__ghsbinfo_comtcopy) + SCIFIX);
    void **e = (void **) ((char *)__ghs_funcadjust(__ghseinfo_comcopy) + SCIFIX);
...
/* The --link_constprop optimization works for ARM and PowerPC.
...
#if (defined(__ARM__) || defined(__PPC)) && \
    (!defined(__ghs_pic) && !defined(__ghs_pid) && !defined(__ghs_ropi))
    {
...
#endif
  {
    ...
    char **ppaddr	= (char **)((char *)ROADJUST(__ghsbegin_fixaddr) + SCIFIX);
    char **ppaddrend	= (char **)((char *)ROADJUST(__ghsend_fixaddr) + SCIFIX);
    char  *ptype	= (char  *)((char *)ROADJUST(__ghsbegin_fixtype) + SCIFIX); /* -> .fixtype  */

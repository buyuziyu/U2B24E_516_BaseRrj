...
**          );
**  - Input parameter
**      i_u4_Start                : Address in the target data flash memory to start erasure
**      i_u4_End                  : End address to erase
**  - Return
**      R_RFD_OK                  : Normal End
...
**  
**  - Traceability          : [Covers:UD_105_001]
**********************************************************************************************************************/
...
**      i_u2_Length        : Data length for writing
...
**      R_RFD_ERR_NOFACI          : Specified FACI is noexistance
**  
**  - Traceability          : [Covers:UD_106_001]
**********************************************************************************************************************/
...
**          );
**  - Input parameter
**      i_u4_Start         : Start address to check blank
**      i_u4_End           : End address to check blank
**  - Return
**      R_RFD_OK                  : Normal End
**      R_RFD_STS_BUSY            : Busy state
**      R_RFD_STS_ERASE_SUSPENDED : Erasure Suspended state
...
**      R_RFD_ERR_NOFACI          : Specified FACI is noexistance
**  
**  - Traceability          : [Covers:UD_107_001]
**********************************************************************************************************************/

/**********************************************************************************************************************
    ...
    File Name       : sample_control_exdata.c
...
#include "sample_exdata_control.h"

/**********************************************************************************************************************
**  Function Name   : Sample_ExtendedDataControl
**  
**  - Outline
...
**  - Format
**      T_u4_RFDReturn
**          Sample_ExtendedDataControl(
**              T_u4_RfdAddress   i_u4_Start,
**              T_u4_RfdAddress   i_u4_End,
**              T_u4_RfdBuffer    i_pu4_Data
**          );
**  - Input parameter
**      i_u4_Start                : Address in the Extended Data Area to start writing
**      i_u4_End                  : End address of the Extended Data Area
...
**      No preconditions
**  
**  - Traceability          : [Covers:VT_01_012] [Covers:VT_01_013] [Covers:VT_01_031] [Covers:VT_01_032]
**********************************************************************************************************************/
    ...
    T_pu4_RfdBuffer i_pu4_Data)
{
    ...
    T_u4                l_bu4_writtenOffset;       /* For deciding writing position            */
    ...
    {                                                           /* !CERT-C rule INT02 (QAC message 2100) */
        l_bu4_returnValue = Sample_EraseExtendedData(i_u4_Start);
    ...
    {                                                                    /* !CERT-C rule INT02 (QAC message 2100) */
        ...
        {                                                                /* !CERT-C rule INT02 (QAC message 2100) */
            ...
            l_bu4_returnValue = Sample_WriteExtendedData(l_bu4_currentStartAddress,
                                                         l_bu4_currentWritingSize,
                                                         (i_pu4_Data + l_bu4_writtenOffset)
                                                        );
            
            l_bu4_writtenOffset += l_bu4_currentWritingSize/4;
            ...
            /* Return value of Sample_WriteExtendedData is not R_RFD_OK */
            else
            {
                /* Return value of Sample_WriteExtendedData is "R_RFD_ERR_NOFACI" or "R_RFD_ERR_INTERNAL_HW" */
                l_bl1_errorFlag = R_RFD_TRUE; /* Error occurred */
            }

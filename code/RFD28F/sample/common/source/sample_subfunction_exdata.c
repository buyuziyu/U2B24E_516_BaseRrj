/**********************************************************************************************************************
    ...
    File Name       : sample_subfunction_exdata.c
...
/**********************************************************************************************************************
**  Function Name   : Sample_EraseExtendedData
**  
**  - Outline
**      Erase the contents of the data flash memory
**  - Format
**      T_u4_RFDReturn
**          Sample_EraseExtendedData(
...
**  
**  - Traceability          : [Covers:UD_118_001]
**********************************************************************************************************************/

/* !CERT-C rule DCL00 (QAC message 3227)     */

T_u4_RFDReturn
Sample_EraseExtendedData(T_u4_RfdAddress i_u4_Start)
{
    ...
    /* Status has been the command-lock status (return value of Sample_CheckFaciStatus) as follows  */
    ...
    /* Return value of the R_RFD_GetFaciStatus or the Sample_ReleaseCommandLock is R_RFD_OK */
    if (l_bu4_returnValue == R_RFD_OK)
    {
        R_RFD_EraseExtendedDataRequest(i_u4_Start);
    }
    else
    {
...
/**********************************************************************************************************************
**  Function Name   : Sample_WriteExtendedData
**  
**  - Outline
**      Write the data to the data flash memory
**  - Format
**      T_u4_RFDReturn
**          Sample_WriteExtendedData(
**              T_u4_RfdAddress  i_u4_Start,
**              T_u2             i_u2_Length,
...
**  
**  - Traceability          : [Covers:UD_119_001]
**********************************************************************************************************************/

/* !CERT-C rule DCL00 (QAC message 3227)     */

T_u4_RFDReturn
Sample_WriteExtendedData(T_u4_RfdAddress i_u4_Start, T_u2 i_u2_Length, T_pu4_RfdBuffer i_pu4_Data)
{
    ...
    if (l_bu4_returnValue == R_RFD_OK)
    {
        R_RFD_WriteExtendedDataRequest(i_u4_Start, i_u2_Length, i_pu4_Data);
    }
    else
    {
        /* Status (return value of Sample_CheckFaciStatus) as follows           */

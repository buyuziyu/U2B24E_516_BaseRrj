/**********************************************************************************************************************
    ...
    File Name       : sample_property_control.h
...
#ifndef SAMPLE_PROPERTY_CONTROL_H
#define SAMPLE_PROPERTY_CONTROL_H
...
extern T_u4_RFDReturn  Sample_EraseConfigurationSettingArea(T_u4_RfdAddress i_u4_Start);
extern T_u4_RFDReturn  Sample_WriteConfigurationSettingArea(T_u4_RfdAddress i_u4_Start, T_pu4_RfdBuffer i_pu4_Data);
extern T_u4_RFDReturn  Sample_EraseSwitchArea(void);
extern T_u4_RFDReturn  Sample_WriteSwitchArea(T_pu4_RfdBuffer i_pu4_Data);
extern T_u4_RFDReturn  Sample_EraseTagArea(void);
extern T_u4_RFDReturn  Sample_UpdateTagArea(void);

#endif  /* SAMPLE_PROPERTY_CONTROL_H */

/**********************************************************************************************************************
    ...
    File Name       : sample_dataflash_control.h
...
#ifndef SAMPLE_DATAFLASH_CONTROL_H
#define SAMPLE_DATAFLASH_CONTROL_H
...
extern T_u4_RFDReturn  Sample_EraseDF(T_u4_RfdAddress i_u4_Start, T_u4_RfdAddress i_u4_End);
extern T_u4_RFDReturn  Sample_WriteDF(T_u4_RfdAddress i_u4_Start, T_u2 i_u2_Length, T_pu4_RfdBuffer i_pu4_Data);
extern T_u4_RFDReturn  Sample_BlankCheckDF(T_u4_RfdAddress i_u4_Start, T_u4_RfdAddress i_u4_End);

#endif  /* SAMPLE_DATAFLASH_CONTROL_H */

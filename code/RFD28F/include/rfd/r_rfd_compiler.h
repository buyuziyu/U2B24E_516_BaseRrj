/**********************************************************************************************************************
    ...
    Description     : Include file for compiler dependency information
**********************************************************************************************************************/
...
/**********************************************************************************************************************
 *   Rule         : MISRA-C 2012 rule 8.6 / QAC(RCMA) message 1753
 *   Message      : The function 'name' with external linkage is declared but not defined within this project.
 *   Reason       : The corresponding function is defined in compiler.
 *   Verification : No violation.
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
    Definition for each supported compiler
**********************************************************************************************************************/

#ifdef  __ghs__
    extern void __SYNCP(void);
    
    #define R_RFD_ALIGN_VARIABLE_4      _Pragma("alignvar(4)")
    #define R_RFD_SYNCP()               __SYNCP()               /* !MISRA-C 2012 rule 8.6 (QAC(RCMA) message 1753) */
#elif   __RENESAS__
    extern void __SYNCP(void);
    
    #define R_RFD_ALIGN_VARIABLE_4                              /* No corresponding function                       */
    #define R_RFD_SYNCP()               __syncp()               /* !MISRA-C 2012 rule 8.6 (QAC(RCMA) message 1753) */
#endif  /* __ghs__, __RENESAS__ */


#endif  /* R_RFD_COMPILER_H */
